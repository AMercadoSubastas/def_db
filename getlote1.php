...
if(isset($lote)){  
  ...
  $res = mysqli_query($amercado, "SELECT * FROM lotes WHERE ( codrem='".$remate."' AND codintlote='".$lote."')")  or die(mysqli_error($amercado));
...
//  fclose($f1); 
 ...
 // $chau ="12";
  ...
  $chau = $inf["comiscobr"];
  $secu = $inf["secuencia"];
   echo "formObj2.descripcion1.value = '".$hola."';\n";  
  //  echo "formObj.descripcion.value = '".$inf["descor"]."';\n";    
   echo "formObj2.comision1.value = '".$chau."';\n";    
   echo "formObj2.secuencia1.value = '".$secu."';\n";   
   } else {
   ...
   echo "formObj2.descripcion1.value = '".$item."';\n";  
   
   
   } 
    
  }else{
    echo "formObj2.descripcion1.value  = '';\n";    
    echo "formObj2.comision1.value = '';\n";    
    echo "formObj2.secuencia1.value = '';\n";
  }    
}
?> 
