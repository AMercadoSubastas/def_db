...
//  fclose($f1); 
 ...
 // $chau ="12";
  ...
  $chau = $inf["comiscobr"];
  $secu = $inf["secuencia"];
   echo "formObj10.descripcion9.value = '".$hola."';\n";  
   echo "formObj10.comision9.value = '".$chau."';\n";    
    echo "formObj10.secuencia9.value = '".$secu."';\n";    
    } else {
   ...
   echo "formObj10.descripcion9.value = '".$item."';\n";  
   
   
   }      
    
  }else{
    echo "formObj10.descripcion9.value  = '';\n";    
    echo "formObj10.comision9.value = '';\n";    
	echo "formObj10.secuencia9.value = '';\n";    
