...
//echo "   6  - ";
	...
	mysqli_select_db($amercado, $database_amercado);
	$query_facturas_a = "SELECT * FROM series  WHERE series.tipcomp=1  AND series.codnum=1";
...
var selec = form.tipos.options;
    ...
    if (selec[1].selected == true)
    {
		...
		factura.serie_texto.value = "SERIE DE FACTURA A0001";
...
mysqli_select_db($amercado, $database_amercado);
$query_cliente = "SELECT * FROM entidades WHERE (tipoent='2' OR tipoent='1') AND activo = '1' ORDER BY razsoc ASC";
    ...
    <tr>
      ...
      <td width="22%" height="20" bgcolor="#0094FF">&nbsp;<span class="ewTableHeader">Tipo comprobante </span></td>
          <td width="24%"><select name="tipos" onChange="agregarOpciones(this.form)">
                                      ...
                                      <option value="1">FACT AUTOMATICA A</option>
                                      <option value="23">FACT AUTOMATICA B</option>
                           </select>
