...
/**
 * Table class for formapago
 */
class Formapago extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // porcrecargo
        $this->porcrecargo = new DbField(
            $this, // Table
            'x_porcrecargo', // Variable name
            'porcrecargo', // Name
            '`porcrecargo`', // Expression
            '`porcrecargo`', // Basic search expression
            4, // Type
            12, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`porcrecargo`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->porcrecargo->addMethod("getDefault", fn() => 0);
        $this->porcrecargo->InputTextType = "text";
        $this->porcrecargo->Raw = true;
        $this->porcrecargo->Nullable = false; // NOT NULL field
        $this->porcrecargo->Required = true; // Required field
        $this->porcrecargo->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->porcrecargo->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['porcrecargo'] = &$this->porcrecargo;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->activo->Lookup = new Lookup($this->activo, 'formapago', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
                break;
            default:
                $this->activo->Lookup = new Lookup($this->activo, 'formapago', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
                break;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "formapago";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->porcrecargo->DbValue = $row['porcrecargo'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("FormapagoList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "FormapagoView" => $Language->phrase("View"),
            "FormapagoEdit" => $Language->phrase("Edit"),
            "FormapagoAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "FormapagoView",
            Config("API_ADD_ACTION") => "FormapagoAdd",
            Config("API_EDIT_ACTION") => "FormapagoEdit",
            Config("API_DELETE_ACTION") => "FormapagoDelete",
            Config("API_LIST_ACTION") => "FormapagoList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("FormapagoView", $parm);
        } else {
            $url = $this->keyUrl("FormapagoView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FormapagoEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FormapagoList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FormapagoAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FormapagoList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("FormapagoDelete", $parm);
        }
    }
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->porcrecargo);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->porcrecargo);
