...
/**
 * lista_martillero controller
 */
class ListaMartilleroController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/ListaMartillero[/{params:.*}]", [PermissionMiddleware::class], "custom.lista_martillero")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "ListaMartillero");
    }
}
