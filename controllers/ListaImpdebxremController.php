...
/**
 * lista_impdebxrem controller
 */
class ListaImpdebxremController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/ListaImpdebxrem[/{params:.*}]", [PermissionMiddleware::class], "custom.lista_impdebxrem")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "ListaImpdebxrem");
    }
}
