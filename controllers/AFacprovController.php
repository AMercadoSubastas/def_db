...
/**
 * a_facprov controller
 */
class AFacprovController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/AFacprov[/{params:.*}]", [PermissionMiddleware::class], "custom.a_facprov")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "AFacprov");
    }
}
