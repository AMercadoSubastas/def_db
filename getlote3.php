...
//  fclose($f1); 
 ...
 // $chau ="12";
  ...
  $chau = $inf["comiscobr"];
  $secu = $inf["secuencia"];
   echo "formObj4.descripcion3.value = '".$hola."';\n";  
  //  echo "formObj.descripcion.value = '".$inf["descor"]."';\n";    
    echo "formObj4.comision3.value = '".$chau."';\n";    
 //   echo "formObj4.comision3.value.focus() = '';\n";
     echo "formObj4.secuencia3.value = '".$secu."';\n";  
	  } else {
   ...
   echo "formObj4.descripcion3.value = '".$item."';\n";  
   
   
   }      
    
  }else{
    echo "formObj4.descripcion3.value  = '';\n";    
    echo "formObj4.comision3.value = '';\n";    
	    echo "formObj4.secuencia3.value = '';\n";    
