...
if ($sigo_y_grabo == 1 && $todo_ok ==1) {
	...
	if (isset($_POST['lote']) && GetSQLValueString($_POST['lote'], "int")!="NULL") {
		...
		if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
  			...
  			$insertSQL = sprintf("INSERT INTO detfac (tcomp, serie, ncomp,  nreng, descrip, neto, porciva, concafac, usuario) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
	...
	if (isset($_POST['lote']) && GetSQLValueString($_POST['lote'], "int")!="NULL") {
  		...
  		$query_mascara = "SELECT * FROM series  WHERE series.codnum='32'";//'$tcomp'  AND series.codnum='$serie'";
		...
		if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
			...
			$en_liquid = 0;
  			$insertSQL = sprintf("INSERT INTO cabfac (tcomp, serie, ncomp, fecval, fecdoc, fecreg, cliente, fecvenc, estado, emitido, totbruto, totiva105, totiva21, totimp, totcomis, totneto105, totneto21, nrengs, nrodoc , tieneresol, en_liquid, CAE, CAEFchVto, Resultado, usuario, usuarioultmod, fecultmod) VALUES (%s, %s, %s, '$fecha_factura1','$fecha_factura1', '$fecha_factura1', %s, '$fecha_factura1', %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s,'$en_liquid', '$CAE', '$CAEFchVto', '$Resultado', %s, %s, %s)",
                       GetSQLValueString($_POST['tcomp'], "int"),
                       GetSQLValueString($_POST['serie'], "int"),
                       $num_fac,
			...
			if ($totalRows_medios_pago==0 && strcmp(GetSQLValueString($_POST['GrupoOpciones1'], "text"),"'S'")==0) {
    			...
    			$num_comp = ($row_comprobante['nroact'])+1 ; 
  				...
  				$strSQL = sprintf("INSERT INTO cartvalores (tcomp, serie, ncomp,  codpais , importe , fechapago , fechaingr ,  serierel , tcomprel , estado , moneda  , ncomprel )
	VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
		...
		if (GetSQLValueString($_POST['leyenda'], "text")!="NULL") {
 			...
 			$insertSQLfactley = sprintf("INSERT INTO factley (tcomp, serie, ncomp, leyendafc, ) VALUES (%s, %s, %s, %s)",
                       GetSQLValueString($_POST['tcomp'], "int"),
                       GetSQLValueString($_POST['serie'], "int"),
                       $num_fac,
...
//echo "   6  - ";
	...
	mysqli_select_db($amercado, $database_amercado);
	$query_facturas_b = "SELECT * FROM series  WHERE  series.codnum=32";
...
var selec = form.tipos.options;
    ...
    if (selec[1].selected == true)
    {
		...
		factura.serie_texto.value = "SERIE NOTA DEB B0006";
		factura.tcomp.value = 64;
...
var selec = form.tipos.options;
    ...
    if (selec[1].selected == true)
    {
		...
		factura.tcbterel_texto.value = "FACTURA B0006";
    ...
    if (selec[2].selected == true)
    {
		...
		factura.tcbterel_texto.value = "N CRED B0006";
...
function forma_pago(form) {
	...
	factura.leyenda.value = "";
  	var error ="";
  	if (tipo_comprobante=="" || total=="" || serie_num==""  || imp == 0  || fecha_factura=="") {
      	if (tipo_comprobante=="") {
...
<form id="factura" name="factura" method="POST" action="<?php echo $editFormAction; ?>">
  <table width="900" border="2" align="left" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
    ...
    <tr>
      ...
      <td width="14%" height="20" bgcolor="#FFFFFF">&nbsp;<span class="ewTableHeader">Tipo de Cbte </span></td>
          <td width="40%"><select name="tipos" onChange="agregarOpciones(this.form)">
                                      ...
                                      <option value="64">NOTA DE DEBITO B0006</option>
...
?>
    ...
    <tr>
        <td colspan="3" valign="top" bgcolor="#FFFFFF"><table width="100%" border="1" cellspacing="1" cellpadding="1">
          ...
          <td width="20%"><select name="tcbterel2" onChange="agregarOpciones2(this.form)">
                              <option value="6">FACTURA B0006</option>
                              <option value="8">N CRED B0006</option>
    ...
    <tr>
	  ...
	  <table width="100%" border="1" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
        <tr>
          <td width="39" rowspan="2" class="ewTableHeader"  background="images/fonod_lote.jpg" > <div align="center">CONC</div></td>
          <td width="10" background="images/fonod_lote.jpg" rowspan="2" class="ewTableHeader">
        ...
        <td bgcolor="#FFFFFF"><input name="tipoiva1" size="10" onChange="getprov(this.form)"></td> 
          <td bgcolor="#FFFFFF"><input name="descripcion1" type="text" class="phpmaker" id="descripcion1" size="65" /></td>
         
    <td bgcolor="#FFFFFF"><input name="importe1" type="text" id="importe1" onBlur="MM_validateForm('importe1','','NisNum');return document.MM_returnValue" size="20"  /></td>
      ...
      <input name="secuencia1" type="hidden" class="phpmaker" id="secuencia1" size="65" />
		 ...
		 <tr>
          ...
          <td bgcolor="#FFFFFF"><input name="importe2" type="text" id="importe2" onBlur="MM_validateForm('importe2','','NisNum');return document.MM_returnValue" size="20" /></td>
          ...
          <td bgcolor="#FFFFFF"><input name="importe3" type="text" id="importe3" onBlur="MM_validateForm('importe3','','NisNum');return document.MM_returnValue" size="20" /></td>
          ...
          <td bgcolor="#FFFFFF"><input name="importe4" type="text" id="importe4" onBlur="MM_validateForm('importe4','','NisNum');return document.MM_returnValue" size="20" /></td>
          ...
          <td bgcolor="#FFFFFF"><input name="importe5" type="text" id="importe5" onBlur="MM_validateForm('importe5','','NisNum');return document.MM_returnValue" size="20" /></td>
		 ...
		 <tr>
          ...
          <td bgcolor="#FFFFFF"><input name="descripcion6" type="text" class="phpmaker" id="descripcion6" size="65" /></td>
		   ...
		   <td bgcolor="#FFFFFF"><input name="importe6" type="text" id="importe6" onBlur="MM_validateForm('importe6','','NisNum');return document.MM_returnValue" size="20" /></td>
		 ...
		 <tr>
          ...
          <td bgcolor="#FFFFFF"><input name="importe7" type="text" id="importe7" onBlur="MM_validateForm('importe7','','NisNum');return document.MM_returnValue" size="20" /></td>
		 ...
		 <tr>
          ...
          <td bgcolor="#FFFFFF"><input name="importe8" type="text" id="importe8" onBlur="MM_validateForm('importe8','','NisNum');return document.MM_returnValue" size="20" /></td>
		 ...
		 <tr>
          ...
          <td bgcolor="#FFFFFF"><input name="importe9" type="text" id="importe9" onBlur="MM_validateForm('importe9','','NisNum');return document.MM_returnValue" size="20" /></td>
		 ...
		 <tr>
          ...
          <td bgcolor="#FFFFFF"><input name="importe10" type="text" id="importe10" onBlur="MM_validateForm('importe10','','NisNum');return document.MM_returnValue" size="20" /></td>
		 ...
		 <tr>
          ...
          <td bgcolor="#FFFFFF"><input name="importe11" type="text" id="importe11" onBlur="MM_validateForm('importe11','','NisNum');return document.MM_returnValue" size="20" /></td>
		 ...
		 <tr>
          ...
          <td bgcolor="#FFFFFF"><input name="importe12" type="text" id="importe12" onBlur="MM_validateForm('importe12','','NisNum');return document.MM_returnValue" size="20" /></td>
		 ...
		 <tr>
          ...
          <td bgcolor="#FFFFFF"><input name="importe13" type="text" id="importe13" onBlur="MM_validateForm('importe13','','NisNum');return document.MM_returnValue" size="20" /></td>
         ...
         <input name="secuencia13" type="hidden" class="phpmaker" id="secuencia13" size="65" />
          ...
          <td bgcolor="#FFFFFF"><input name="importe14" type="text" id="importe14" onBlur="MM_validateForm('importe14','','NisNum');return document.MM_returnValue" size="20" /></td>
		          
          <input name="secuencia14" type="hidden" class="phpmaker" id="secuencia14" size="65" />
		</tr>
      </table>      </td>
    </tr>
    <tr bgcolor="#FFFFFF"><td bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF"><tr>
	...
	<tr><td class="ewTableHeader">&nbsp;Imprimir </td><td><input type="checkbox" name="imprime" value="1" />
      ...
      <td width="281" rowspan="3" valign="top"><table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
        <tr>
