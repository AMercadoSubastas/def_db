...
/**
 * Table class for series
 */
class Series extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // tipcomp
        $this->tipcomp = new DbField(
            $this, // Table
            'x_tipcomp', // Variable name
            'tipcomp', // Name
            '`tipcomp`', // Expression
            '`tipcomp`', // Basic search expression
            3, // Type
            2, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`tipcomp`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->tipcomp->InputTextType = "text";
        $this->tipcomp->Raw = true;
        $this->tipcomp->Nullable = false; // NOT NULL field
        $this->tipcomp->Required = true; // Required field
        $this->tipcomp->setSelectMultiple(false); // Select one
        $this->tipcomp->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->tipcomp->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        global $CurrentLanguage;
        switch ($CurrentLanguage) {
            case "en-US":
                $this->tipcomp->Lookup = new Lookup($this->tipcomp, 'tipcomp', false, 'codnum', ["descripcion","","",""], '', '', [], [], [], [], [], [], false, '`descripcion` ASC', '', "`descripcion`");
                break;
            default:
                $this->tipcomp->Lookup = new Lookup($this->tipcomp, 'tipcomp', false, 'codnum', ["descripcion","","",""], '', '', [], [], [], [], [], [], false, '`descripcion` ASC', '', "`descripcion`");
                break;
        }
        $this->tipcomp->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->tipcomp->SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['tipcomp'] = &$this->tipcomp;
        ...
        // nrodesde
        $this->nrodesde = new DbField(
            $this, // Table
            'x_nrodesde', // Variable name
            'nrodesde', // Name
            '`nrodesde`', // Expression
            '`nrodesde`', // Basic search expression
            3, // Type
            9, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`nrodesde`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->nrodesde->InputTextType = "text";
        $this->nrodesde->Raw = true;
        $this->nrodesde->Nullable = false; // NOT NULL field
        $this->nrodesde->Required = true; // Required field
        $this->nrodesde->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->nrodesde->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['nrodesde'] = &$this->nrodesde;

        // nrohasta
        $this->nrohasta = new DbField(
            $this, // Table
            'x_nrohasta', // Variable name
            'nrohasta', // Name
            '`nrohasta`', // Expression
            '`nrohasta`', // Basic search expression
            3, // Type
            9, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`nrohasta`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->nrohasta->InputTextType = "text";
        $this->nrohasta->Raw = true;
        $this->nrohasta->Nullable = false; // NOT NULL field
        $this->nrohasta->Required = true; // Required field
        $this->nrohasta->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->nrohasta->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['nrohasta'] = &$this->nrohasta;

        // nroact
        $this->nroact = new DbField(
            $this, // Table
            'x_nroact', // Variable name
            'nroact', // Name
            '`nroact`', // Expression
            '`nroact`', // Basic search expression
            3, // Type
            9, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`nroact`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->nroact->InputTextType = "text";
        $this->nroact->Raw = true;
        $this->nroact->Nullable = false; // NOT NULL field
        $this->nroact->Required = true; // Required field
        $this->nroact->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->nroact->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['nroact'] = &$this->nroact;

        // mascara
        $this->mascara = new DbField(
            $this, // Table
            'x_mascara', // Variable name
            'mascara', // Name
            '`mascara`', // Expression
            '`mascara`', // Basic search expression
            200, // Type
            6, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`mascara`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->mascara->InputTextType = "text";
        $this->mascara->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['mascara'] = &$this->mascara;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->activo->Lookup = new Lookup($this->activo, 'series', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
                break;
            default:
                $this->activo->Lookup = new Lookup($this->activo, 'series', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
                break;
        ...
        // automatica
        $this->automatica = new DbField(
            $this, // Table
            'x_automatica', // Variable name
            'automatica', // Name
            '`automatica`', // Expression
            '`automatica`', // Basic search expression
            16, // Type
            1, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`automatica`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->automatica->addMethod("getDefault", fn() => 0);
        $this->automatica->InputTextType = "text";
        $this->automatica->Raw = true;
        $this->automatica->Nullable = false; // NOT NULL field
        $this->automatica->setDataType(DataType::BOOLEAN);
        global $CurrentLanguage;
        switch ($CurrentLanguage) {
            case "en-US":
                $this->automatica->Lookup = new Lookup($this->automatica, 'series', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
                break;
            default:
                $this->automatica->Lookup = new Lookup($this->automatica, 'series', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
                break;
        }
        $this->automatica->OptionCount = 2;
        $this->automatica->DefaultErrorMessage = $Language->phrase("IncorrectField");
        $this->automatica->SearchOperators = ["=", "<>"];
        $this->Fields['automatica'] = &$this->automatica;

        // fechatope
        $this->fechatope = new DbField(
            $this, // Table
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "series";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->tipcomp->DbValue = $row['tipcomp'];
        $this->descripcion->DbValue = $row['descripcion'];
        $this->nrodesde->DbValue = $row['nrodesde'];
        $this->nrohasta->DbValue = $row['nrohasta'];
        $this->nroact->DbValue = $row['nroact'];
        $this->mascara->DbValue = $row['mascara'];
        $this->activo->DbValue = $row['activo'];
        $this->automatica->DbValue = $row['automatica'];
        $this->fechatope->DbValue = $row['fechatope'];
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("SeriesList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "SeriesView" => $Language->phrase("View"),
            "SeriesEdit" => $Language->phrase("Edit"),
            "SeriesAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "SeriesView",
            Config("API_ADD_ACTION") => "SeriesAdd",
            Config("API_EDIT_ACTION") => "SeriesEdit",
            Config("API_DELETE_ACTION") => "SeriesDelete",
            Config("API_LIST_ACTION") => "SeriesList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("SeriesView", $parm);
        } else {
            $url = $this->keyUrl("SeriesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("SeriesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("SeriesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("SeriesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("SeriesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("SeriesDelete", $parm);
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->mascara->EditValue = $this->mascara->CurrentValue;
        ...
        $this->fechatope->EditValue = FormatDateTime($this->fechatope->CurrentValue, $this->fechatope->formatPattern());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->tipcomp);
                    $doc->exportCaption($this->descripcion);
                    $doc->exportCaption($this->nrodesde);
                    $doc->exportCaption($this->nrohasta);
                    $doc->exportCaption($this->nroact);
                    $doc->exportCaption($this->mascara);
                    $doc->exportCaption($this->activo);
                    $doc->exportCaption($this->automatica);
                    $doc->exportCaption($this->fechatope);
                } else {
                    $doc->exportCaption($this->codnum);
                    $doc->exportCaption($this->tipcomp);
                    $doc->exportCaption($this->descripcion);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->tipcomp);
                        $doc->exportField($this->descripcion);
                        $doc->exportField($this->nrodesde);
                        $doc->exportField($this->nrohasta);
                        $doc->exportField($this->nroact);
                        $doc->exportField($this->mascara);
                        $doc->exportField($this->activo);
                        $doc->exportField($this->automatica);
                        $doc->exportField($this->fechatope);
                    } else {
                        $doc->exportField($this->codnum);
                        $doc->exportField($this->tipcomp);
                        $doc->exportField($this->descripcion);
