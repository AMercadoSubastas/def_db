 ...
 * Page class
 */
class NivelesDelete extends Niveles
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NivelesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "NivelesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("NivelesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("NivelesList"); // Return to list
                return;
            }
        }
