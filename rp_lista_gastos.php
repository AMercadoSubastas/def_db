...
$total = 0;
    ...
    $tot71 = $tot72 = $tot73 = $tot74 = $tot75 = $tot76 = $tot77 = $tot78 = $tot79 = $tot80 = 0.00;
    $tot81 = $tot82 = $tot83 = $tot84 = $tot85 = $tot86 = $tot87 = $tot88 = $tot89 = $tot90 = 0.0 ;
    $tot91 = $tot92 = $tot93 = 0.00 ;
$cant_reng  = 0;
...
{			
	...
	$query_detfac = sprintf("SELECT * FROM detfac WHERE  tcomp = %d AND serie = %d AND ncomp = %ld", $tcomp, $serie, $ncomp);
  	...
  	while($row_detfac   = mysqli_fetch_array($detfac)) {
		...
		if ($row_detfac["concafac"] == 30 || $row_detfac["concafac"] == 31 || $row_detfac["concafac"] == 32 || $row_detfac["concafac"] == 34 || $row_detfac["concafac"] == 63 || $row_detfac["concafac"] == 64 || $row_detfac["concafac"] == 65	|| $row_detfac["concafac"] == 66 || $row_detfac["concafac"] == 67 || $row_detfac["concafac"] == 68 || $row_detfac["concafac"] == 72 || $row_detfac["concafac"] == 87 || $row_detfac["concafac"] == 88 || $row_detfac["concafac"] == 91 || $row_detfac["concafac"] == 92 || $row_detfac["concafac"] == 93) 
			continue;
		...
		$pdf->Cell(50,8,utf8_decode(substr($razsoc,0,25)),0,0,'L');
		$pdf->Cell(24,8,$cuit,0,0,'L');
		$pdf->Cell(25,8,$importe,0,0,'R');
		$pdf->Cell(30,8,utf8_decode(substr($nombre_conc,0,25)),0,0,'L');
		$cant_reng +=1;
...
if ($tot1 != 0.0) {
	...
	$pdf->Cell(105,8,'TOTAL '.utf8_decode(substr($nombre_conc,0,28)).' ( '.$cta_bas.' ) :                    ',0,0,'R');
