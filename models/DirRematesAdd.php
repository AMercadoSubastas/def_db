 ...
 * Page class
 */
class DirRematesAdd extends DirRemates
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DirRematesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "DirRematesAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "DirRematesView") {
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['usuariomod'])) { // usuariomod
            $this->usuariomod->setFormValue($row['usuariomod']);
        }
