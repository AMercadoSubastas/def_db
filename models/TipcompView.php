 ...
 * Page class
 */
class TipcompView extends Tipcomp
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TipcompView";
    ...
    // CSS class/style
    public $CurrentPageName = "TipcompView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("codnum") ?? Route("codnum")) !== null) {
            ...
            $returnUrl = "TipcompList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "TipcompList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
