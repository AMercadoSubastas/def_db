 ...
 * Page class
 */
class NivelesView extends Niveles
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NivelesView";
    ...
    // CSS class/style
    public $CurrentPageName = "NivelesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("codnum") ?? Route("codnum")) !== null) {
            ...
            $returnUrl = "NivelesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "NivelesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
