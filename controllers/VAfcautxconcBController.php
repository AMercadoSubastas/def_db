...
/**
 * v_afcautxconcB controller
 */
class VAfcautxconcBController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/VAfcautxconcB[/{params:.*}]", [PermissionMiddleware::class], "custom.v_afcautxconcB")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "VAfcautxconcB");
    }
}
