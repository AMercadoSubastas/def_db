...
/**
 * v_afcmanxlot controller
 */
class VAfcmanxlotController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/VAfcmanxlot[/{params:.*}]", [PermissionMiddleware::class], "custom.v_afcmanxlot")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "VAfcmanxlot");
    }
}
