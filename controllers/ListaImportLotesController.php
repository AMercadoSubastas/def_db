...
/**
 * lista_import_lotes controller
 */
class ListaImportLotesController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/ListaImportLotes[/{params:.*}]", [PermissionMiddleware::class], "custom.lista_import_lotes")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "ListaImportLotes");
    }
}
