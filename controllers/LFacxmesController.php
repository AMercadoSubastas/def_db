...
/**
 * l_facxmes controller
 */
class LFacxmesController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/LFacxmes[/{params:.*}]", [PermissionMiddleware::class], "custom.l_facxmes")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "LFacxmes");
    }
}
