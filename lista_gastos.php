...
<body>
<form  name="libros" class="container-specific-1" method="post" action="rp_lista_gastos.php">
  <table width="366" height="177" border="0" align="left" cellpadding="1" cellspacing="1">
       <tr>
