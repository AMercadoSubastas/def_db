...
if (GetSQLValueString($_POST['tcomp'], "int")=="44") {
...
if (GetSQLValueString($_POST['tcomp'], "int")=="45") {
	if (GetSQLValueString($_POST['leyendafc'], "text")!="NULL") {
 		$insertSQLfactley = sprintf("INSERT INTO factley (tcomp, serie, ncomp, leyendafc, codrem) VALUES (%s, %s, %s, %s, %s)",
                       	GetSQLValueString($_POST['tcomp'], "int"),
...
$sql_deposito = "SELECT   bancos.nombre , sucbancos.nombre ,codchq , importe , fechapago , `codrem`" 
		...
		$sql = "SELECT bancos.nombre , sucbancos.nombre ,codchq , importe , fechapago , codrem"
        . " FROM cartvalores , bancos , sucbancos"
        . " WHERE tcomp =8"
        . " AND serie =6"
        . " AND tcomprel =$tip_comp"
