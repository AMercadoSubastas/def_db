...
/**
 * l_WafcxlotA10 controller
 */
class LWafcxlotA10Controller extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/LWafcxlotA10[/{params:.*}]", [PermissionMiddleware::class], "custom.l_WafcxlotA10")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "LWafcxlotA10");
    }
}
