...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
	...
	if (isset($_POST['totiva105']) && $_POST['totiva105'] != 0.00 && isset($_POST['totiva21']) && $_POST['totiva21'] != 0.00) {
		...
		if (isset($_POST['totiva105']) && $_POST['totiva105'] != 0.00) {
			...
			$IvaAlicuotaId = 3; // 0.0% Ver - AfipWsfev1::FEParamGetTiposIva()
...
if ($sigo_y_grabo == 1 && $todo_ok ==1) {
	...
	if (isset($_POST['lote']) && GetSQLValueString($_POST['lote'], "int")!="NULL") {
  		...
  		$query_mascara = "SELECT * FROM series  WHERE series.codnum='29'";//'$tcomp'  AND series.codnum='$serie'";
...
var selec = form.tipos.options;
    ...
    if (selec[1].selected == true)
    {
		...
		factura.serie_texto.value = "SERIE NOTA DEB A0004";
		factura.tcomp.value = 59;
    ...
    <tr>
      ...
      <td width="14%" height="20" bgcolor="#82BADD">&nbsp;<span class="ewTableHeader">Tipo de Cbte </span></td>
          <td width="40%"><select name="tipos" onChange="agregarOpciones(this.form)">
                                      ...
                                      <option value="59">NOTA DE DEBITO A0004</option>
