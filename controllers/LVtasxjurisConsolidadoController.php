...
/**
 * l_vtasxjuris_consolidado controller
 */
class LVtasxjurisConsolidadoController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/LVtasxjurisConsolidado[/{params:.*}]", [PermissionMiddleware::class], "custom.l_vtasxjuris_consolidado")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "LVtasxjurisConsolidado");
    }
}
