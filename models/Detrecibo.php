...
/**
 * Table class for detrecibo
 */
class Detrecibo extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->tcomprel->Nullable = false; // NOT NULL field
        $this->tcomprel->Required = true; // Required field
        $this->tcomprel->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->tcomprel->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        ...
        $this->serierel->Nullable = false; // NOT NULL field
        $this->serierel->Required = true; // Required field
        $this->serierel->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->serierel->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        ...
        $this->ncomprel->Nullable = false; // NOT NULL field
        $this->ncomprel->Required = true; // Required field
        $this->ncomprel->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->ncomprel->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['ncomprel'] = &$this->ncomprel;

        // netocbterel
        $this->netocbterel = new DbField(
            $this, // Table
            'x_netocbterel', // Variable name
            'netocbterel', // Name
            '`netocbterel`', // Expression
            '`netocbterel`', // Basic search expression
            131, // Type
            12, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`netocbterel`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->netocbterel->InputTextType = "text";
        $this->netocbterel->Raw = true;
        $this->netocbterel->Nullable = false; // NOT NULL field
        $this->netocbterel->Required = true; // Required field
        $this->netocbterel->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->netocbterel->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['netocbterel'] = &$this->netocbterel;
        ...
        $this->nrodoc->Nullable = false; // NOT NULL field
        $this->nrodoc->Required = true; // Required field
        $this->nrodoc->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "detrecibo";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->netocbterel->DbValue = $row['netocbterel'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("DetreciboList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "DetreciboView" => $Language->phrase("View"),
            "DetreciboEdit" => $Language->phrase("Edit"),
            "DetreciboAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "DetreciboView",
            Config("API_ADD_ACTION") => "DetreciboAdd",
            Config("API_EDIT_ACTION") => "DetreciboEdit",
            Config("API_DELETE_ACTION") => "DetreciboDelete",
            Config("API_LIST_ACTION") => "DetreciboList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("DetreciboView", $parm);
        } else {
            $url = $this->keyUrl("DetreciboView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DetreciboEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DetreciboList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DetreciboAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DetreciboList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("DetreciboDelete", $parm);
        }
    }
    ...
    {
        if ($this->getCurrentMasterTable() == "cabrecibo" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->netocbterel);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->netocbterel);
