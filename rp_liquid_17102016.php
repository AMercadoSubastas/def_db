...
$query_fclot = sprintf("SELECT * FROM cabfac WHERE  codrem = %s AND tcomp IN (1, 6, 51, 53) AND ncompsal= %s " , $remate, $liquidacion);
...
//Convert the Total Price to a number with (.) for thousands, and (,) for decimals.
	...
	// Medios de Pago
	$query_cartvalores = "SELECT * FROM cartvalores WHERE  codrem = '$remate' AND estado = 'S' AND tcompsal = '$ptcomp' AND seriesal='$pserie' AND ncompsal = '$liquidacion' ORDER BY tcomp ASC" ;
$cartval = mysqli_query($amercado, $query_cartvalores) or die(mysqli_error($amercado));
	$totalRows_cartval = mysqli_num_rows($cartval);
	$efectivo ="";
	$cheques = "";
...
$query_lotes = "SELECT * FROM detfac WHERE codrem = '$remate' AND (tcomp='1' OR tcomp='6' OR tcomp='23' OR tcomp='24' OR tcomp='51' OR tcomp='53') AND ncompsal= '$liquidacion' ORDER BY ncomp ASC";
$lotes = mysqli_query($amercado, $query_lotes) or die(mysqli_error($amercado));
//$row_lotes = mysqli_fetch_assoc($lotes);
$totalRows_lotes = mysqli_num_rows($lotes);
