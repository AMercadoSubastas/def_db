...
for (i ; i < cantcheques ; i++)
 ...
 // alert()
   if(deposito_list.idcheque[i].checked == true)
	...
	//  deposito_list.idcheque1[i].checked== true;	  
...
echo "<tr>";
echo '<td width=\"150\" bgcolor=\'993333\'><input type=\'checkbox\' name=\'idcheque[]\' value=\"checkbox\" onclick="marca_cheque(this.form)"/></td>' ;
