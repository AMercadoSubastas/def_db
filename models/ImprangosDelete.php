 ...
 * Page class
 */
class ImprangosDelete extends Imprangos
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ImprangosDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ImprangosDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ImprangosList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ImprangosList"); // Return to list
                return;
            }
        }
