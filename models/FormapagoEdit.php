 ...
 * Page class
 */
class FormapagoEdit extends Formapago
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FormapagoEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "FormapagoEdit";
    ...
    protected function getEditRow($rsold)
    {
        ...
        // porcrecargo
        $this->porcrecargo->setDbValueDef($rsnew, $this->porcrecargo->CurrentValue, $this->porcrecargo->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['porcrecargo'])) { // porcrecargo
            $this->porcrecargo->CurrentValue = $row['porcrecargo'];
        }
