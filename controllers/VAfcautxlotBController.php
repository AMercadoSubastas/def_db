...
/**
 * v_afcautxlotB controller
 */
class VAfcautxlotBController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/VAfcautxlotB[/{params:.*}]", [PermissionMiddleware::class], "custom.v_afcautxlotB")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "VAfcautxlotB");
    }
}
