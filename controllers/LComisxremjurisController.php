...
/**
 * l_comisxremjuris controller
 */
class LComisxremjurisController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/LComisxremjuris[/{params:.*}]", [PermissionMiddleware::class], "custom.l_comisxremjuris")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "LComisxremjuris");
    }
}
