...
/**
 * l_retenciones_div controller
 */
class LRetencionesDivController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/LRetencionesDiv[/{params:.*}]", [PermissionMiddleware::class], "custom.l_retenciones_div")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "LRetencionesDiv");
    }
}
