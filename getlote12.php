...
//  fclose($f1); 
 ...
 // $chau ="12";
  ...
  $chau = $inf["comiscobr"];
  $secu = $inf["secuencia"];
   echo "formObj13.descripcion12.value = '".$hola."';\n";  
  //  echo "formObj.descripcion.value = '".$inf["descor"]."';\n";    
    echo "formObj13.comision12.value = '".$chau."';\n";    
	echo "formObj13.secuencia12.value = '".$secu."';\n";    
   } else {
   //  $fact = mysqli_query("SELECT * FROM detfac WHERE ( codrem='".$remate."' AND codintlote='".$lote."')")  or die(mysqli_error($amercado));
    ...
    echo "formObj13.descripcion12.value = '".$item."';\n";  
   
   
   }      
    
  }else{
    echo "formObj13.descripcion12.value  = '';\n";    
    echo "formObj13.comision12.value = '';\n";    
	echo "formObj13.secuencia12.value = '';\n";    
