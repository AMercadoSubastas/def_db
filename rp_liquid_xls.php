...
$query_lotes = "SELECT * FROM detfac WHERE codrem = '$remate' AND (tcomp='1' OR tcomp='6' OR tcomp='23' OR tcomp='24' OR tcomp='51' OR tcomp='53' OR tcomp='57' OR tcomp='58' OR tcomp='59' OR tcomp='60'  OR tcomp='89') AND ncompsal= '$liquidacion' ORDER BY ncomp ASC";
...
//$row_lotes = mysqli_fetch_assoc($lotes);
	...
	$csv.=$remate.$csv_sep.$tc.$num_fac.$csv_sep.$codlote.$csv_sep.$descrip.$csv_sep.$neto.$csv_end; 
	/*
	$pdf->SetFont('Arial','',9);
