...
echo "   ".$tip_comp."   -   ".$serie."    -   ".$num_fact."    -    ".$num_remate."   -   ";
...
<table width="640" border="0" cellspacing="1" cellpadding="1">
     ...
     <form name="valor_contado" > <tr>
      ...
      <tr>
        ...
        <td colspan="2"><table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#003366">
          ...
          <form id="cheques" name="cheque_form" method="post" action="carga_cheque_conA_i.php">
            <tr>
      ...
      <tr>
        ...
        <td colspan="2"><table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#003366">
          ...
          <form id="cheques" name="deposito_form" method="post" action="carga_deposito_conA_i.php">
            <tr>
      ...
      <tr>
        ...
        <td colspan="2"><table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#003366">
          ...
          <form id="form1" name="moneda" method="post" action="carga_moneda_conA_i.php">
            <tr>
      ...
      <tr>
        ...
        <td colspan="2"><table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#003366">
          ...
          <form id="ing_pesos" name="ing_pesos" method="post" action="carga_pesos_conA_i.php">
            <tr>
  ...
  <?php /*  if (($totalRows_total_ing_brutos==0) && ($totalRows_total_ing_brutos==0) && ($totalRows_total_ing_brutos==0) && ($totalRows_total_ing_brutos==0)) { */?>
      <tr>
        ...
        <td colspan="2"><table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#003366">
          <tr>
            <td height="24" colspan="7" bgcolor="#0094FF" ><div align="center" class="Estilo1">Retensiones</div></td>
          </tr>
          <tr>
          ...
          <form id="ing_brutos" name="ing_brutos" method="post" action="carga_retencion_conA_i.php">
			...
			<form id="ing_ganancias" name="ing_ganancias" method="post" action="carga_retencion_conA_i.php"> 
			<tr>
			  ...
			  <form  name="ing_iva" method="post" action="carga_retencion_conA_i.php"> 
			<tr>
			  ...
			  <form  name="ing_suss" method="post" action="carga_retencion_conA_i.php"> 
            <tr>
