...
class SeriesView extends Series
{
    ...
    // CSS class/style
    public $CurrentPageName = "SeriesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("codnum") ?? Route("codnum")) !== null) {
            ...
            $returnUrl = "SeriesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "SeriesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
