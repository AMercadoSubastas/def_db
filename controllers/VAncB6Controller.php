 ...
 * v_ancB6 controller
 */
class VAncB6Controller extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/VAncB6[/{params:.*}]", [PermissionMiddleware::class], "custom.v_ancB6")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "VAncB6");
    }
}
