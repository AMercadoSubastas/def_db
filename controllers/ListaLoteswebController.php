...
/**
 * lista_lotesweb controller
 */
class ListaLoteswebController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/ListaLotesweb[/{params:.*}]", [PermissionMiddleware::class], "custom.lista_lotesweb")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "ListaLotesweb");
    }
}
