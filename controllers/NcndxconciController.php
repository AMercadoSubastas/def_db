...
/**
 * ncndxconci controller
 */
class NcndxconciController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/Ncndxconci[/{params:.*}]", [PermissionMiddleware::class], "custom.ncndxconci")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "Ncndxconci");
    }
}
