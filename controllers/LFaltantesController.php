...
/**
 * l_faltantes controller
 */
class LFaltantesController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/LFaltantes[/{params:.*}]", [PermissionMiddleware::class], "custom.l_faltantes")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "LFaltantes");
    }
}
