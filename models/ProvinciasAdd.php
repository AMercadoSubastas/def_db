 ...
 * Page class
 */
class ProvinciasAdd extends Provincias
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProvinciasAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ProvinciasAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("ProvinciasList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "ProvinciasList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "ProvinciasView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "ProvinciasList") {
                            ...
                            $returnUrl = "ProvinciasList"; // Return list page content
                        }
                    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ProvinciasList"), "", $this->TableVar, true);
