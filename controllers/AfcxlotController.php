 ...
 * afcxlot controller
 */
class AfcxlotController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/Afcxlot[/{params:.*}]", [PermissionMiddleware::class], "custom.afcxlot")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "Afcxlot");
    }
}
