...
*/
	...
	if (isset($_POST['descripcion']) && GetSQLValueString($_POST['descripcion'], "text")!="NULL") {
		...
		if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
			...
			$insertSQL = sprintf("INSERT INTO cabfac (tcomp, serie, ncomp, fecval, fecdoc, fecreg, cliente, fecvenc, estado, emitido, codrem, totbruto, totiva21, totneto21, nrengs, nrodoc, en_liquid, CAE, CAEFchVto, Resultado, usuario, usuarioultmod, fecultmod) VALUES (%s, %s, %s, '$fecha_factura1','$fecha_factura1', '$fecha_factura1', %s, '$fecha_factura1', %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
						   GetSQLValueString($_POST['tcomp'], "int"),
						   GetSQLValueString($_POST['serie'], "int"),
						   $num_fac, //GetSQLValueString($_POST['num_factura'], "int"),
...
//setcookie("concepto","");
mysqli_select_db($amercado, $database_amercado);
$query_facturas_a = "SELECT * FROM series  WHERE series.codnum=30"; // antes decia 1 que es por lotes
...
mysqli_select_db($amercado, $database_amercado);
$query_tipo_comprobante = "SELECT * FROM tipcomp WHERE codnum='54'";
...
function agregarOpciones(form)
{
	var selec = form.tipos.options;
		...
		factura.serie_texto.value = "SERIE DE CONCEPTOS B0004";
		factura.tcomp.value = 54;
...
<form id="factura" name="factura" method="POST" action="<?php echo $editFormAction; ?>">
  <table width="879" height="890" border="0" align="left" cellpadding="1" cellspacing="1" bgcolor="#82BADD">
    <tr>
    ...
    <tr>
      <td colspan="2" valign="top" bgcolor="#82BADD"><table width="818" border="1" cellspacing="1" cellpadding="1">
         <tr>
		 <td width="14%" height="20" class="ewTableHeader">&nbsp;Tipo de Cbte </td>
          <td width="36%"><select name="tipos" onChange="agregarOpciones(this.form)">
                        <option value="">[seleccione una opci&oacute;n]</option>
                                      <option value="54">FACT AUT CONCEPTOS B0004</option>
                                     
                           </select>
		  <input name="tcomp" type="hidden" value="54" size="25" >
		         </td>
          
          <td width="15%" class="ewTableHeader">Serie</td>
          <td width="35%"><input name="serie_texto" type="text"  size="24" />
		  <input name="serie" type="hidden" value="30" size="25"/>
            </td>
        </tr>
        <tr>
         ...
         <tr>
          ...
          <td colspan="4" rowspan="5" valign="top" bgcolor="#82BADD" ><table width="94%" border="1" cellpadding="1" cellspacing="1" bgcolor="#003366">
...
?>
    ...
    <tr>
      <td width="639" rowspan="3" valign="top"><table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#82BADD"><tr>
      <td width="88" height="20" valign="top" bgcolor="#82BADD" class="ewTableHeader">&nbsp;Leyenda</td>
      <td width="527"  valign="top"><textarea name="leyenda" cols="55" rows="4"></textarea></td>
    </tr>
	<tr><td height="25" bgcolor="#82BADD" border="1" class="ewTableHeader">&nbsp;Imprimir   </td><td bgcolor="#82BADD" ><input type="checkbox" name="imprime" value="1" />
      ...
      <td width="229" rowspan="3" valign="top"><table width="95%" height="115" border="1" cellpadding="1" cellspacing="1" bgcolor="#82BADD">
