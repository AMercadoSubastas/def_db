...
/**
 * l_facncint controller
 */
class LFacncintController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/LFacncint[/{params:.*}]", [PermissionMiddleware::class], "custom.l_facncint")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "LFacncint");
    }
}
