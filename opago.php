...
if (isset($_POST['renglon1']) && GetSQLValueString($_POST['renglon1'], "int")!="NULL") {
	// DESDE ACA ===================================================================================
	if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "opago")) {
    	// BUSCA el Numero de la ULTIMA  O PAGO
	 	mysqli_select_db($amercado, $database_amercado);
  		$query_opago = "SELECT nroact   FROM series WHERE codnum ='50' AND tipcomp  ='114'";
  		$sel_opago =mysqli_query($amercado, $query_opago) or die(mysqli_error($amercado));
  		$row_opagonum = mysqli_fetch_assoc($sel_opago);
  		$opago = $row_opagonum['nroact']+1;
    	// Actualiza el numero de la ultima o pago
		mysqli_select_db($amercado, $database_amercado);
		$actualiza1 = "UPDATE `series` SET nroact = '$opago' WHERE codnum ='50' AND tipcomp='114'" ;	 
		$resultado=mysqli_query($amercado,	$actualiza1);	
	}
    
	if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "opago")) {
		// INSERTO LOS DETALLES DE LA FACTURA EN LA opago DE LA PRIMER FACTURA
		...
		$insertSQL = "INSERT INTO detrecibo (tcomp, serie, ncomp, nreng , tcomprel, serierel , ncomprel , netocbterel, nrodoc) VALUES ('2', '3', '$opago', '1' , '$tcomprel', '$serierel','$ncomprel','$netocbterel','$doc1')";
        $Result1 = mysqli_query($amercado, $insertSQL) or die(mysqli_error($amercado));
        if ($tcomprel == 51 || $tcomprel == 53) {
                ...
                // Actualiza el numero de la ultima opago
                mysqli_select_db($amercado, $database_amercado);
...
if (isset($_POST['renglon2']) && GetSQLValueString($_POST['renglon2'], "int")!="NULL") {
	if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "opago")) {
		// INSERTO LOS DETALLES DE LA FACTURA EN LA opago DE LA SEGUNDA FACTURA
		...
		$doc2 = $_POST['doc2'];
		$insertSQL = sprintf("INSERT INTO detrecibo (tcomp, serie, ncomp, nreng , tcomprel, serierel , ncomprel , netocbterel, nrodoc) VALUES ('2', '3', '$opago', '2' , %s, %s, %s, %s, '$doc2')",
...
if (isset($_POST['renglon3']) && GetSQLValueString($_POST['renglon3'], "int")!="NULL") {
	if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "opago")) {
		// INSERTO LOS DETALLES DE LA FACTURA EN LA opago DE LA TERCER FACTURA
		...
		$doc3 = $_POST['doc3'];
		$insertSQL = sprintf("INSERT INTO detrecibo (tcomp, serie, ncomp, nreng , tcomprel, serierel , ncomprel , netocbterel, nrodoc) VALUES ('2', '3', '$opago', '3' , %s, %s, %s, %s, '$doc3' )",
        ...
        if ($tcomprel3 == 51 || $tcomprel3 == 53) {
                ...
                $row_remitonum = mysqli_fetch_assoc($sel_remito);
                $remito = $row_remitonum['nroact']+1;
                // Actualiza el numero del ultimo opago
                mysqli_select_db($amercado, $database_amercado);
                $actualiza1 = "UPDATE `series` SET nroact = '$remito' WHERE codnum ='28' AND tipcomp='50'" ;				 
                $resultado=mysqli_query($amercado,	$actualiza1);	
...
if (isset($_POST['renglon4']) && GetSQLValueString($_POST['renglon4'], "int")!="NULL") {
	if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "opago")) {
		...
		$ncomprel4 = GetSQLValueString($_POST['ncomprel_4'], "int");
 		$doc4 = $_POST['doc4'];
		// INSERTO LOS DETALLES DE LA FACTURA EN EL opago DE LA CUARTA FACTURA
		$insertSQL = sprintf("INSERT INTO detrecibo (tcomp, serie, ncomp, nreng , tcomprel, serierel , ncomprel , netocbterel, nrodoc) VALUES ('2', '3', '$opago', '4' , %s, %s, %s, %s, '$doc4')",
...
if (isset($_POST['renglon5']) && GetSQLValueString($_POST['renglon5'], "int")!="NULL") {
	if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "opago")) {
		...
		$ncomprel5 = GetSQLValueString($_POST['ncomprel_5'], "int");
 		$doc5 = $_POST['doc5'];
		// INSERTO LOS DETALLES DE LA FACTURA EN EL opago DE LA QUINTA FACTURA
		$insertSQL = sprintf("INSERT INTO detrecibo (tcomp, serie, ncomp, nreng , tcomprel, serierel , ncomprel , netocbterel, nrodoc) VALUES ('2', '3', '$opago', '5' , %s, %s, %s, %s, '$doc5')",
...
if (isset($_POST['renglon6']) && GetSQLValueString($_POST['renglon6'], "int")!="NULL") {
	if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "opago")) {
		// INSERTO LOS DETALLES DE LA FACTURA EN la  opago DE LA SEXTA FACTURA
		...
		$doc6 = $_POST['doc6'];
		$insertSQL = sprintf("INSERT INTO detrecibo (tcomp, serie, ncomp, nreng , tcomprel, serierel , ncomprel , netocbterel, nrodoc) VALUES ('2', '3', '$opago', '6' , %s, %s, %s, %s, '$doc6' )",
...
if (isset($_POST['renglon7']) && GetSQLValueString($_POST['renglon7'], "int")!="NULL") {
	if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "opago")) {
		// INSERTO LOS DETALLES DE LA FACTURA EN la  opago DE LA SEPTIMA FACTURA
		...
		$doc7 = $_POST['doc7'];
		$insertSQL = sprintf("INSERT INTO detrecibo (tcomp, serie, ncomp, nreng , tcomprel, serierel , ncomprel , netocbterel, nrodoc) VALUES ('2', '3', '$opago', '7' , %s, %s, %s, %s,'$doc7' )",
...
if (isset($_POST['renglon8']) && GetSQLValueString($_POST['renglon8'], "int")!="NULL") {
	if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "opago")) {
		...
		$doc8 = $_POST['doc8'];
		// INSERTO LOS DETALLES DE LA FACTURA EN la opago DE LA OCTAVA FACTURA
		$insertSQL = sprintf("INSERT INTO detrecibo (tcomp, serie, ncomp, nreng , tcomprel, serierel , ncomprel , netocbterel, nrodoc) VALUES ('2', '3', '$opago', '8' , %s, %s, %s, %s, '$doc8')",
...
if (isset($_POST['renglon9']) && GetSQLValueString($_POST['renglon9'], "int")!="NULL") {
	if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "opago")) {
		...
		$doc9 = $_POST['doc9'];
		// INSERTO LOS DETALLES DE LA FACTURA EN LA opago DE LA NOVENA FACTURA
		$insertSQL = sprintf("INSERT INTO detrecibo (tcomp, serie, ncomp, nreng , tcomprel, serierel , ncomprel , netocbterel, nrodoc) VALUES ('2', '3', '$opago', '9' , %s, %s, %s, %s, '$doc9')",
...
if (isset($_POST['renglon10']) && GetSQLValueString($_POST['renglon10'], "int")!="NULL") {
	if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "opago")) {
		...
		$doc10 = $_POST['doc10'];
		$insertSQL = sprintf("INSERT INTO detrecibo (tcomp, serie, ncomp, nreng , tcomprel, serierel , ncomprel , netocbterel, nrodoc) VALUES ('2', '3', '$opago', '10' , %s, %s, %s, %s, '$doc10')",
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "opago"))  {
	...
	$fecha = substr($fecha,6,4)."-".substr($fecha,3,2)."-".substr($fecha,0,2);
  	...
  	$insertSQL = sprintf("INSERT INTO cabrecibo (tcomp, serie, ncomp, cantcbtes, fecha , cliente , imptot ,emitido ) VALUES ('2', '3', '$opago', '$renglones' , '$fecha', '$cliente' ,  '$tot_general', '0')");
  	mysqli_select_db($amercado, $database_amercado);
  	$Result1 = mysqli_query($amercado, $insertSQL) or die(mysqli_error($amercado));
	...
	$insertGoTo = "medios_pago_opagos.php?ftcomp='2'&&fserie='3'&&fncomp=$opago";
  	if (isset($_SERVER['QUERY_STRING'])) {
    	$insertGoTo .= (strpos($insertGoTo, '?')) ? "&" : "?";
    	$insertGoTo .= $_SERVER['QUERY_STRING'];
  	}
  	header(sprintf("Location: %s", "medios_pago_opagos.php?ftcomp=2&&fserie=3&&fncomp=$opago&&total_general=$tot_general&&remate=$remate&&cliente=$cliente"));
}
?>
...
{ 
	var fecha = opago_cab.fecha_opago1.value;
	var ano = fecha.substring(6,10);
	var mes = fecha.substring(3,5);
	var dia = fecha.substring(0,2);
	var fecha1 = ano+"-"+mes+"-"+dia ;
	opago_cab.fecha_opago.value = fecha1;
}
</script>
</head>
<body>
...
mysqli_select_db($amercado, $database_amercado);
$query_opago = "SELECT nroact   FROM series WHERE series.codnum ='50' AND series.tipcomp  ='114'";
$sel_opago =mysqli_query($amercado, $query_opago) or die(mysqli_error($amercado));
$row_opagonum = mysqli_fetch_assoc($sel_opago);
$opago = $row_opagonum['nroact']+1;
...
<form id="opago_cab" name="opago" method="POST" action="<?php echo $editFormAction; ?>"> 
   
    <tr  bgcolor="#00CCFF">
      <td class="Estilo2" >Fecha</td><input name="fecha" type="hidden" size="12" />
      <td class="Estilo3"><input name="fecha_opago1" type="text" size="12"  value="<?php echo date('d-m-Y') ;?>"  onblur="cambia_fecha(this.form)" />
	...
	<input type="hidden" name="cantcbtes"  value="<?php echo sizeof($codigo) ?>" />
     <tr bgcolor="#003366">
      ...
      <td><input type="text" name="nombre"  value="<?php echo utf8_encode($row_cliente['razsoc']) ?>"/></td>
    </tr>
    <tr bgcolor="#003366">
      <td class="Estilo2">Direccion</td>
      <td><input name="direccion" type="text" value="<?php echo utf8_encode($row_cliente['calle'])."  ".$row_cliente['numero'] ?>" size="50"/></td>
    </tr>
     <tr bgcolor="#003366">
      <td class="Estilo2">Localidad</td>
      <td><input type="text" name="localidad" value="<?php echo utf8_encode($row_loc['descripcion']) ?>" /></td>
    </tr>
    <tr bgcolor="#003366">
      <td class="Estilo2">Provincia</td>
      <td><input type="text" class="seleccion" name="provincia" value="<?php echo utf8_encode($row_prov['descripcion'])
          ?>" /></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
 ...
 <tr bgcolor="FFFFFF">
   ...
   <td bgcolor="#0099CC"><input type="submit" name="Submit" value="Grabar" /></td>
	...
	<input type="hidden" name="MM_insert" value="opago">
   </form>
</table>
