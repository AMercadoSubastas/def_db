...
class UsuariosAdd extends Usuarios
{
    ...
    // Page object name
    public $PageObjName = "UsuariosAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "UsuariosAdd";
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            ...
            if (!$this->usuario->Raw && Config("REMOVE_XSS") && CheckUsername($this->usuario->FormValue)) {
                $this->usuario->addErrorMessage($Language->phrase("InvalidUsernameChars"));
            }
