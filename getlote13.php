...
//  fclose($f1); 
 ...
 // $chau ="12";
  ...
  $chau = $inf["comiscobr"];
   $secu = $inf["secuencia"];
   echo "formObj14.descripcion13.value = '".$hola."';\n";  
  //  echo "formObj.descripcion.value = '".$inf["descor"]."';\n";    
    echo "formObj14.comision13.value = '".$chau."';\n";    
	echo "formObj14.secuencia13.value = '".$secu."';\n";    
   } else {
   //  $fact = mysqli_query("SELECT * FROM detfac WHERE ( codrem='".$remate."' AND codintlote='".$lote."')")  or die(mysqli_error($amercado));
    ...
    echo "formObj14.descripcion13.value = '".$item."';\n";  
   
   
   }      
    
  }else{
    echo "formObj14.descripcion13.value  = '';\n";    
    echo "formObj14.comision13.value = '';\n";    
	echo "formObj14.secuencia13.value = '';\n";    
