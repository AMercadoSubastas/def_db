 ...
 * Page class
 */
class CabremiList extends Cabremi
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CabremiList";
    ...
    public $FormName = "fcabremilist";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "CabremiList";
    ...
    public function setVisibility()
    {
        ...
        $this->cantrengs->setVisibility();
        $this->comprador->setVisibility();
        $this->fecharemi->setVisibility();
        ...
        $this->patente->setVisibility();
        $this->patremolque->setVisibility();
    ...
    public function __construct()
    {
        ...
        // Table object (cabremi)
        if (!isset($GLOBALS["cabremi"]) || $GLOBALS["cabremi"]::class == PROJECT_NAMESPACE . "cabremi") {
            $GLOBALS["cabremi"] = &$this;
        }
        ...
        // Initialize URLs
        $this->AddUrl = "CabremiAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiEditUrl = $pageUrl . "action=multiedit";
        $this->MultiDeleteUrl = "CabremiDelete";
        $this->MultiUpdateUrl = "CabremiUpdate";

        // Table name (for backward compatibility only)
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'cabremi');
        }
        ...
        if ($url != "") {
            ...
            if ($this->IsModal) { // Show as modal
                ...
                if (!SameString($pageName, GetPageName($this->getListUrl()))) { // Not List page
                    ...
                    $result["view"] = SameString($pageName, "CabremiView"); // If View page, no primary button
                } else { // List page
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server") {
            $savedFilterList = Profile()->getSearchFilters("fcabremisrch");
        }
        ...
        $filterList = Concat($filterList, $this->cantrengs->AdvancedSearch->toJson(), ","); // Field cantrengs
        $filterList = Concat($filterList, $this->comprador->AdvancedSearch->toJson(), ","); // Field comprador
        $filterList = Concat($filterList, $this->fecharemi->AdvancedSearch->toJson(), ","); // Field fecharemi
        ...
        $filterList = Concat($filterList, $this->patente->AdvancedSearch->toJson(), ","); // Field patente
        $filterList = Concat($filterList, $this->patremolque->AdvancedSearch->toJson(), ","); // Field patremolque
        ...
        $filterList = Concat($filterList, $this->fechaultmod->AdvancedSearch->toJson(), ","); // Field fechaultmod
        if ($this->BasicSearch->Keyword != "") {
    ...
    protected function processFilterList()
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("fcabremisrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field cantrengs
        $this->cantrengs->AdvancedSearch->SearchValue = @$filter["x_cantrengs"];
        $this->cantrengs->AdvancedSearch->SearchOperator = @$filter["z_cantrengs"];
        $this->cantrengs->AdvancedSearch->SearchCondition = @$filter["v_cantrengs"];
        $this->cantrengs->AdvancedSearch->SearchValue2 = @$filter["y_cantrengs"];
        $this->cantrengs->AdvancedSearch->SearchOperator2 = @$filter["w_cantrengs"];
        $this->cantrengs->AdvancedSearch->save();
        ...
        // Field fecharemi
        $this->fecharemi->AdvancedSearch->SearchValue = @$filter["x_fecharemi"];
        $this->fecharemi->AdvancedSearch->SearchOperator = @$filter["z_fecharemi"];
        $this->fecharemi->AdvancedSearch->SearchCondition = @$filter["v_fecharemi"];
        $this->fecharemi->AdvancedSearch->SearchValue2 = @$filter["y_fecharemi"];
        $this->fecharemi->AdvancedSearch->SearchOperator2 = @$filter["w_fecharemi"];
        $this->fecharemi->AdvancedSearch->save();
        ...
        // Field patente
        $this->patente->AdvancedSearch->SearchValue = @$filter["x_patente"];
        $this->patente->AdvancedSearch->SearchOperator = @$filter["z_patente"];
        $this->patente->AdvancedSearch->SearchCondition = @$filter["v_patente"];
        $this->patente->AdvancedSearch->SearchValue2 = @$filter["y_patente"];
        $this->patente->AdvancedSearch->SearchOperator2 = @$filter["w_patente"];
        $this->patente->AdvancedSearch->save();

        // Field patremolque
        $this->patremolque->AdvancedSearch->SearchValue = @$filter["x_patremolque"];
        $this->patremolque->AdvancedSearch->SearchOperator = @$filter["z_patremolque"];
        $this->patremolque->AdvancedSearch->SearchCondition = @$filter["v_patremolque"];
        $this->patremolque->AdvancedSearch->SearchValue2 = @$filter["y_patremolque"];
        $this->patremolque->AdvancedSearch->SearchOperator2 = @$filter["w_patremolque"];
        $this->patremolque->AdvancedSearch->save();
        ...
        // Field fechaultmod
        $this->fechaultmod->AdvancedSearch->SearchValue = @$filter["x_fechaultmod"];
        $this->fechaultmod->AdvancedSearch->SearchOperator = @$filter["z_fechaultmod"];
        $this->fechaultmod->AdvancedSearch->SearchCondition = @$filter["v_fechaultmod"];
        $this->fechaultmod->AdvancedSearch->SearchValue2 = @$filter["y_fechaultmod"];
        $this->fechaultmod->AdvancedSearch->SearchOperator2 = @$filter["w_fechaultmod"];
        $this->fechaultmod->AdvancedSearch->save();
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->cantrengs); // cantrengs
            $this->updateSort($this->comprador); // comprador
            $this->updateSort($this->fecharemi); // fecharemi
            ...
            $this->updateSort($this->patremolque); // patremolque
            ...
            $this->updateSort($this->fechaultmod); // fechaultmod
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->serie->setSort("");
                $this->ncomp->setSort("");
                $this->cantrengs->setSort("");
                $this->comprador->setSort("");
                $this->fecharemi->setSort("");
                ...
                if ($listAction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    if ($action != "") {
                        ...
                        $link = $disabled
                            ...
                            : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fcabremilist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button></li>";
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = $disabled
                            ? "<div class=\"alert alert-light\">" . $icon . " " . $caption . "</div>"
                            : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . $title . "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fcabremilist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button>";
                        }
                    }
                }
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "cantrengs");
            $this->createColumnOption($option, "comprador");
            $this->createColumnOption($option, "fecharemi");
            $this->createColumnOption($option, "observaciones");
            ...
            $this->createColumnOption($option, "patente");
            $this->createColumnOption($option, "patremolque");
            ...
            $this->createColumnOption($option, "fechaultmod");
        }
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fcabremisrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fcabremisrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions as $listAction) {
            if ($listAction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fcabremilist"' . $listAction->toDataAttributes() . '>' . $icon . '</button>';
    ...
    public function setupRow()
    {
        ...
        if ($this->isGridAdd() || $this->isGridEdit()) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_cabremi", "data-rowtype" => RowType::ADD]);
    ...
    protected function newRow()
    {
        ...
        $row['cantrengs'] = $this->cantrengs->DefaultValue;
        $row['comprador'] = $this->comprador->DefaultValue;
        $row['fecharemi'] = $this->fecharemi->DefaultValue;
        ...
        $row['patente'] = $this->patente->DefaultValue;
        $row['patremolque'] = $this->patremolque->DefaultValue;
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fcabremilist" data-ew-action="email" data-custom="false" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fcabremisrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
