 ...
 * Page class
 */
class MonedasDelete extends Monedas
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MonedasDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "MonedasDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("MonedasList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("MonedasList"); // Return to list
                return;
            }
        }
