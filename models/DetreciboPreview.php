 ...
 * Page class
 */
class DetreciboPreview extends Detrecibo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DetreciboPreview";
    ...
    // CSS class/style
    public $CurrentPageName = "DetreciboPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "cabrecibo") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=cabrecibo&" . GetForeignKeyUrl("fk_tcomp", $this->tcomp->QueryStringValue) . "&" . GetForeignKeyUrl("fk_serie", $this->serie->QueryStringValue) . "&" . GetForeignKeyUrl("fk_ncomp", $this->ncomp->QueryStringValue) . "";
        }
        return $url;
    }
