 ...
 * v_andA4 controller
 */
class VAndA4Controller extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/VAndA4[/{params:.*}]", [PermissionMiddleware::class], "custom.v_andA4")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "VAndA4");
    }
}
