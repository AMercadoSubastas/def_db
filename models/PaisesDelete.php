 ...
 * Page class
 */
class PaisesDelete extends Paises
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PaisesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "PaisesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PaisesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("PaisesList"); // Return to list
                return;
            }
        }
