 ...
 * v_ancB4 controller
 */
class VAncB4Controller extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/VAncB4[/{params:.*}]", [PermissionMiddleware::class], "custom.v_ancB4")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "VAncB4");
    }
}
