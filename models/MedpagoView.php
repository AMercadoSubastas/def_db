 ...
 * Page class
 */
class MedpagoView extends Medpago
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MedpagoView";
    ...
    // CSS class/style
    public $CurrentPageName = "MedpagoView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("codnum") ?? Route("codnum")) !== null) {
            ...
            $returnUrl = "MedpagoList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "MedpagoList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
