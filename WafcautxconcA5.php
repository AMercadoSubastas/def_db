...
$comprobante = mysqli_query($amercado, $query_comprobante) or die("ERROR LEYENDO TABLA SERIES");
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
	...
	$cliente2 = mysqli_query($amercado, $query_cliente2) or die("ERROR LEYENDO TABLA ENTIDADES");
...
*/
	...
	if (isset($_POST['descripcion']) && GetSQLValueString($_POST['descripcion'], "text")!="NULL") {
		...
		$mascara = mysqli_query($amercado, $query_mascara) or die("ERROR EN LA SERIE");
		...
		if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
			...
			$insertSQL = sprintf("INSERT INTO cabfac (tcomp, serie, ncomp, fecval, fecdoc, fecreg, cliente, fecvenc, estado, emitido, codrem, totbruto, totiva21, totneto21, nrengs, nrodoc, en_liquid, CAE, CAEFchVto, Resultado) VALUES (%s, %s, %s, '$fecha_factura1','$fecha_factura1', '$fecha_factura1', %s, '$fecha_factura1', %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
						   GetSQLValueString($_POST['tcomp'], "int"),
						   GetSQLValueString($_POST['serie'], "int"),
						   $num_fac, //GetSQLValueString($_POST['num_factura'], "int"),
			...
			mysqli_select_db($amercado, $database_amercado);
			$Result1 = mysqli_query($amercado, $insertSQL) or die("ERROR GRABANDO CABECERA DE FACTURA");
			...
			if (isset($_POST['leyenda']) && GetSQLValueString($_POST['leyenda'], "text")!="NULL") {
				...
				mysqli_select_db($amercado, $database_amercado);
				$Result1 = mysqli_query($amercado, $insertSQLfactley) or die("ERROR GRABANDO LEYENDA DE FACTURA");
			...
			$medios_pago = mysqli_query($amercado, $query_medios_pago) or die("ERROR GRABANDO MEDIOS DE PAGO");
			...
			if ($totalRows_medios_pago==0 && strcmp(GetSQLValueString($_POST['GrupoOpciones1'], "text"),"'S'")==0) {
				...
				$comprobante = mysqli_query($amercado, $query_comprobante) or die("ERROR LEYENDO SERIE DEL MEDIO DE PAGO");
				$row_comprobante = mysqli_fetch_assoc($comprobante);
				$totalRows_comprobante = mysqli_num_rows($comprobante);
				$num_comp = ($row_comprobante['nroact'])+1 ; 
...
setcookie("concepto","");
mysqli_select_db($amercado, $database_amercado);
$query_facturas_a = "SELECT * FROM series  WHERE series.codnum=37"; // antes decia 1 que es por lotes
$facturas_a = mysqli_query($amercado, $query_facturas_a) or die("ERROR LEYENDO SERIE DE FAC A");
...
mysqli_select_db($amercado, $database_amercado);
$query_tipo_comprobante = "SELECT * FROM tipcomp WHERE codnum='92'";
$tipo_comprobante = mysqli_query($amercado, $query_tipo_comprobante) or die("ERROR LEYENDO TIPO DE CBTE");
...
$num_remates = mysqli_query($amercado, $query_num_remates) or die("ERROR LEYENDO EL REMATE");
...
function agregarOpciones(form)
{
	var selec = form.tipos.options;
    	...
    	{
		//alert ("SElec 1")
		factura.serie.value = 37;
		factura.serie_texto.value = "SERIE DE CONCEPTOS A00005";
		factura.tcomp.value = 92;
...
<form id="factura" name="factura" method="POST" action="<?php echo $editFormAction; ?>">
  <table width="810" height="890" border="0" align="left" cellpadding="1" cellspacing="1" bgcolor="#82BADD">
    <tr>
    ...
    <tr>
      <td colspan="2" valign="top" bgcolor="#82BADD"><table width="810" border="1" cellspacing="1" cellpadding="1">
         <tr>
		 <td width="17%" height="20" class="ewTableHeader">&nbsp;Tipo de Cbte </td>
          <td width="41%"><select name="tipos" onChange="agregarOpciones(this.form)">
                        <option value="">[seleccione una opci&oacute;n]</option>
                                      <option value="92">FACT CONCEPTOS A00005</option>
                                     
                           </select>
		  <input name="tcomp" type="hidden" value="92" size="25" >
		         </td>
          
          <td width="7%" class="ewTableHeader">Serie</td>
          <td width="35%"><input name="serie_texto" type="text"  size="24" />
		  <input name="serie" type="hidden" value="37" size="25"/>
            </td>
        </tr>
        <tr>
...
?>
    ...
    <tr>
	  ...
	  <table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#082BADD">
        <tr>
          <td width="90" background="images/fonod_lote.jpg" class="ewTableHeader">
              <div  align="center">CONCEPTO</div></td>
          <td width="500" background="images/fonod_lote.jpg" class="ewTableHeader">
              <div align="center">DESCRIPCION</div></td>
          
          <td width="150" background="images/fonod_lote.jpg" class="ewTableHeader">
              <div align="center">IMPORTE</div></td>
        </tr>
       
        
		<tr>
          <td bgcolor="#82BADD"> <input name="lote" type="text" id="lote" size="10" value="1" readonly=""/></td>
          <td bgcolor="#82BADD"><input name="descripcion" type="text" class="phpmaker" id="descripcion" size="80" />		  </td><input name="secuencia" type="hidden" class="phpmaker"  size="64"  value="1"/>
         
          <td width="150" bgcolor="#82BADD"><input name="importe" type="text" id="importe"  onchange="validarFormulario(this.form)" size="10"   /></td>
          </tr>
		 <tr>
    ...
    <td width="149" bgcolor="#82BADD"><input name="importe1" type="text" id="importe1" onchange="validarFormulario(this.form)" size="10"  /></td>
	<input name="secuencia1" type="hidden" class="phpmaker" id="secuencia1" size="64" value="2" />
		 ...
		 <tr>
          ...
          <td width="149" bgcolor="#82BADD"><input name="importe2" type="text" id="importe2" onchange="validarFormulario(this.form)" size="10" /></td>
          ...
          <td width="149" bgcolor="#82BADD"><input name="importe3" type="text" id="importe3" onchange="validarFormulario(this.form)" size="10" /></td>
          ...
          <td width="149" bgcolor="#82BADD"><input name="importe4" type="text" id="importe4" onchange="validarFormulario(this.form)" size="10" /></td>
          ...
          <td width="149" bgcolor="#82BADD"><input name="importe5" type="text" id="importe5" onchange="validarFormulario(this.form)" size="10" /></td>
		 ...
		 <tr>
          ...
          <td bgcolor="#82BADD"><input name="descripcion6" type="text" class="phpmaker" id="descripcion6" size="64" /></td>
		   ...
		   <td width="149" bgcolor="#82BADD"><input name="importe6" type="text" id="importe6" onchange="validarFormulario(this.form)" size="10" /></td>
		 ...
		 <tr>
          ...
          <td width="149" bgcolor="#82BADD"><input name="importe7" type="text" id="importe7" onchange="validarFormulario(this.form)" size="10" /></td>
		 ...
		 <tr>
          ...
          <td width="149" bgcolor="#82BADD"><input name="importe8" type="text" id="importe8" onchange="validarFormulario(this.form)" size="10" /></td>
		 ...
		 <tr>
          ...
          <td width="149" bgcolor="#82BADD"><input name="importe9" type="text" id="importe9" onchange="validarFormulario(this.form)" size="10" /></td>
		 ...
		 <tr>
          ...
          <td width="149" bgcolor="#82BADD"><input name="importe10" type="text" id="importe10" onchange="validarFormulario(this.form)" size="10" /></td>
		 ...
		 <tr>
          ...
          <td width="149" bgcolor="#82BADD"><input name="importe11" type="text" id="importe11" onchange="validarFormulario(this.form)" size="10" /></td>
		 ...
		 <tr>
          ...
          <td width="149" bgcolor="#82BADD"><input name="importe12" type="text" id="importe12" onchange="validarFormulario(this.form)" size="10" /></td>
		 ...
		 <tr>
          ...
          <td width="149" bgcolor="#82BADD"><input name="importe13" type="text" id="importe13" onchange="validarFormulario(this.form)" size="10" /></td>
		 <input name="secuencia13" type="hidden" class="phpmaker" id="secuencia13" size="64" value="14"/>
          ...
          <td width="149" bgcolor="#82BADD"><input name="importe14" type="text" id="importe14" onchange="validarFormulario(this.form)" size="10" /></td>
		 <input name="secuencia14" type="hidden" class="phpmaker" id="secuencia14" size="64" value="15"/>
		</tr>
      </table>      </td>
    </tr>
    <tr>
      <td width="538" rowspan="3" valign="top"><table width="94%" border="0" cellpadding="1" cellspacing="1" bgcolor="#82BADD"><tr>
	...
	<tr><td height="25" bgcolor="#82BADD" border="1" class="ewTableHeader">&nbsp;Imprimir   </td><td bgcolor="#82BADD" ><input type="checkbox" name="imprime" value="1" />
      ...
      <td width="247" rowspan="3" valign="top"><table width="95%" height="115" border="1" cellpadding="1" cellspacing="1" bgcolor="#82BADD">
