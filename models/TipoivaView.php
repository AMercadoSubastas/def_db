 ...
 * Page class
 */
class TipoivaView extends Tipoiva
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TipoivaView";
    ...
    // CSS class/style
    public $CurrentPageName = "TipoivaView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("codnum") ?? Route("codnum")) !== null) {
            ...
            $returnUrl = "TipoivaList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "TipoivaList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
