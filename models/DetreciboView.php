 ...
 * Page class
 */
class DetreciboView extends Detrecibo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DetreciboView";
    ...
    // CSS class/style
    public $CurrentPageName = "DetreciboView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("codnum") ?? Route("codnum")) !== null) {
            ...
            $returnUrl = "DetreciboList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "DetreciboList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
