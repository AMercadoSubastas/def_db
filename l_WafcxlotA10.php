...
$query_Recordset1 = "SELECT * FROM remates WHERE servicios IS NOT NULL AND gastos IS NOT NULL AND codcli != 940 AND fecest >= NOW() ORDER BY `ncomp` desc";
...
<body>
<form id="form1" name="form1" method="post" action="WafcautxlotA10.php?<?php echo $cod_usuario?>">
  <table width="706" height="152" border="0" align="left" cellpadding="1" cellspacing="1">
    ...
    <tr>
      ...
      <td height="10" class="ewTableHeader"> </td>
          <td><select name="remate_num" id="remate_num" required="required">
