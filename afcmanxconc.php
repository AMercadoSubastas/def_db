...
// LO GUARDO PARA QUE ARME BIEN LA MASCARA
...
if (isset($_POST['descripcion']) && GetSQLValueString($_POST['descripcion'], "text")!="NULL") {
	...
	if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
		//echo "insert detfac 1";
  		$insertSQL = sprintf("INSERT INTO detfac (tcomp, serie, ncomp, nreng, codrem , descrip, neto,  concafac) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",              	GetSQLValueString($_POST['tcomp'], "int"),
...
if (isset($_POST['descripcion']) && GetSQLValueString($_POST['descripcion'], "text")!="NULL") {
 	...
 	$tcomp = $_POST['tcomp'];
  	if ($tcomp==28)
		...
		$serie = 5; // antes decia 11 $_POST['serie'];
	...
	if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
		...
		if ($totalRows_medios_pago==0 && strcmp(GetSQLValueString($_POST['GrupoOpciones1'], "text"),"'S'")==0) {
			...
			// MODIFICADO PARA VER SI AHORA GRABA EL EFVO CUANDO CORRESPONDE
   			mysqli_select_db($amercado, $database_amercado);
			...
			// COMENTADO 13-11-2010 LO DESCOMENTO PARA QUE SALGA EL EFECTIVO, HAY QUE VER PORQUE SALE SIEMPRE 
...
//ACA VEO SI ES FACTURA A

mysqli_select_db($amercado, $database_amercado);
$query_facturas_a = "SELECT * FROM series  WHERE series.tipcomp = $serie";
...
//ACA VEO SI ES FACTURA B
mysqli_select_db($amercado, $database_amercado);
$query_facturas_b = "SELECT * FROM series  WHERE series.tipcomp=$serie";
...
function forma_pago(form) {
	...
	var cliente          = factura.codnum.value ;
  	...
  	var error ="";
  	if (tipo_comprobante=="" || total=="" || serie_num=="" || fecha_factura1=="" || cliente=="") {
    	if (tipo_comprobante=="") {
...
function agregarOpciones(form)
{
	var selec = form.tipos.options;
    	...
    	if (selec[1].selected == true) {
			...
			factura.serie_texto.value = "SERIE CONCEPTOS A0002";
			factura.tcomp.value = 19;
	   	}

    	if (selec[2].selected == true) {
	
			factura.serie.value = 12;
			factura.serie_texto.value = "SERIE CONCEPTOS B0002";
			factura.tcomp.value = 28;
...
<form id="factura" name="factura" method="POST" action="<?php echo $editFormAction; ?>">
  <table width="672" height="902" border="0" align="left" cellpadding="1" cellspacing="1" bgcolor="#82BADD">
    <tr>
      <td colspan="3" background="images/fondo_titulos.jpg"><div align="center"><img src="images/carga_man_conc.gif" width="450" height="30" /></div></td>
    </tr>
    <tr>
      <td colspan="3" valign="top" bgcolor="#82BADD"><table width="100%" border="1" cellspacing="1" cellpadding="1">
		 ...
		 <td width="14%" height="20" class="ewTableHeader">&nbsp;Tipo de Comprobante </td>
          <td width="35%"><select name="tipos" onChange="agregarOpciones(this.form)">
                                      ...
                                      <option value="19">FACT MANUAL DE CONCEPTOS A</option>
                                      <option value="28">FACT MANUAL DE CONCEPTOS B</option>
                           </select>
		  <input name="tcomp" type="hidden"  size="25" >
		         </td>
          <td width="6%"></td>
          <td width="10%" class="ewTableHeader">Serie</td>
          <td width="35%"><input name="serie_texto" type="text"  size="22" />
        ...
        <tr>
          ...
          <td><input name="fecha_factura1" type="text" size="22" id="fecha_factura1"  />
        ...
        <tr>
          ...
          <td colspan="2" rowspan="4" valign="top" bgcolor="#82BADD" ><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#003366">
            <tr>
              <td colspan="2" bgcolor="#82BADD" align="center"><img src="images/cond_pago.gif" width="150" height="30" /></td>
            </tr>
            <tr>
              <td width="62%" bgcolor="#82BADD">&nbsp;<span class="ewTableHeader">Contado</span></td>
              <td width="38%" bgcolor="#82BADD"><input name="GrupoOpciones1" type="radio" value="S" checked="checked"onclick="pendiente(this.form)"  /></td>
            </tr>
            <tr>
             ...
             <tr>
              <td width="62%" bgcolor="#82BADD">&nbsp;<span class="ewTableHeader">Afecta Liq</span></td>
              <td width="38%" bgcolor="#82BADD"><input name="GrupoOpciones2" type="radio" value='1' onclick="liquidacion(this.form)"  /></td>
            </tr>
            <tr>
              <td bgcolor="#82BADD">&nbsp;<span class="ewTableHeader">No afecta Liq</span></td>
              <td bgcolor="#82BADD"><input type="radio" name="GrupoOpciones2" value='0' checked="checked"onClick="liquidacion(this.form)"/></td>
            </tr>
          </table></td>
          </tr>
        <tr>
...
?>
    ...
    <tr>
      <td width="424" rowspan="3" valign="top"><table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#82BADD"><tr>
	...
	<tr><td height="25" bgcolor="#82BADD" border="1" class="ewTableHeader">&nbsp;Imprimir   </td><td bgcolor="#82BADD" ><input type="checkbox" name="imprime" value="1" />
      ...
      <td width="210" rowspan="3" valign="top"><table width="111%" height="115" border="1" cellpadding="1" cellspacing="1" bgcolor="#82BADD">
    ...
    <tr>
      <td width="22" height="20" valign="top"><input name="iva21" type="hidden" size="12" value="<?php echo $iva_21_porcen     ?>"/></td>
    </tr>
    <tr>
