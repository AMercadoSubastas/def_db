...
/**
 * a_fcxconci controller
 */
class AFcxconciController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/AFcxconci[/{params:.*}]", [PermissionMiddleware::class], "custom.a_fcxconci")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "AFcxconci");
    }
}
