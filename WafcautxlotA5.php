...
$rangos = mysqli_query( $query_rangos, $amercado) or die("ERROR LEYENDO RANGOS");
...
if ($sigo_y_grabo == 1 && $todo_ok ==1) {
		...
		if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
			...
			//============================================================================
  			$insertSQL = sprintf("INSERT INTO detfac (tcomp, serie, ncomp, codrem, codlote, descrip, neto, porciva, comcob, usuario) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       51, //GetSQLValueString($_POST['tcomp'], "int"),
                       29, //GetSQLValueString($_POST['serie'], "int"),
                       $num_fac,
                       GetSQLValueString($_POST['remate_num'], "int"),
	...
	if (isset($_POST['lote']) && GetSQLValueString($_POST['lote'], "int")!="NULL") {
  		...
  		$query_mascara = "SELECT * FROM series  WHERE series.tipcomp= '51' AND series.codnum='29'";//'$tcomp'  AND series.codnum='$serie'";
...
var selec = form.tipos.options;
		...
		factura.serie_texto.value = "SERIE DE FACTURA A0004";
		factura.tcomp.value = 51;
    ...
    <tr>
      ...
      <td width="14%" height="20" bgcolor="#82BADD">&nbsp;<span class="ewTableHeader">Tipo de Cbte </span></td>
          <td width="40%"><select name="tipos" onChange="agregarOpciones(this.form)">
                                      <option value="51">FACTURA POR LOTES A0004</option>
                                     
                           </select>
		  <input name="tcomp" id="tcomp"  type="hidden" value="51"/>
		         </td>
          <td width="1%">&nbsp;</td>
          <td width="12%" class="ewTableHeader">&nbsp;Serie</td>
          <td width="33%"><input name="serie_texto" type="text"  size="25" value="SERIE DE FACTURA A0004"/>
		  <input name="serie" type="hidden"  size="25" value="29"/>
            </td>
        </tr>
        <tr>
...
?>
    ...
    <tr>
      ...
      ?>
		...
		<td bgcolor="#82BADD" width="59" align="center"><input type="radio" name="impuesto" value="<?php  echo $iva_15_porcen     ?>"  
                                                               <?php if ($nuevo == 0) { ?> 
                                                               onclick="validarFormulario(this.form)"
                                                              <?php } else { ?> 
                                                               onclick="validarFormularioNew(this.form)"
                                                               <?php }  ?>/>
		</td>
		 
		<td bgcolor="#82BADD" width="31" align="center"><input type="radio" name="impuesto" value="<?php  echo $iva_21_porcen     ?>" 
                                                               <?php if ($nuevo == 0) { ?> onclick="validarFormulario(this.form)"
                                                              <?php } else { ?> onclick="validarFormularioNew(this.form)" 
                                                               <?php } ?> /> 
		</td>
	...
	<td bgcolor="#82BADD" width="59" align="center"><input type="radio" name="impuesto1" value="<?php  echo $iva_15_porcen     ?>" <?php if ($nuevo == 0) { ?> onclick="validarFormulario(this.form)"
                                                              <?php } else { ?> onclick="validarFormularioNew(this.form)" <?php } ?> /></td>
	<td bgcolor="#82BADD" width="31" align="center"><input type="radio" name="impuesto1" value="<?php  echo $iva_21_porcen     ?>" <?php if ($nuevo == 0) { ?> onclick="validarFormulario(this.form)"
                                                              <?php } else { ?> onclick="validarFormularioNew(this.form)" <?php } ?> /></td>
      ...
      ?>
		  ...
		  <td bgcolor="#82BADD" width="59" align="center"><input type="radio" name="impuesto2" value="<?php  echo $iva_15_porcen     ?>" <?php if ($nuevo == 0) { ?> onclick="validarFormulario(this.form)"
                                                              <?php } else { ?> onclick="validarFormularioNew(this.form)" <?php } ?> /></td>
		  <td bgcolor="#82BADD" width="31" align="center"><input type="radio" name="impuesto2" value="<?php  echo $iva_21_porcen     ?>" <?php if ($nuevo == 0) { ?> onclick="validarFormulario(this.form)"
                                                              <?php } else { ?> onclick="validarFormularioNew(this.form)" <?php } ?> /></td>
      ...
      ?>
		  ...
		  <td bgcolor="#82BADD" width="59" align="center"><input type="radio" name="impuesto3" value="<?php  echo $iva_15_porcen     ?>"  <?php if ($nuevo == 0) { ?> onclick="validarFormulario(this.form)"
                                                              <?php } else { ?> onclick="validarFormularioNew(this.form)" <?php } ?> /></td>
		  <td bgcolor="#82BADD" width="31" align="center"><input type="radio" name="impuesto3" value="<?php  echo $iva_21_porcen     ?>"  <?php if ($nuevo == 0) { ?> onclick="validarFormulario(this.form)"
                                                              <?php } else { ?> onclick="validarFormularioNew(this.form)" <?php } ?> /></td>
      ...
      ?>
          ...
          <td bgcolor="#82BADD"><input name="importe4" type="text" id="importe4" onBlur="MM_validateForm('importe4','','NisNum');return document.MM_returnValue" size="10" /></td>
		   <td bgcolor="#82BADD" width="59" align="center"><input type="radio" name="impuesto4" value="<?php echo $iva_15_porcen     ?>"  <?php if ($nuevo == 0) { ?> onclick="validarFormulario(this.form)"
                                                              <?php } else { ?> onclick="validarFormularioNew(this.form)" <?php } ?> /></td>
		  <td bgcolor="#82BADD" width="31" align="center"><input type="radio" name="impuesto4" value="<?php  echo $iva_21_porcen     ?>"  <?php if ($nuevo == 0) { ?> onclick="validarFormulario(this.form)"
                                                              <?php } else { ?> onclick="validarFormularioNew(this.form)" <?php } ?> /></td>
      ...
      ?>
		  ...
		  <td bgcolor="#82BADD" width="59" align="center"><input type="radio" name="impuesto5" value="<?php  echo $iva_15_porcen     ?>"  <?php if ($nuevo == 0) { ?> onclick="validarFormulario(this.form)"
                                                              <?php } else { ?> onclick="validarFormularioNew(this.form)" <?php } ?> /></td>
		  <td bgcolor="#82BADD" width="31" align="center"><input type="radio" name="impuesto5" value="<?php  echo $iva_21_porcen     ?>" <?php if ($nuevo == 0) { ?> onclick="validarFormulario(this.form)"
                                                              <?php } else { ?> onclick="validarFormularioNew(this.form)" <?php } ?> /></td>
      ...
      ?>
          ...
          <td bgcolor="#82BADD"><input name="descripcion6" type="text" class="phpmaker" id="descripcion6" size="45" /></td>
           ...
           <td bgcolor="#82BADD" width="59" align="center"><input type="radio" name="impuesto6" value="<?php  echo $iva_15_porcen     ?>"  <?php if ($nuevo == 0) { ?> onclick="validarFormulario(this.form)"
                                                              <?php } else { ?> onclick="validarFormularioNew(this.form)" <?php } ?> /></td>
		  <td bgcolor="#82BADD" width="31" align="center"><input type="radio" name="impuesto6" value="<?php  echo $iva_21_porcen     ?>"  <?php if ($nuevo == 0) { ?> onclick="validarFormulario(this.form)"
                                                              <?php } else { ?> onclick="validarFormularioNew(this.form)" <?php } ?>/></td>
      ...
      ?>
		 ...
		 <td bgcolor="#82BADD" width="59" align="center"><input type="radio" name="impuesto7" value="<?php  echo $iva_15_porcen     ?>"  <?php if ($nuevo == 0) { ?> onclick="validarFormulario(this.form)"
                                                              <?php } else { ?> onclick="validarFormularioNew(this.form)" <?php } ?> /></td>
		  <td bgcolor="#82BADD" width="31" align="center"><input type="radio" name="impuesto7" value="<?php  echo $iva_21_porcen     ?>"  <?php if ($nuevo == 0) { ?> onclick="validarFormulario(this.form)"
                                                              <?php } else { ?> onclick="validarFormularioNew(this.form)" <?php } ?> /></td>
      ...
      ?>
		  ...
		  <td bgcolor="#82BADD" width="59" align="center"><input type="radio" name="impuesto8" value="<?php echo $iva_15_porcen     ?>"  <?php if ($nuevo == 0) { ?> onclick="validarFormulario(this.form)"
                                                              <?php } else { ?> onclick="validarFormularioNew(this.form)" <?php } ?> /></td>
		  <td bgcolor="#82BADD" width="31" align="center"><input type="radio" name="impuesto8" value="<?php  echo $iva_21_porcen     ?>"  <?php if ($nuevo == 0) { ?> onclick="validarFormulario(this.form)"
                                                              <?php } else { ?> onclick="validarFormularioNew(this.form)" <?php } ?> /></td>
      ...
      ?>
		  ...
		  <td bgcolor="#82BADD" width="59" align="center"><input type="radio" name="impuesto9" value="<?php  echo $iva_15_porcen     ?>"  <?php if ($nuevo == 0) { ?> onclick="validarFormulario(this.form)"
                                                              <?php } else { ?> onclick="validarFormularioNew(this.form)" <?php } ?> /></td>
		  <td bgcolor="#82BADD" width="31" align="center"><input type="radio" name="impuesto9" value="<?php  echo $iva_21_porcen     ?>"  <?php if ($nuevo == 0) { ?> onclick="validarFormulario(this.form)"
                                                              <?php } else { ?> onclick="validarFormularioNew(this.form)" <?php } ?> /></td>
      ...
      ?>
         ...
         <td bgcolor="#82BADD"><input name="comision10" type="text" id="comision10" size="5" /></td> 
		  ...
		  <td bgcolor="#82BADD" width="59" align="center"><input type="radio" name="impuesto10" value="<?php  echo $iva_15_porcen     ?>"  <?php if ($nuevo == 0) { ?> onclick="validarFormulario(this.form)"
                                                              <?php } else { ?> onclick="validarFormularioNew(this.form)" <?php } ?> /></td>
		  <td bgcolor="#82BADD" width="31" align="center"><input type="radio" name="impuesto10" value="<?php  echo $iva_21_porcen     ?>"  <?php if ($nuevo == 0) { ?> onclick="validarFormulario(this.form)"
                                                              <?php } else { ?> onclick="validarFormularioNew(this.form)" <?php } ?> /></td>
      ...
      ?>
		  ...
		  <td bgcolor="#82BADD" width="59" align="center"><input type="radio" name="impuesto11" value="<?php  echo $iva_15_porcen     ?>"  <?php if ($nuevo == 0) { ?> onclick="validarFormulario(this.form)"
                                                              <?php } else { ?> onclick="validarFormularioNew(this.form)" <?php } ?> /></td>
		  <td bgcolor="#82BADD" width="31" align="center"><input type="radio" name="impuesto11" value="<?php  echo $iva_21_porcen     ?>"  <?php if ($nuevo == 0) { ?> onclick="validarFormulario(this.form)"
                                                              <?php } else { ?> onclick="validarFormularioNew(this.form)" <?php } ?> /></td>
      ...
      ?>
		  ...
		  <td bgcolor="#82BADD" width="59" align="center"><input type="radio" name="impuesto12" value="<?php  echo $iva_15_porcen     ?>"  <?php if ($nuevo == 0) { ?> onclick="validarFormulario(this.form)"
                                                              <?php } else { ?> onclick="validarFormularioNew(this.form)" <?php } ?> /></td>
		  <td bgcolor="#82BADD" width="31" align="center"><input type="radio" name="impuesto12" value="<?php  echo $iva_21_porcen     ?>"  <?php if ($nuevo == 0) { ?> onclick="validarFormulario(this.form)"
                                                              <?php } else { ?> onclick="validarFormularioNew(this.form)" <?php } ?> /></td>
      ...
      ?>
		 ...
		 <td bgcolor="#82BADD" width="59" align="center"><input type="radio" name="impuesto13" value="<?php echo $iva_15_porcen     ?>"  <?php if ($nuevo == 0) { ?> onclick="validarFormulario(this.form)"
                                                              <?php } else { ?> onclick="validarFormularioNew(this.form)" <?php } ?> /></td>
		  <td bgcolor="#82BADD" width="31" align="center"><input type="radio" name="impuesto13" value="<?php  echo $iva_21_porcen     ?>"  <?php if ($nuevo == 0) { ?> onclick="validarFormulario(this.form)"
                                                              <?php } else { ?> onclick="validarFormularioNew(this.form)" <?php } ?> /></td>
      ...
      ?>
        ...
        <td bgcolor="#82BADD"><input name="comision14" type="text" id="comision14" size="5" /></td>
		 ...
		 <td bgcolor="#82BADD" width="59" align="center"><input type="radio" name="impuesto14" value="<?php  echo $iva_15_porcen     ?>"  <?php if ($nuevo == 0) { ?> onclick="validarFormulario(this.form)"
                                                              <?php } else { ?> onclick="validarFormularioNew(this.form)" <?php } ?> /></td>
		  <td bgcolor="#82BADD" width="31" align="center"><input type="radio" name="impuesto14" value="<?php  echo $iva_21_porcen     ?>"  <?php if ($nuevo == 0) { ?> onclick="validarFormulario(this.form)"
                                                              <?php } else { ?> onclick="validarFormularioNew(this.form)" <?php } ?> /></td>
