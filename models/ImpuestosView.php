 ...
 * Page class
 */
class ImpuestosView extends Impuestos
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ImpuestosView";
    ...
    // CSS class/style
    public $CurrentPageName = "ImpuestosView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("codnum") ?? Route("codnum")) !== null) {
            ...
            $returnUrl = "ImpuestosList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ImpuestosList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
