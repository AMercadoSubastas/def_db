 ...
 * Page class
 */
class DirRematesView extends DirRemates
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DirRematesView";
    ...
    // CSS class/style
    public $CurrentPageName = "DirRematesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("codigo") ?? Route("codigo")) !== null) {
            ...
            $returnUrl = "DirRematesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "DirRematesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
