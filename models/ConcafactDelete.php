 ...
 * Page class
 */
class ConcafactDelete extends Concafact
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ConcafactDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ConcafactDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ConcafactList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ConcafactList"); // Return to list
                return;
            }
        }
