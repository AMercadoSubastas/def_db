...
<body>
<form id="form1" class="container" name="form1" method="post" action="WafcautxlotA.php?<?php echo $cod_usuario?>">
  <table width="706" height="152" border="0" align="left" cellpadding="1" cellspacing="1">
    <tr>
    </tr>
	  <td><input hidden name="codusu" id="codusu" type="text"  size="12" value="<?php echo $cod_usuario ?>"/></td>
    <tr>
      <td width="234">&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
