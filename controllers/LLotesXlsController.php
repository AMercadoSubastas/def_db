...
/**
 * l_lotes_xls controller
 */
class LLotesXlsController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/LLotesXls[/{params:.*}]", [PermissionMiddleware::class], "custom.l_lotes_xls")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "LLotesXls");
    }
}
