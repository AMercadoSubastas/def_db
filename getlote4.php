...
//  fclose($f1); 
 ...
 // $chau ="12";
  ...
  $chau = $inf["comiscobr"];
  $secu = $inf["secuencia"];
   echo "formObj5.descripcion4.value = '".$hola."';\n";  
  //  echo "formObj.descripcion.value = '".$inf["descor"]."';\n";    
    echo "formObj5.comision4.value = '".$chau."';\n";    
	echo "formObj5.secuencia4.value = '".$secu."';\n";    
    } else {
   ...
   echo "formObj5.descripcion4.value = '".$item."';\n";  
   
   
   }      
    
  }else{
    echo "formObj5.descripcion4.value  = '';\n";    
    echo "formObj5.comision4.value = '';\n";    
	    echo "formObj5.secuencia4.value = '';\n";    
