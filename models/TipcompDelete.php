 ...
 * Page class
 */
class TipcompDelete extends Tipcomp
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TipcompDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "TipcompDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("TipcompList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("TipcompList"); // Return to list
                return;
            }
        }
