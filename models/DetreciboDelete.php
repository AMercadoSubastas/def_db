 ...
 * Page class
 */
class DetreciboDelete extends Detrecibo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DetreciboDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "DetreciboDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("DetreciboList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("DetreciboList"); // Return to list
                return;
            }
        }
