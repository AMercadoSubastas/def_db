 ...
 * l_ivaxls controller
 */
class LIvaxlsController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/LIvaxls[/{params:.*}]", [PermissionMiddleware::class], "custom.l_ivaxls")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "LIvaxls");
    }
}
