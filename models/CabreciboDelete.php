 ...
 * Page class
 */
class CabreciboDelete extends Cabrecibo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CabreciboDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "CabreciboDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("CabreciboList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("CabreciboList"); // Return to list
                return;
            }
        }
