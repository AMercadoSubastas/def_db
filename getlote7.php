...
//  fclose($f1); 
  ...
  if ($estado==0) {  
    ...
    $chau = $inf["comiscobr"];
    $secu = $inf["secuencia"];
   echo "formObj8.descripcion7.value = '".$hola."';\n";  
  //  echo "formObj.descripcion.value = '".$inf["descor"]."';\n";    
   echo "formObj8.comision7.value = '".$chau."';\n";    
   echo "formObj8.secuencia7.value = '".$secu."';\n";    
   } else {
   ...
   echo "formObj8.descripcion7.value = '".$item."';\n";  
   
   
   }      
    
  }else{
    echo "formObj8.descripcion7.value  = '".$mensaje."';\n";    
    echo "formObj8.comision7.value = '';\n";    
	echo "formObj8.secuencia7.value = '';\n";    
