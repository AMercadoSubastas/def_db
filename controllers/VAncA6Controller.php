 ...
 * v_ancA6 controller
 */
class VAncA6Controller extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/VAncA6[/{params:.*}]", [PermissionMiddleware::class], "custom.v_ancA6")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "VAncA6");
    }
}
