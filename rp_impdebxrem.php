...
$tot_efe = 0.00;
	...
	while($row_remate = mysqli_fetch_array($result_remate)) {
		...
		$query_cabfac = sprintf("SELECT * FROM cabfac WHERE  codrem = $remate AND (((tcomp = 115 OR tcomp = 116 OR tcomp = 117) AND estado = 'S') OR (tcomp IN (119,120,122,123,124) AND en_liquid = 1)) ORDER BY tcomp,ncomp");
