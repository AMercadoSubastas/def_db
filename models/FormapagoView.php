 ...
 * Page class
 */
class FormapagoView extends Formapago
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FormapagoView";
    ...
    // CSS class/style
    public $CurrentPageName = "FormapagoView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("codnum") ?? Route("codnum")) !== null) {
            ...
            $returnUrl = "FormapagoList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "FormapagoList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
