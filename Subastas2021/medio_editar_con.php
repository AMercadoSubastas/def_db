...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  	$updateSQL = sprintf("UPDATE cartvalores SET importe=%s WHERE codnum=%s",
  	...
  	$updateGoTo = "medios_pago_con.php";
  	if (isset($_SERVER['QUERY_STRING'])) {
...
<form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
  <table width="500" border="0" cellpadding="1" cellspacing="1" bgcolor="#FFFFCC">
    <tr>
      <td colspan="2" bgcolor="#336666" class="ewGroupAggregate Estilo1" ><div align="center">Editar transaccion </div></td>
    </tr>
    ...
    <tr>
      ...
      <td bgcolor="#993333"><input type="submit" name="Submit" value="Enviar" /></td>
    </tr>
  </table>
