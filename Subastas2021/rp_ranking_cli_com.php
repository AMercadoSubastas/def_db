...
$pdf->SetY(15);
$pdf->Cell(70);
$pdf->Cell(20,10,' Ranking de Comisiones por Cliente',0,0,'L');
$pdf->SetFont('Arial','B',9);
$pdf->SetY(25);
$pdf->Cell(10);
$pdf->Cell(60,8,'     Raz�n Social  ',1,0,'L');
$pdf->Cell(25,8,'       CUIT  ',1,0,'L');
$pdf->Cell(45,8,'     Total Comisiones      ',1,0,'L');
...
{	
	...
	if ($tcomp ==  57 ||  $tcomp ==  58 || $tcomp == 61 || $tcomp == 62 || $tcomp == 5 || $tcomp == 6 || $tcomp == 25 || $tcomp == 26 || $tcomp == 46 || $tcomp == 47 ) {
		$tc = "NC-";
		$signo = -1;
	}
	...
	$cliente = $row_cabecerafac["cliente"];
	if ($tcomp ==  18 ||  $tcomp ==  19 || $tcomp == 27 || $tcomp == 28 ||  $tcomp ==  44 || $tcomp == 45 || $tcomp == 52 ||  $tcomp ==  54 || $tcomp == 55 || $tcomp == 56) {
		$total   = ($row_cabecerafac["totneto21"]) * $signo;
	}
	else {
		$total   = ($row_cabecerafac["totcomis"]) * $signo;
	}
		// Acumulo subtotales
...
$linea = 0;
for ($j=0;$j < ($cant_cli > $i ? $i : $cant_cli);$j++) {
	if ($linea < 48) {
