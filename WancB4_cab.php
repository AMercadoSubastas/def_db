...
//if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
	...
	$query_cliente2 = sprintf("SELECT * FROM entidades WHERE codnum = 10242"); //%s",GetSQLValueString($_POST['codnum'],"int"));
    ...
    $ImpTotal     = 7027.68; //$_POST['tot_general']; //GetSQLValueString($_POST['tot_general'], "double"); //121.00;
    $ImpTotConc   = 0.00; // GetSQLValueString($_POST['totiva21_1'], "double"); // 0.00;
    $ImpNeto      = 3513.84;// $_POST['totneto21'] + $_POST['totneto105'] + $_POST['totcomis'];//GetSQLValueString($_POST['totneto21'], "double") + GetSQLValueString($_POST['totneto105'], "double"); //100.00;
    $ImpOpEx      = 0.00;
    $ImpIVA       = 3513.84; //$_POST['totiva21'] + $_POST['totiva105'];//GetSQLValueString($_POST['totiva21'], "double") + GetSQLValueString($_POST['totiva105'], "double"); // 21.00;
    $ImpTrib      = 0.00;
	...
	if (isset($_POST['totneto105']) && $_POST['totneto105'] != 0.00) {
	    ...
	    $IvaAlicuotaBaseImp = 3513.84; //$_POST['totneto21'] + $_POST['totcomis'];// 100.00;
    	$IvaAlicuotaImporte = 3513.84; //$_POST['totiva21'] ;//21.00;   
