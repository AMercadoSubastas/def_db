...
/**
 * lista_pasolotesweb controller
 */
class ListaPasoloteswebController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/ListaPasolotesweb[/{params:.*}]", [PermissionMiddleware::class], "custom.lista_pasolotesweb")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "ListaPasolotesweb");
    }
}
