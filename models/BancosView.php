 ...
 * Page class
 */
class BancosView extends Bancos
{
    use MessagesTrait;
    ...
    // CSS class/style
    public $CurrentPageName = "BancosView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("codnum") ?? Route("codnum")) !== null) {
            ...
            $returnUrl = "BancosList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "BancosList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
