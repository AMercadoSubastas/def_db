...
/**
 * v_afcautxconc controller
 */
class VAfcautxconcController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/VAfcautxconc[/{params:.*}]", [PermissionMiddleware::class], "custom.v_afcautxconc")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "VAfcautxconc");
    }
}
