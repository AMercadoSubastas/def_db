...
/**
 * lista_catalogo controller
 */
class ListaCatalogoController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/ListaCatalogo[/{params:.*}]", [PermissionMiddleware::class], "custom.lista_catalogo")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "ListaCatalogo");
    }
}
