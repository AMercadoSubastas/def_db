...
// DESDE ACA =======================================================================================
if (GetSQLValueString($_POST['pago_contado'], "int")=="1") {
...
<script language="javascript">
 function forma_pago(form)
 {
  ...
  var error ="";
  if (tipo_comprobante=="" || total=="" || serie_num=="" || remate_num=="") {
      if (tipo_comprobante=="") {
    ...
    <tr>
      <td colspan="3" valign="top" bgcolor="#003366"><table width="100%" border="0" cellspacing="1" cellpadding="1">
        ...
        <tr>
          ...
          <td><input name="num_factura" type="num_factura" class="phpmakerlist" id="ncomp"  width="25" value="<?php echo $num_comp ?>"/></td>
          <td>&nbsp;</td>
