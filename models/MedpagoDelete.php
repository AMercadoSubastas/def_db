 ...
 * Page class
 */
class MedpagoDelete extends Medpago
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MedpagoDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "MedpagoDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("MedpagoList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("MedpagoList"); // Return to list
                return;
            }
        }
