...
/**
 * l_citiventas_alic controller
 */
class LCitiventasAlicController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/LCitiventasAlic[/{params:.*}]", [PermissionMiddleware::class], "custom.l_citiventas_alic")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "LCitiventasAlic");
    }
}
