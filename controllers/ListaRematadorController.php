...
/**
 * lista_rematador controller
 */
class ListaRematadorController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/ListaRematador[/{params:.*}]", [PermissionMiddleware::class], "custom.lista_rematador")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "ListaRematador");
    }
}
