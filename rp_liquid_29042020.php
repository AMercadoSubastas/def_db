...
$query_fclot = sprintf("SELECT * FROM cabfac WHERE  codrem = %s AND tcomp IN (1, 6, 51, 53, 57,58,59,60) AND ncompsal= %s " , $remate, $liquidacion);
...
$query_lotes = "SELECT * FROM detfac WHERE codrem = '$remate' AND (tcomp='1' OR tcomp='6' OR tcomp='23' OR tcomp='24' OR tcomp='51' OR tcomp='53' OR tcomp='57' OR tcomp='58' OR tcomp='59' OR tcomp='60') AND ncompsal= '$liquidacion' ORDER BY ncomp ASC";
