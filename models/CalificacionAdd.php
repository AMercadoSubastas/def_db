 ...
 * Page class
 */
class CalificacionAdd extends Calificacion
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CalificacionAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "CalificacionAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("CalificacionList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "CalificacionView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "CalificacionList") {
                            ...
                            $returnUrl = "CalificacionList"; // Return list page content
                        }
                    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("CalificacionList"), "", $this->TableVar, true);
