 ...
 * v_andB6 controller
 */
class VAndB6Controller extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/VAndB6[/{params:.*}]", [PermissionMiddleware::class], "custom.v_andB6")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "VAndB6");
    }
}
