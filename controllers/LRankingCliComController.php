...
/**
 * l_ranking_cli_com controller
 */
class LRankingCliComController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/LRankingCliCom[/{params:.*}]", [PermissionMiddleware::class], "custom.l_ranking_cli_com")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "LRankingCliCom");
    }
}
