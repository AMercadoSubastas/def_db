 ...
 * Page class
 */
class LocalidadesView extends Localidades
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LocalidadesView";
    ...
    // CSS class/style
    public $CurrentPageName = "LocalidadesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("codnum") ?? Route("codnum")) !== null) {
            ...
            $returnUrl = "LocalidadesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "LocalidadesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
