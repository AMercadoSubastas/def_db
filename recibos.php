...
if (isset($_POST['renglon1']) && GetSQLValueString($_POST['renglon1'], "int")!="NULL") {
	...
	if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "recibo")) {
		...
		$insertSQL = "INSERT INTO detrecibo (tcomp, serie, ncomp, nreng , tcomprel, serierel , ncomprel , netocbterel, usuario ,nrodoc) VALUES ('2', '3', '$recibo', '1' , '$tcomprel', '$serierel','$ncomprel','$netocbterel','$cod_usuario','$doc1')";
...
if (isset($_POST['renglon2']) && GetSQLValueString($_POST['renglon2'], "int")!="NULL") {
	if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "recibo")) {
		...
		$doc2 = $_POST['doc2'];
		$insertSQL = sprintf("INSERT INTO detrecibo (tcomp, serie, ncomp, nreng , tcomprel, serierel , ncomprel , netocbterel, usuario ,nrodoc) VALUES ('2', '3', '$recibo', '2' , %s, %s, %s, %s,'$cod_usuario', '$doc2')",
...
if (isset($_POST['renglon3']) && GetSQLValueString($_POST['renglon3'], "int")!="NULL") {
	if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "recibo")) {
		...
		$doc3 = $_POST['doc3'];
		$insertSQL = sprintf("INSERT INTO detrecibo (tcomp, serie, ncomp, nreng , tcomprel, serierel , ncomprel , netocbterel, usuario , nrodoc) VALUES ('2', '3', '$recibo', '3' , %s, %s, %s, %s,'$cod_usuario','$doc3' )",
...
if (isset($_POST['renglon4']) && GetSQLValueString($_POST['renglon4'], "int")!="NULL") {
	if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "recibo")) {
		...
		$insertSQL = sprintf("INSERT INTO detrecibo (tcomp, serie, ncomp, nreng , tcomprel, serierel , ncomprel , netocbterel, usuario, nrodoc) VALUES ('2', '3', '$recibo', '4' , %s, %s, %s, %s, '$cod_usuario','$doc4')",
...
if (isset($_POST['renglon5']) && GetSQLValueString($_POST['renglon5'], "int")!="NULL") {
	if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "recibo")) {
		...
		$insertSQL = sprintf("INSERT INTO detrecibo (tcomp, serie, ncomp, nreng , tcomprel, serierel , ncomprel , netocbterel, usuario ,nrodoc) VALUES ('2', '3', '$recibo', '5' , %s, %s, %s, %s, '$cod_usuario' ,'$doc5')",
...
if (isset($_POST['renglon6']) && GetSQLValueString($_POST['renglon6'], "int")!="NULL") {
	if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "recibo")) {
		...
		$doc6 = $_POST['doc6'];
		$insertSQL = sprintf("INSERT INTO detrecibo (tcomp, serie, ncomp, nreng , tcomprel, serierel , ncomprel , netocbterel, usuario, nrodoc) VALUES ('2', '3', '$recibo', '6' , %s, %s, %s, %s,'$cod_usuario', '$doc6' )",
...
if (isset($_POST['renglon7']) && GetSQLValueString($_POST['renglon7'], "int")!="NULL") {
	if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "recibo")) {
		...
		$doc7 = $_POST['doc7'];
		$insertSQL = sprintf("INSERT INTO detrecibo (tcomp, serie, ncomp, nreng , tcomprel, serierel , ncomprel , netocbterel, usuario, nrodoc) VALUES ('2', '3', '$recibo', '7' , %s, %s, %s, %s, '$cod_usuario', '$doc7' )",
...
if (isset($_POST['renglon8']) && GetSQLValueString($_POST['renglon8'], "int")!="NULL") {
	if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "recibo")) {
		...
		$insertSQL = sprintf("INSERT INTO detrecibo (tcomp, serie, ncomp, nreng , tcomprel, serierel , ncomprel , netocbterel, usuario,nrodoc) VALUES ('2', '3', '$recibo', '8' , %s, %s, %s, %s, '$cod_usuario','$doc8')",
...
if (isset($_POST['renglon9']) && GetSQLValueString($_POST['renglon9'], "int")!="NULL") {
	if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "recibo")) {
		...
		$insertSQL = sprintf("INSERT INTO detrecibo (tcomp, serie, ncomp, nreng , tcomprel, serierel , ncomprel , netocbterel, usuario,nrodoc) VALUES ('2', '3', '$recibo', '9' , %s, %s, %s, %s, '$cod_usuario','$doc9')",
...
if (isset($_POST['renglon10']) && GetSQLValueString($_POST['renglon10'], "int")!="NULL") {
	if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "recibo")) {
		...
		$doc10 = $_POST['doc10'];
		$insertSQL = sprintf("INSERT INTO detrecibo (tcomp, serie, ncomp, nreng , tcomprel, serierel , ncomprel , netocbterel, usuario,nrodoc) VALUES ('2', '3', '$recibo', '10' , %s, %s, %s, %s, '$cod_usuario','$doc10')",
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "recibo"))  {
	...
	$fecha = substr($fecha,6,4)."-".substr($fecha,3,2)."-".substr($fecha,0,2);
  	...
  	$insertSQL = sprintf("INSERT INTO cabrecibo (tcomp, serie, ncomp, cantcbtes, fecha , usuario , cliente , imptot ,emitido, usuarioultmod) VALUES ('2', '3', '$recibo', '$renglones' , '$fecha', '$cod_usuario', '$cliente' ,  '$tot_general', '0', $cod_usuario)");
  	mysqli_select_db($amercado, $database_amercado);
  	$Result1 = mysqli_query($amercado, $insertSQL) or die(mysqli_error($amercado));
...
<form id="recibo_cab" name="recibo" method="POST" action="<?php echo $editFormAction; ?>"> 
 ...
 <tr bgcolor="FFFFFF">
   ...
   <td bgcolor="#0099CC"><input type="submit" style="width:100%;" name="Submit" value="Grabar" /></td>
 </tr>
      </table></td>
    </tr>
