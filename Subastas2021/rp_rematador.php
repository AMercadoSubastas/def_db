...
if ($hojas == 0)
	$hojas = 1;
if ( $colname_remate == 3110 || $colname_remate == 3094)
	$hojas = $hojas + 1;

if ($colname_remate == 2357 || $colname_remate == 2368 || $colname_remate == 2386)  // || $colname_remate == 2348)
	$hojas = $hojas - 1;

if ( $colname_remate == 3068 || $colname_remate == 2377 || $colname_remate == 2328 || $colname_remate == 2094 || $colname_remate == 2051)
	$hojas = $hojas + 1;
