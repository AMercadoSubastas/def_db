...
<script language="javascript">
function agregarOpciones2(for  type="text/javascript"m)
{
var selec = form.tipos.options;
    if (selec[0].selected == true)
    {
    ...
    <script language="javascript">
tion validarFormulario(form)  type="text/javascript"
{
...
<script language="javascript">
// Concepto 2
function getpr type="text/javascript"ov1(form) {
...
<script language="javascript">
// TERCER CONCEPTO
function  type="text/javascript"getprov2(form) {
...
function getprov3(form) { type=""text/javascript
...
function getprov4(form) {
 type="text/javascript"	var seleccion4 = form.concepto4.options;
...
function getprov5(form) { type=""text/javascript
...
function getprov6(form) { type=""text/javascript
...
function getprov7(form) {
 type="text/javascript"	var seleccion7 = form.concepto7.options;
...
function getprov8(form) {
 type="text/javascript"	var seleccion8 = form.concepto8.options;
...
function getprov9(form) {
 type="text/javascript"	var seleccion9 = form.concepto9.options;
...
function getprov10(form) { type=""text/javascript
...
function getprov12(form) { type=""text/javascript
...
<script language="javascript">
 ...
 type="text/javascript"	var seleccion13 = form.concepto13.options;
...
{
 type="text/javascript"	alert("Debe ingresar al menos un lote para facturar");
}
</script> 
<script language="jconceptocript">
anguage="javascript" src="cal2.js" >
</script>
<script language="javascript" srctype="text/javascript"="cal_conf2.js"></script>

<script type="text/javascript" src="../js/ajax type="text/javascript".
js"></script>    
...
<!--
	...
	function neto(form) type=""text/javascript
			//alert("en MM_findObj    ");
...
function getRemate(form) {
	 type="text/javascript"var seleccion =  form.remate_num.options;
  ...
  <table width="640" border="1" align="left" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
    ...
    <tr>
      <td colspan="3" valign="top" bgcolor="#FFFFFF"><table width="100%" border="1" cellspacing="1" cellpadding="1">
        <tr>
      <td width="15%" height="20" bgcolor="#FFFFFF">&nbsp;<span class="ewTableHeader">Tipo de Cbte </span></td>
          <td width="40%"><select name="tipos" onChange="agregarOpciones(this.form)">
                                      <option value="122">NOTA DE DEBITO B0002</option>
                                     
                           </select>
		  <input name122tcomp" id="tcomp"  ty2e="hidden" />
		         </td>
        ...
        <tr>
          <td he53ht="20" class="ewTableHea2er">&nbsp;Nro Factura </td>
...
do {  
?>
            <option value="<?php echo $row_cliente['codnum']?>"><?php echo utf8_encode(substr($row_cliente['razsoc'],0,22))?><?php echo $row_cliente['cuit']?></option>
            <?php
...
?>
    ...
    <tr>
        <td colspan="3" valign="top" bgcolor="#FFFFFF"><table width="100%" border="1" cellspacing="1" cellpadding="1">
          ...
          <td width="20%"><select name="tcbterel2" onChange="agregarOpciones2(this.form)">
                              ...
                              <option value="8">N CRED B0002</option>
    ...
    <tr>
	  ...
	  <table width="100%" border="1" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
        <tr>
          ...
          <td width="10"  rowspan="2" background="images/fonod_lote.jpg" class="ewTableHeader">
    ...
    <tr>
      <td colspan="3" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
        ...
        <tr>
          <td><input name="totneto105"  type="hidden"  size="20" /></td>
          <td><input name="totneto21"   type="hidden"  size="20" /></td>
          <td><input name="totcomis"    type="hidden"  size="20" /></td>
          <td><input name="totiva105"   type="hidden"  size="20" /></td>
          <td><input name="totiva21"    type="hidden"  size="20" /></td>
          
          <td><input name="tot_general" type="hidden"  size="25" /></td>
        </tr>
		 <tr>
          <td><input name="totneto105_1"  type="text"  size="20" /></td>
          <td><input name="totneto21_1"   type="text"  size="20" /></td>
          <td><input name="totcomis_1"    type="text"  size="20" /></td>
          <td><input name="totiva105_1"   type="text"  size="20" /></td>
          <td><input name="totiva21_1"    type="text"  size="20" /></td>
          
          <td><input name="tot_general_1" type="text"  required="required" size="25" /></td>
        </tr>
      </table></td>
    </tr>
    <tr>
