 ...
 * v_ancman controller
 */
class VAncmanController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/VAncman[/{params:.*}]", [PermissionMiddleware::class], "custom.v_ancman")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "VAncman");
    }
}
