...
/**
 * v_afcautxlot controller
 */
class VAfcautxlotController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/VAfcautxlot[/{params:.*}]", [PermissionMiddleware::class], "custom.v_afcautxlot")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "VAfcautxlot");
    }
}
