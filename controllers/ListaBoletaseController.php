...
/**
 * lista_boletase controller
 */
class ListaBoletaseController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/ListaBoletase[/{params:.*}]", [PermissionMiddleware::class], "custom.lista_boletase")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "ListaBoletase");
    }
}
