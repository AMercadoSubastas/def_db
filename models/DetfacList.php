 ...
 * Page class
 */
class DetfacList extends Detfac
{
    use MessagesTrait;
    ...
    public $FormName = "fdetfaclist";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "DetfacList";
    ...
    public function __construct()
    {
        ...
        $this->MultiDeleteUrl = "DetfacDelete";
        $this->MultiUpdateUrl = "DetfacUpdate";
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server") {
            $savedFilterList = Profile()->getSearchFilters("fdetfacsrch");
        }
        ...
        $filterList = Concat($filterList, $this->nreng->AdvancedSearch->toJson(), ","); // Field nreng
        $filterList = Concat($filterList, $this->codrem->AdvancedSearch->toJson(), ","); // Field codrem
        $filterList = Concat($filterList, $this->codlote->AdvancedSearch->toJson(), ","); // Field codlote
        $filterList = Concat($filterList, $this->descrip->AdvancedSearch->toJson(), ","); // Field descrip
        $filterList = Concat($filterList, $this->neto->AdvancedSearch->toJson(), ","); // Field neto
        $filterList = Concat($filterList, $this->bruto->AdvancedSearch->toJson(), ","); // Field bruto
        ...
        $filterList = Concat($filterList, $this->comcob->AdvancedSearch->toJson(), ","); // Field comcob
        $filterList = Concat($filterList, $this->compag->AdvancedSearch->toJson(), ","); // Field compag
        ...
        $filterList = Concat($filterList, $this->concafac->AdvancedSearch->toJson(), ","); // Field concafac
        $filterList = Concat($filterList, $this->tcomsal->AdvancedSearch->toJson(), ","); // Field tcomsal
    ...
    protected function processFilterList()
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("fdetfacsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field nreng
        $this->nreng->AdvancedSearch->SearchValue = @$filter["x_nreng"];
        $this->nreng->AdvancedSearch->SearchOperator = @$filter["z_nreng"];
        $this->nreng->AdvancedSearch->SearchCondition = @$filter["v_nreng"];
        $this->nreng->AdvancedSearch->SearchValue2 = @$filter["y_nreng"];
        $this->nreng->AdvancedSearch->SearchOperator2 = @$filter["w_nreng"];
        $this->nreng->AdvancedSearch->save();
        ...
        // Field codlote
        $this->codlote->AdvancedSearch->SearchValue = @$filter["x_codlote"];
        $this->codlote->AdvancedSearch->SearchOperator = @$filter["z_codlote"];
        $this->codlote->AdvancedSearch->SearchCondition = @$filter["v_codlote"];
        $this->codlote->AdvancedSearch->SearchValue2 = @$filter["y_codlote"];
        $this->codlote->AdvancedSearch->SearchOperator2 = @$filter["w_codlote"];
        $this->codlote->AdvancedSearch->save();
        ...
        // Field neto
        $this->neto->AdvancedSearch->SearchValue = @$filter["x_neto"];
        $this->neto->AdvancedSearch->SearchOperator = @$filter["z_neto"];
        $this->neto->AdvancedSearch->SearchCondition = @$filter["v_neto"];
        $this->neto->AdvancedSearch->SearchValue2 = @$filter["y_neto"];
        $this->neto->AdvancedSearch->SearchOperator2 = @$filter["w_neto"];
        $this->neto->AdvancedSearch->save();

        // Field bruto
        $this->bruto->AdvancedSearch->SearchValue = @$filter["x_bruto"];
        $this->bruto->AdvancedSearch->SearchOperator = @$filter["z_bruto"];
        $this->bruto->AdvancedSearch->SearchCondition = @$filter["v_bruto"];
        $this->bruto->AdvancedSearch->SearchValue2 = @$filter["y_bruto"];
        $this->bruto->AdvancedSearch->SearchOperator2 = @$filter["w_bruto"];
        $this->bruto->AdvancedSearch->save();
        ...
        // Field comcob
        $this->comcob->AdvancedSearch->SearchValue = @$filter["x_comcob"];
        $this->comcob->AdvancedSearch->SearchOperator = @$filter["z_comcob"];
        $this->comcob->AdvancedSearch->SearchCondition = @$filter["v_comcob"];
        $this->comcob->AdvancedSearch->SearchValue2 = @$filter["y_comcob"];
        $this->comcob->AdvancedSearch->SearchOperator2 = @$filter["w_comcob"];
        $this->comcob->AdvancedSearch->save();

        // Field compag
        $this->compag->AdvancedSearch->SearchValue = @$filter["x_compag"];
        $this->compag->AdvancedSearch->SearchOperator = @$filter["z_compag"];
        $this->compag->AdvancedSearch->SearchCondition = @$filter["v_compag"];
        $this->compag->AdvancedSearch->SearchValue2 = @$filter["y_compag"];
        $this->compag->AdvancedSearch->SearchOperator2 = @$filter["w_compag"];
        $this->compag->AdvancedSearch->save();
        ...
        // Field concafac
        $this->concafac->AdvancedSearch->SearchValue = @$filter["x_concafac"];
        $this->concafac->AdvancedSearch->SearchOperator = @$filter["z_concafac"];
        $this->concafac->AdvancedSearch->SearchCondition = @$filter["v_concafac"];
        $this->concafac->AdvancedSearch->SearchValue2 = @$filter["y_concafac"];
        $this->concafac->AdvancedSearch->SearchOperator2 = @$filter["w_concafac"];
        $this->concafac->AdvancedSearch->save();

        // Field tcomsal
        $this->tcomsal->AdvancedSearch->SearchValue = @$filter["x_tcomsal"];
        $this->tcomsal->AdvancedSearch->SearchOperator = @$filter["z_tcomsal"];
        $this->tcomsal->AdvancedSearch->SearchCondition = @$filter["v_tcomsal"];
        $this->tcomsal->AdvancedSearch->SearchValue2 = @$filter["y_tcomsal"];
        $this->tcomsal->AdvancedSearch->SearchOperator2 = @$filter["w_tcomsal"];
        $this->tcomsal->AdvancedSearch->save();
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->nreng); // nreng
            $this->updateSort($this->codrem); // codrem
            $this->updateSort($this->codlote); // codlote
            $this->updateSort($this->descrip); // descrip
            $this->updateSort($this->neto); // neto
            $this->updateSort($this->bruto); // bruto
            $this->updateSort($this->iva); // iva
            $this->updateSort($this->imp); // imp
            $this->updateSort($this->comcob); // comcob
            $this->updateSort($this->compag); // compag
            ...
            $this->updateSort($this->concafac); // concafac
            $this->updateSort($this->tcomsal); // tcomsal
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->concafac->setSort("");
                $this->tcomsal->setSort("");
                ...
                if ($listAction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    if ($action != "") {
                        ...
                        $link = $disabled
                            ...
                            : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fdetfaclist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button></li>";
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = $disabled
                            ? "<div class=\"alert alert-light\">" . $icon . " " . $caption . "</div>"
                            : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . $title . "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fdetfaclist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button>";
                        }
                    }
                }
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "nreng");
            $this->createColumnOption($option, "codrem");
            $this->createColumnOption($option, "codlote");
            $this->createColumnOption($option, "descrip");
            $this->createColumnOption($option, "neto");
            $this->createColumnOption($option, "bruto");
            $this->createColumnOption($option, "iva");
            $this->createColumnOption($option, "imp");
            $this->createColumnOption($option, "comcob");
            $this->createColumnOption($option, "compag");
            ...
            $this->createColumnOption($option, "concafac");
            $this->createColumnOption($option, "tcomsal");
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fdetfacsrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fdetfacsrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions as $listAction) {
            if ($listAction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fdetfaclist"' . $listAction->toDataAttributes() . '>' . $icon . '</button>';
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fdetfaclist" data-ew-action="email" data-custom="false" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fdetfacsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
    ...
    */
    public function exportData($doc)
    {
        ...
        if (Config("EXPORT_MASTER_RECORD") && $this->DbMasterFilter != "" && $this->getCurrentMasterTable() == "cabfac") {
            $cabfac = new CabfacList();
            $rsmaster = $cabfac->loadRs($this->DbMasterFilter); // Load master record
            if ($rsmaster) {
                $exportStyle = $doc->Style;
                $doc->setStyle("v"); // Change to vertical
                if (!$this->isExport("csv") || Config("EXPORT_MASTER_RECORD_FOR_CSV")) {
                    $doc->setTable($cabfac);
                    $cabfac->exportDocument($doc, $rsmaster);
                    $doc->exportEmptyRow();
                    $doc->setTable($this);
                }
