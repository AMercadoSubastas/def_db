...
// Inicio el pdf con los datos de cabecera
  ...
  $pdf->SetY(15);
  $pdf->Cell(70);
  $pdf->Cell(20,10,' Percepciones y Retenciones Sufridas RG 3337 ',0,0,'L');
...
{	
	...
	// Leo cartvalores
	$query_cartvalores = sprintf("SELECT * FROM cartvalores WHERE  tcomp = 40 AND ((tcomprel = %d AND serierel = %d AND ncomprel = %d) OR (tcompsal = %d AND seriesal = %d AND ncompsal = %d))", $tcomp, $serie, $ncomp, $tcomp, $serie, $ncomp);
