...
$query_cabfac = sprintf("SELECT * FROM cabfac WHERE fecreg BETWEEN %s AND %s AND cliente = %s ORDER BY fecreg, nrodoc", $fecha_desde, $fecha_hasta, $cliente_form);
...
// Inicio el pdf con los datos de cabecera
  ...
  $pdf->SetY(15);
  $pdf->Cell(130);
  $pdf->Cell(20,10,' Libro IVA Ventas por Cliente',0,0,'L');
  ...
  $pdf->Cell(24,16,' IVA Debito',1,0,'L');
  $pdf->Cell(24,16,' Percepci�n',1,0,'L');
