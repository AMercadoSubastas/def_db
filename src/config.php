...
$CONFIG = [
    ...
    "PROJECT_STYLESHEET_FILENAME" => "css/Subastas2024.css", // Project stylesheet file name
    ...
    "AES_ENCRYPTION_KEY" => "Q5i7qaDCZ59/7SpzXcCKrKNXT2gbeP2U/M7nXQie9Hs=", // AES encryption key (base64 encoded)
    ...
    "AUTH_CONFIG" => [
        "providers" => [
            ...
            "Azure" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\Subastas2024\\AzureAD',
                "keys" => [
                    "id" => '',
            ...
            "Saml" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\Subastas2024\\Saml2',
    ...
    "AUDIT_TRAIL_TABLE_NAME" => "logs", // Table name
    "AUDIT_TRAIL_TABLE_VAR" => "logs", // Table var
    ...
    "LOGIN_USERNAME_FIELD_NAME" => "usuario",
    "LOGIN_USERNAME_PROPERTY_NAME" => "usuario",
    "LOGIN_PASSWORD_FIELD_NAME" => "clave",
    "USER_ID_FIELD_NAME" => "",
    "PARENT_USER_ID_FIELD_NAME" => "",
    "USER_LEVEL_FIELD_NAME" => "nivel",
    "USER_PROFILE_FIELD_NAME" => "perfil",
    "REGISTER_ACTIVATE" => true,
    "REGISTER_AUTO_LOGIN" => true,
    "REGISTER_ACTIVATE_FIELD_NAME" => "activo",
    "REGISTER_ACTIVATE_PROPERTY_NAME" => "activo",
    ...
    // Email
    "SENDER_EMAIL" => "soporte@grupoadrianmercado.com", // Sender email address
    "RECIPIENT_EMAIL" => "soporte@grupoadrianmercado.com", // Recipient email address
    ...
    "USE_ILIKE_FOR_POSTGRESQL" => false,
