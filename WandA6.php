...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
    ...
    $ImpTotConc   = 0.00;$_POST['totiva21_1']; // 0.00;
    $ImpNeto      = $_POST['totneto21'] ;//GetSQLValueString($_POST['totneto21'], "double") + GetSQLValueString($_POST['totneto105'], "double"); //100.00;
    $ImpOpEx      = 0.00;
    $ImpIVA       = $_POST['totiva21'] ;//GetSQLValueString($_POST['totiva21'], "double") + GetSQLValueString($_POST['totiva105'], "double"); // 21.00;
    $ImpTrib      = 0.00;
...
if ($sigo_y_grabo == 1 ) {
	...
	if (isset($_POST['lote']) && GetSQLValueString($_POST['lote'], "int")!="NULL") {
		...
		if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
  			...
  			$insertSQL = sprintf("INSERT INTO detfac (tcomp, serie, ncomp, renglon, descrip, neto, porciva, concafac, usuario) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['secuencia0'], "double"),
						$cod_usuario);
	...
	if (isset($_POST['lote2']) && GetSQLValueString($_POST['lote2'], "int")!="NULL") {
		...
		if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
  			$insertSQL = sprintf("INSERT INTO detfac (tcomp, serie, ncomp, renglon, descrip, neto, porciva, concafac, usuario) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['secuencia2'], "double"),
						$cod_usuario);
	...
	if (isset($_POST['lote3']) && GetSQLValueString($_POST['lote3'], "int")!="NULL") {
		...
		if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
  			$insertSQL = sprintf("INSERT INTO detfac (tcomp, serie, ncomp, renglon, descrip, neto, porciva, concafac, usuario) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['secuencia3'], "double"),
					   $cod_usuario);
	...
	if (isset($_POST['lote4']) && GetSQLValueString($_POST['lote4'], "int")!="NULL") {
		...
		if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
  			$insertSQL = sprintf("INSERT INTO detfac (tcomp, serie, ncomp, renglon, descrip, neto, porciva, concafac, usuario) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['secuencia4'], "double"),
					   $cod_usuario);
	...
	if (isset($_POST['lote5']) && GetSQLValueString($_POST['lote5'], "int")!="NULL") {
		...
		if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
  			$insertSQL = sprintf("INSERT INTO detfac (tcomp, serie, ncomp, renglon, descrip, neto, porciva, concafac, usuario) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['secuencia5'], "double"),
					   $cod_usuario);
	...
	if (isset($_POST['lote6']) && GetSQLValueString($_POST['lote6'], "int")!="NULL") {
		...
		if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
  			$insertSQL = sprintf("INSERT INTO detfac (tcomp, serie, ncomp, renglon, descrip, neto, porciva, concafac, usuario) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['secuencia6'], "double"),
					   $cod_usuario);
	...
	if (isset($_POST['lote7']) && GetSQLValueString($_POST['lote7'], "int")!="NULL") {
		...
		if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
  			$insertSQL = sprintf("INSERT INTO detfac (tcomp, serie, ncomp, renglon, descrip, neto, porciva, concafac, usuario) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['secuencia7'], "double"),
					   $cod_usuario);
	...
	if (isset($_POST['lote8']) && GetSQLValueString($_POST['lote8'], "int")!="NULL") {
		if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
  			$insertSQL = sprintf("INSERT INTO detfac (tcomp, serie, ncomp, renglon, descrip, neto, porciva, concafac, usuario) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['secuencia8'], "double"),
					   $cod_usuario);
	...
	if (isset($_POST['lote9']) && GetSQLValueString($_POST['lote9'], "int")!="NULL") {
		if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
  			$insertSQL = sprintf("INSERT INTO detfac (tcomp, serie, ncomp, renglon, descrip, neto, porciva, concafac, usuario) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['secuencia9'], "double"),
					   $cod_usuario);
	...
	if (isset($_POST['lote10']) && GetSQLValueString($_POST['lote10'], "int")!="NULL") {
		if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
  			$insertSQL = sprintf("INSERT INTO detfac (tcomp, serie, ncomp, renglon, descrip, neto, porciva, concafac, usuario) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['secuencia10'], "double"));
	...
	if (isset($_POST['lote11']) && GetSQLValueString($_POST['lote11'], "int")!="NULL") {
		if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
  			$insertSQL = sprintf("INSERT INTO detfac (tcomp, serie, ncomp, renglon, descrip, neto, porciva, concafac, usuario) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['secuencia11'], "double"),
					   $cod_usuario);
	...
	if (isset($_POST['lote12']) && GetSQLValueString($_POST['lote12'], "int")!="NULL") {
		if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
  			$insertSQL = sprintf("INSERT INTO detfac (tcomp, serie, ncomp, renglon, descrip, neto, porciva, concafac, usuario) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['secuencia12'], "double"),
					   $cod_usuario);
	...
	if (isset($_POST['lote13']) && GetSQLValueString($_POST['lote13'], "int")!="NULL") {
		if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
  			$insertSQL = sprintf("INSERT INTO detfac (tcomp, serie, ncomp, renglon, descrip, neto, porciva, concafac, usuario) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['secuencia13'], "double"),
					   $cod_usuario);
	...
	if (isset($_POST['lote14']) && GetSQLValueString($_POST['lote14'], "int")!="NULL") {
		if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
  			$insertSQL = sprintf("INSERT INTO detfac (tcomp, serie, ncomp, renglon, descrip, neto, porciva, concafac, usuario) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['secuencia14'], "double"),
					   $cod_usuario);
	...
	if (isset($_POST['lote']) && GetSQLValueString($_POST['lote'], "int")!="NULL") {
  		...
  		$query_mascara = "SELECT * FROM series  WHERE series.codnum='31'";//'$tcomp'  AND series.codnum='$serie'";
		...
		if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
			...
			$en_liquid = 0;
  			$insertSQL = sprintf("INSERT INTO cabfac (tcomp, serie, ncomp, fecval, fecdoc, fecreg, cliente, fecvenc, estado, emitido, totbruto, totiva105, totiva21, totimp, totcomis, totneto105, totneto21, nrengs, nrodoc , en_liquid, CAE, CAEFchVto, Resultado, usuario, usuarioultmod, fecultmod) VALUES (%s, %s, %s, '$fecha_factura1','$fecha_factura1', '$fecha_factura1', %s, '$fecha_factura1', %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s,'$en_liquid', '$CAE', '$CAEFchVto', '$Resultado')",
                       GetSQLValueString($_POST['tcomp'], "int"),
                       GetSQLValueString($_POST['serie'], "int"),
                       $num_fac,
...
//echo "   6  - ";
	...
	mysqli_select_db($amercado, $database_amercado);
	$query_facturas_b = "SELECT * FROM series  WHERE  series.codnum=29";
	...
	if ($mascara1='') {
		...
		if ($facturanum2 >99999 && $facturanum2 <999999) {
			$mascara=$mascara."-"."00".$facturanum2;
		}
		...
		if ($facturanum1 >99999 && $facturanum1 <999999) {
			$mascara=$mascara."-"."00".$facturanum1;
		}
	}

}  // ESTA ES LA NUEVA LLAVE 09082010
mysqli_select_db($amercado, $database_amercado);
$query_conceptos_a_facturar = "SELECT * FROM concafactven WHERE impuesto = 8 ORDER BY nroconc  ASC";
...
var selec = form.tipos.options;
		...
		form.serie.value = 31;
		form.serie_texto.value = "SERIE NOTA DEB A0006";
		form.tcomp.value = 63;
...
var selec = form.tipos.options;
    ...
    {
		form.tcbterel.value = 1;
		form.tcbterel_texto.value = "FACTURA A0006";
    ...
    if (selec[2].selected == true)
    {
		...
		form.tcbterel.value = 3;
		form.tcbterel_texto.value = "N CRED A0006";
...
function validarFormulario(form)
{
    ...
    if (monto.length!=0) {
		...
		if (eval(porciva)===0.21) {
            ...
            var neto21 = eval(monto);
            var imp_tot_21  = eval(neto21+('*')+porciva);
            var tot_general = eval(monto+('+')+imp_tot_21);
        ...
        //strAlerta = "totneto= " + tot_mon_ex + "\n" + " totneto21= " + neto21 + "\n" + " totiva= " + imp_tot_21 + "\n" + " tot_general = " + tot_general;
       
        //alert(" totneto21= " + neto21 + "\n");
        //alert(" totiva= " + imp_tot_21 + "\n");
	...
	if (monto1.length!=0) {
		...
		if (eval(porciva1)===0.21) {
            ...
            var imp_tot_21_1  = eval(monto1); 
			imp_tot_21_1  = eval(imp_tot_21_1+('*')+porciva1);
            imp_tot_21 = eval(imp_tot_21+('+')+imp_tot_21_1);
            var tot_general = eval(tot_general+('+')+monto1+('+')+imp_tot_21_1);	
		}
	...
	if (monto2.length!=0) {
		...
		if (eval(porciva2)===0.21) {
            ...
            var imp_tot_21_2  = eval(monto2); 
			imp_tot_21_2  = eval(imp_tot_21_2+('*')+porciva2);
            imp_tot_21 = eval(imp_tot_21+('+')+imp_tot_21_2);
            var tot_general = eval(tot_general+('+')+monto2+('+')+imp_tot_21_2);	
		}
	...
	if (monto3.length!=0) {
		...
		if (eval(porciva3)===0.21) {
            ...
            var imp_tot_21_3  = eval(monto3); 
			imp_tot_21_3  = eval(imp_tot_21_3+('*')+porciva3);
            imp_tot_21 = eval(imp_tot_21+('+')+imp_tot_21_3);
            var tot_general = eval(tot_general+('+')+monto3+('+')+imp_tot_21_3);	
		}
	...
	if (monto4.length!=0) {
		...
		if (eval(porciva4)===0.21) {
            ...
            var imp_tot_21_4  = eval(monto4); 
			imp_tot_21_4  = eval(imp_tot_21_4+('*')+porciva4);
            imp_tot_21 = eval(imp_tot_21+('+')+imp_tot_21_4);
            var tot_general = eval(tot_general+('+')+monto4+('+')+imp_tot_21_4);	
		}
	...
	if (monto5.length!=0) {
		...
		if (eval(porciva5)===0.21) {
            ...
            var imp_tot_21_5  = eval(monto5); 
			imp_tot_21_5  = eval(imp_tot_21_5+('*')+porciva5);
            imp_tot_21 = eval(imp_tot_21+('+')+imp_tot_21_5);
            var tot_general = eval(tot_general+('+')+monto5+('+')+imp_tot_21_5);	
		}
	...
	// SEPTIMO CONCEPTO
		...
		if (eval(porciva6)===0.21) {
            ...
            var imp_tot_21_6  = eval(monto6); 
			imp_tot_21_6  = eval(imp_tot_21_6+('*')+porciva6);
            imp_tot_21 = eval(imp_tot_21+('+')+imp_tot_21_6);
            var tot_general = eval(tot_general+('+')+monto6+('+')+imp_tot_21_6);	
		}
	...
	if (monto7.length!=0) {
		...
		if (eval(porciva7)===0.21) {
            ...
            var imp_tot_21_7  = eval(monto7); 
			imp_tot_21_7  = eval(imp_tot_21_7+('*')+porciva7);
            imp_tot_21 = eval(imp_tot_21+('+')+imp_tot_21_7);
            var tot_general = eval(tot_general+('+')+monto7+('+')+imp_tot_21_7);	
		}
	...
	// NOVENO CONCEPTO
		...
		if (eval(porciva8)===0.21) {
            ...
            var imp_tot_21_8  = eval(monto8); 
			imp_tot_21_8  = eval(imp_tot_21_8+('*')+porciva8);
            imp_tot_21 = eval(imp_tot_21+('+')+imp_tot_21_8);
            var tot_general = eval(tot_general+('+')+monto8+('+')+imp_tot_21_8);	
		}
	...
	if (monto9.length!=0) {
		...
		if (eval(porciva9)===0.21) {
            ...
            var imp_tot_21_9  = eval(monto9); 
			imp_tot_21_9  = eval(imp_tot_21_9+('*')+porciva9);
            imp_tot_21 = eval(imp_tot_21+('+')+imp_tot_21_9);
            var tot_general = eval(tot_general+('+')+monto9+('+')+imp_tot_21_9);	
		}
	...
	//  CONCEPTO ONCE
		...
		if (eval(porciva10)===0.21) {
            ...
            var imp_tot_21_10  = eval(monto10); 
			imp_tot_21_10  = eval(imp_tot_21_10+('*')+porciva10);
            imp_tot_21 = eval(imp_tot_21+('+')+imp_tot_21_10);
            var tot_general = eval(tot_general+('+')+monto10+('+')+imp_tot_21_10);	
		}
	...
	//  CONCEPTO DOCE
		...
		if (eval(porciva11)===0.21) {
            ...
            var imp_tot_21_11  = eval(monto11); 
			imp_tot_21_11  = eval(imp_tot_21_11+('*')+porciva11);
            imp_tot_21 = eval(imp_tot_21+('+')+imp_tot_21_11);
            var tot_general = eval(tot_general+('+')+monto11+('+')+imp_tot_21_11);	
		}
	...
	if (monto12.length!=0) {
		...
		if (eval(porciva12)===0.21) {
            ...
            var imp_tot_21_12  = eval(monto12); 
			imp_tot_21_12  = eval(imp_tot_21_12+('*')+porciva12);
            imp_tot_21 = eval(imp_tot_21+('+')+imp_tot_21_12);
            var tot_general = eval(tot_general+('+')+monto12+('+')+imp_tot_21_12);	
		}
	...
	//  CONCEPTO CATORCE
		...
		if (eval(porciva13)===0.21) {
            ...
            var imp_tot_21_13 = eval(monto13); 
			imp_tot_21_13  = eval(imp_tot_21_13+('*')+porciva13);
            imp_tot_21 = eval(imp_tot_21+('+')+imp_tot_21_13);
            var tot_general = eval(tot_general+('+')+monto13+('+')+imp_tot_21_13);	
		}
    ...
    if (monto14.length!=0) {
		...
		if (eval(porciva14)===0.21) {
            ...
            var imp_tot_21_14  = eval(monto14); 
			imp_tot_21_14  = eval(imp_tot_21_14+('*')+porciva14);
            imp_tot_21 = eval(imp_tot_21+('+')+imp_tot_21_14);
            var tot_general = eval(tot_general+('+')+monto14+('+')+imp_tot_21_14);	
		}
    ...
    strAlerta = "totneto= " + form.totneto.value + " totneto21= " + form.totneto21.value + " totiva= " + form.totiva21.value + " tot_general = " + form.tot_general.value;
        //alert(strAlerta);
    ...
    <tr>
      ...
      <td width="14%" height="20" bgcolor="#FFFFFF">&nbsp;<span class="ewTableHeader">Tipo de Cbte </span></td>
          <td width="40%"><select name="tipos" onChange="agregarOpciones(this.form)">
                                      <option value="63">NOTA DE DEBITO A0006</option>
          ...
          <td width="33%"><input name="serie_texto" type="text"  value="SERIE DE N DEB A0006" size="25" />
		  <input name="serie" type="hidden"  value="31" size="25"/>
            </td>
        </tr>
        <tr>
...
?>
    ...
    <tr>
        <td colspan="3" valign="top" bgcolor="#FFFFFF"><table width="100%" border="1" cellspacing="1" cellpadding="1">
          ...
          <td width="20%"><select name="tcbterel2" onChange="agregarOpciones2(this.form)">
                              <option value="1">FACTURA A0006</option>
                              <option value="3">N CRED A0006</option>
        ...
        <td width="33%" height="20" bgcolor="#FFFFFF">&nbsp;<span class="ewTableHeader">Nro. de Cbte Relacionado: 
            <input name="ncbterel" type="text" class="phpmaker" id="ncbterel" size="10" />
        </span></td>
            </table></td>
	  ...
	  <table width="100%" border="1" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
        <tr>
            ...
            <div align="center">DESCRIPCION</div></td>
          	...
          	<td width="20" background="images/fonod_lote.jpg" class="ewTableHeader">
          ...
          <td bgcolor="#FFFFFF"><select name="concepto"  required="required" onChange="getprov(this.form)">
			...
			?>
             ...
             <td bgcolor="#FFFFFF"><input name="tipoiva" size="10" onChange="getprov(this.form)"></td>
          <td bgcolor="#FFFFFF"><input name="descripcion" type="text" class="phpmaker" id="descripcion" size="65" /> </td>
         
          <td bgcolor="#FFFFFF"><input name="importe" type="text" id="importe" onChange="validarFormulario(this.form)"   onBlur="MM_validateForm('importe','','NisNum');return document.MM_returnValue" size="20"   /></td>
		...
		<input name="secuencia0" type="hidden" class="phpmaker" id="secuencia0" size="65" />
		 ...
		 <tr>
          ...
          <td bgcolor="#FFFFFF"><input name="descripcion1" type="text" class="phpmaker" id="descripcion1" size="65" /></td>
        
    <td bgcolor="#FFFFFF"><input name="importe1" type="text" id="importe1" onChange="validarFormulario(this.form)"   onBlur="MM_validateForm('importe1','','NisNum');return document.MM_returnValue" size="20"  /></td>
      ...
      <input name="secuencia1" type="hidden" class="phpmaker" id="secuencia1" size="65" />
		 ...
		 <tr>
          ...
          <td bgcolor="#FFFFFF"><input name="descripcion2" type="text" class="phpmaker" id="descripcion2" size="65" /></td>
         
          <td bgcolor="#FFFFFF"><input name="importe2" type="text" id="importe2" onChange="validarFormulario(this.form)"   onBlur="MM_validateForm('importe2','','NisNum');return document.MM_returnValue" size="20" /></td>
          ...
          <td bgcolor="#FFFFFF"><input name="descripcion3" type="text" class="phpmaker" id="descripcion3" size="65" /></td>
          
          <td bgcolor="#FFFFFF"><input name="importe3" type="text" id="importe3" onChange="validarFormulario(this.form)"   onBlur="MM_validateForm('importe3','','NisNum');return document.MM_returnValue" size="20" /></td>
          ...
          <td bgcolor="#FFFFFF"><input name="descripcion4" type="text" class="phpmaker" id="descripcion4" size="65" /></td>
          
          <td bgcolor="#FFFFFF"><input name="importe4" type="text" id="importe4" onChange="validarFormulario(this.form)"   onBlur="MM_validateForm('importe4','','NisNum');return document.MM_returnValue" size="20" /></td>
          ...
          <td bgcolor="#FFFFFF"><input name="descripcion5" type="text" class="phpmaker" id="descripcion5" size="65" /></td>
          
          <td bgcolor="#FFFFFF"><input name="importe5" type="text" id="importe5" onChange="validarFormulario(this.form)"   onBlur="MM_validateForm('importe5','','NisNum');return document.MM_returnValue" size="20" /></td>
		 ...
		 <tr>
          ...
          <td bgcolor="#FFFFFF"><input name="descripcion6" type="text" class="phpmaker" id="descripcion6" size="65" /></td>
          
		   <td bgcolor="#FFFFFF"><input name="importe6" type="text" id="importe6" onChange="validarFormulario(this.form)"   onBlur="MM_validateForm('importe6','','NisNum');return document.MM_returnValue" size="20" /></td>
		 ...
		 <tr>
          ...
          <td bgcolor="#FFFFFF"><input name="descripcion7" type="text" class="phpmaker" id="descripcion7" size="65" /></td>
          
          <td bgcolor="#FFFFFF"><input name="importe7" type="text" id="importe7" onChange="validarFormulario(this.form)"   onBlur="MM_validateForm('importe7','','NisNum');return document.MM_returnValue" size="20" /></td>
		 ...
		 <tr>
          ...
          <td bgcolor="#FFFFFF"><input name="descripcion8" type="text" class="phpmaker" id="descripcion8" size="65" /></td>
          
          <td bgcolor="#FFFFFF"><input name="importe8" type="text" id="importe8" onChange="validarFormulario(this.form)"   onBlur="MM_validateForm('importe8','','NisNum');return document.MM_returnValue" size="20" /></td>
		 ...
		 <tr>
          ...
          <td bgcolor="#FFFFFF"><input name="descripcion9" type="text" class="phpmaker" id="descripcion9" size="65" /></td>
          
          <td bgcolor="#FFFFFF"><input name="importe9" type="text" id="importe9" onChange="validarFormulario(this.form)"   onBlur="MM_validateForm('importe9','','NisNum');return document.MM_returnValue" size="20" /></td>
		 ...
		 <tr>
          ...
          <td bgcolor="#FFFFFF"><input name="descripcion10" type="text" class="phpmaker" id="descripcion10" size="65" /></td>
        
          <td bgcolor="#FFFFFF"><input name="importe10" type="text" id="importe10" onChange="validarFormulario(this.form)"   onBlur="MM_validateForm('importe10','','NisNum');return document.MM_returnValue" size="20" /></td>
		 ...
		 <tr>
          ...
          <td bgcolor="#FFFFFF"><input name="descripcion11" type="text" class="phpmaker" id="descripcion11" size="65" /></td>
          
          <td bgcolor="#FFFFFF"><input name="importe11" type="text" id="importe11" onChange="validarFormulario(this.form)"   onBlur="MM_validateForm('importe11','','NisNum');return document.MM_returnValue" size="20" /></td>
		 ...
		 <tr>
          ...
          <td bgcolor="#FFFFFF"><input name="descripcion12" type="text" class="phpmaker" id="descripcion12" size="65" /></td>
          
          <td bgcolor="#FFFFFF"><input name="importe12" type="text" id="importe12" onChange="validarFormulario(this.form)"   onBlur="MM_validateForm('importe12','','NisNum');return document.MM_returnValue" size="20" /></td>
		 ...
		 <tr>
          ...
          <td bgcolor="#FFFFFF"><input name="descripcion13" type="text" class="phpmaker" id="descripcion13" size="65" /></td>
          
          <td bgcolor="#FFFFFF"><input name="importe13" type="text" id="importe13" onChange="validarFormulario(this.form)"   onBlur="MM_validateForm('importe13','','NisNum');return document.MM_returnValue" size="20" /></td>
          ...
          <td bgcolor="#FFFFFF"><input name="descripcion14" type="text" class="phpmaker" id="descripcion14" size="65" /></td>
       
          <td bgcolor="#FFFFFF"><input name="importe14" type="text" id="importe14" onChange="validarFormulario(this.form)"   onBlur="MM_validateForm('importe14','','NisNum');return document.MM_returnValue" size="20" /></td>
    ...
    <tr>
      <td colspan="3" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
        ...
        <tr>
          <td><input name="totneto21"   type="hidden"  size="20" /></td>
          <td><input name="totiva21"    type="hidden"  size="20" /></td>
          <td><input name="tot_general" type="hidden"  size="25" /></td>
        </tr>
		 <tr>
          <td><input name="totneto21_1"   type="text"  size="20" /></td>
          <td><input name="totiva21_1"    type="text"  size="20" /></td>
          <td><input name="tot_general_1" type="text"  size="25" /></td>
        </tr>
      </table></td>
    </tr>
    <tr>
