 ...
 * Page class
 */
class RubrosView extends Rubros
{
    use MessagesTrait;
    ...
    // CSS class/style
    public $CurrentPageName = "RubrosView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("codnum") ?? Route("codnum")) !== null) {
            ...
            $returnUrl = "RubrosList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "RubrosList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
