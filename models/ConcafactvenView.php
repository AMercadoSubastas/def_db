 ...
 * Page class
 */
class ConcafactvenView extends Concafactven
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ConcafactvenView";
    ...
    // CSS class/style
    public $CurrentPageName = "ConcafactvenView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("codnum") ?? Route("codnum")) !== null) {
            ...
            $returnUrl = "ConcafactvenList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ConcafactvenList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
