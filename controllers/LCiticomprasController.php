...
/**
 * l_citicompras controller
 */
class LCiticomprasController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/LCiticompras[/{params:.*}]", [PermissionMiddleware::class], "custom.l_citicompras")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "LCiticompras");
    }
}
