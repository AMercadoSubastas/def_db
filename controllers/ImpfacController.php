...
class ImpfacController extends ControllerBase
{
    // list
    #[Map(["GET","POST","OPTIONS"], "/ImpfacList[/{codnum}]", [PermissionMiddleware::class], "list.impfac")]
    public function list(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "ImpfacList");
    }
}
