...
/**
 * emiliquid controller
 */
class EmiliquidController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/Emiliquid[/{params:.*}]", [PermissionMiddleware::class], "custom.emiliquid")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "Emiliquid");
    }
}
