...
/**
 * v_wafcautxconcA10 controller
 */
class VWafcautxconcA10Controller extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/VWafcautxconcA10[/{params:.*}]", [PermissionMiddleware::class], "custom.v_wafcautxconcA10")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "VWafcautxconcA10");
    }
}
