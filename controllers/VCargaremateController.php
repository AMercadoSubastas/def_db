...
/**
 * v_cargaremate controller
 */
class VCargaremateController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/VCargaremate[/{params:.*}]", [PermissionMiddleware::class], "custom.v_cargaremate")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "VCargaremate");
    }
}
