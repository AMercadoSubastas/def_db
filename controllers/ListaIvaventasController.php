...
/**
 * lista_ivaventas controller
 */
class ListaIvaventasController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/ListaIvaventas[/{params:.*}]", [PermissionMiddleware::class], "custom.lista_ivaventas")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "ListaIvaventas");
    }
}
