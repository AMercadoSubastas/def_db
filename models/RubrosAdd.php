 ...
 * Page class
 */
class RubrosAdd extends Rubros
{
    use MessagesTrait;
    ...
    // CSS class/style
    public $CurrentPageName = "RubrosAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("RubrosList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "RubrosView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "RubrosList") {
                            ...
                            $returnUrl = "RubrosList"; // Return list page content
                        }
                    }
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->codimp->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->codimp->setFormValue($val, true, $validate);
            }
        }
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            ...
            if (!CheckInteger($this->codimp->FormValue)) {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("RubrosList"), "", $this->TableVar, true);
