...
?>
<main class="edit">
<form name="fcabfacedit" id="fcabfacedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" autocomplete="off">
<script>
...
<?php if ($Page->codnum->Visible) { // codnum ?>
    <div id="r_codnum"<?= $Page->codnum->rowAttributes() ?>>
        <label id="elh_cabfac_codnum" class="<?= $Page->LeftColumnClass ?>"><?= $Page->codnum->caption() ?><?= $Page->codnum->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<input type="hidden" data-table="cabfac" data-field="x_codnum" data-hidden="1" name="x_codnum" id="x_codnum" value="<?= HtmlEncode($Page->codnum->CurrentValue) ?>">
</span>
</div></div>
    </div>
<?php } ?>
...
<span id="el_cabfac_tcomp">
    <select
        ...
        data-select2-id="fcabfacedit_x_tcomp"
        <?php } ?>
        data-table="cabfac"
        data-field="x_tcomp"
...
<?php if (!$Page->tcomp->IsNativeSelect) { ?>
<script>
loadjs.ready("fcabfacedit", function() {
    var options = { name: "x_tcomp", selectId: "fcabfacedit_x_tcomp" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fcabfacedit.lists.tcomp?.lookupOptions.length) {
        options.data = { id: "x_tcomp", form: "fcabfacedit" };
    } else {
        options.ajax = { id: "x_tcomp", form: "fcabfacedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_cabfac_serie">
    <select
        ...
        data-select2-id="fcabfacedit_x_serie"
        <?php } ?>
        data-table="cabfac"
        data-field="x_serie"
...
<script>
loadjs.ready("fcabfacedit", function() {
    var options = { name: "x_serie", selectId: "fcabfacedit_x_serie" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fcabfacedit.lists.serie?.lookupOptions.length) {
        options.data = { id: "x_serie", form: "fcabfacedit" };
    } else {
        options.ajax = { id: "x_serie", form: "fcabfacedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
loadjs.ready(["fcabfacedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fcabfacedit", "x_fecval", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fcabfacedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fcabfacedit", "x_fecdoc", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fcabfacedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fcabfacedit", "x_fecreg", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
<span id="el_cabfac_cliente">
    <select
        ...
        data-select2-id="fcabfacedit_x_cliente"
        <?php } ?>
        data-table="cabfac"
...
<script>
loadjs.ready("fcabfacedit", function() {
    var options = { name: "x_cliente", selectId: "fcabfacedit_x_cliente" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fcabfacedit.lists.cliente?.lookupOptions.length) {
        options.data = { id: "x_cliente", form: "fcabfacedit" };
    } else {
        options.ajax = { id: "x_cliente", form: "fcabfacedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_cabfac_codrem">
    <select
        ...
        data-select2-id="fcabfacedit_x_codrem"
        <?php } ?>
        data-table="cabfac"
        data-field="x_codrem"
...
<script>
loadjs.ready("fcabfacedit", function() {
    var options = { name: "x_codrem", selectId: "fcabfacedit_x_codrem" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fcabfacedit.lists.codrem?.lookupOptions.length) {
        options.data = { id: "x_codrem", form: "fcabfacedit" };
    } else {
        options.ajax = { id: "x_codrem", form: "fcabfacedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
loadjs.ready(["fcabfacedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fcabfacedit", "x_CAEFchVto", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
<input type="hidden" data-table="cabfac" data-field="x_direc" data-hidden="1" name="x_direc" id="x_direc" value="<?= HtmlEncode($Page->direc->CurrentValue) ?>">
</span>
<span id="el_cabfac_dnro">
<input type="hidden" data-table="cabfac" data-field="x_dnro" data-hidden="1" name="x_dnro" id="x_dnro" value="<?= HtmlEncode($Page->dnro->CurrentValue) ?>">
</span>
<span id="el_cabfac_pisodto">
<input type="hidden" data-table="cabfac" data-field="x_pisodto" data-hidden="1" name="x_pisodto" id="x_pisodto" value="<?= HtmlEncode($Page->pisodto->CurrentValue) ?>">
</span>
<span id="el_cabfac_codpost">
<input type="hidden" data-table="cabfac" data-field="x_codpost" data-hidden="1" name="x_codpost" id="x_codpost" value="<?= HtmlEncode($Page->codpost->CurrentValue) ?>">
</span>
<span id="el_cabfac_codpais">
<input type="hidden" data-table="cabfac" data-field="x_codpais" data-hidden="1" name="x_codpais" id="x_codpais" value="<?= HtmlEncode($Page->codpais->CurrentValue) ?>">
</span>
<span id="el_cabfac_codprov">
<input type="hidden" data-table="cabfac" data-field="x_codprov" data-hidden="1" name="x_codprov" id="x_codprov" value="<?= HtmlEncode($Page->codprov->CurrentValue) ?>">
</span>
<span id="el_cabfac_codloc">
<input type="hidden" data-table="cabfac" data-field="x_codloc" data-hidden="1" name="x_codloc" id="x_codloc" value="<?= HtmlEncode($Page->codloc->CurrentValue) ?>">
</span>
<span id="el_cabfac_telef">
<input type="hidden" data-table="cabfac" data-field="x_telef" data-hidden="1" name="x_telef" id="x_telef" value="<?= HtmlEncode($Page->telef->CurrentValue) ?>">
</span>
<span id="el_cabfac_moneda">
<input type="hidden" data-table="cabfac" data-field="x_moneda" data-hidden="1" name="x_moneda" id="x_moneda" value="<?= HtmlEncode($Page->moneda->CurrentValue) ?>">
</span>
...
<input type="hidden" data-table="cabfac" data-field="x_leyendafc" data-hidden="1" name="x_leyendafc" id="x_leyendafc" value="<?= HtmlEncode($Page->leyendafc->CurrentValue) ?>">
</span>
<?php
    if (in_array("detfac", explode(",", $Page->getCurrentDetailTable())) && $detfac->DetailEdit) {
?>
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fcabfacedit"><?= $Language->phrase("SaveBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fcabfacedit" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
