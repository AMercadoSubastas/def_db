...
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        ...
        .setFields([
            ...
            ["codban", [fields.codban.visible && fields.codban.required ? ew.Validators.required(fields.codban.caption) : null, ew.Validators.integer], fields.codban.isInvalid],
            ["codsuc", [fields.codsuc.visible && fields.codsuc.required ? ew.Validators.required(fields.codsuc.caption) : null, ew.Validators.integer], fields.codsuc.isInvalid],
...
$Page->showMessage();
?>
<form name="fcartvaloresadd" id="fcartvaloresadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" autocomplete="off">
...
<?php if ($Page->tcomp->Visible) { // tcomp ?>
    <div id="r_tcomp"<?= $Page->tcomp->rowAttributes() ?>>
        <label id="elh_cartvalores_tcomp" for="x_tcomp" class="<?= $Page->LeftColumnClass ?>"><?= $Page->tcomp->caption() ?><?= $Page->tcomp->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->tcomp->cellAttributes() ?>>
<span id="el_cartvalores_tcomp">
<input type="<?= $Page->tcomp->getInputTextType() ?>" name="x_tcomp" id="x_tcomp" data-table="cartvalores" data-field="x_tcomp" value="<?= $Page->tcomp->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->tcomp->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->tcomp->formatPattern()) ?>"<?= $Page->tcomp->editAttributes() ?> aria-describedby="x_tcomp_help">
...
<input type="<?= $Page->codban->getInputTextType() ?>" name="x_codban" id="x_codban" data-table="cartvalores" data-field="x_codban" value="<?= $Page->codban->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->codban->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->codban->formatPattern()) ?>"<?= $Page->codban->editAttributes() ?> aria-describedby="x_codban_help">
...
<input type="<?= $Page->codsuc->getInputTextType() ?>" name="x_codsuc" id="x_codsuc" data-table="cartvalores" data-field="x_codsuc" value="<?= $Page->codsuc->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->codsuc->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->codsuc->formatPattern()) ?>"<?= $Page->codsuc->editAttributes() ?> aria-describedby="x_codsuc_help">
...
<script>
loadjs.ready(["fcartvaloresadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fcartvaloresadd", "x_fechaemis", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fcartvaloresadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fcartvaloresadd", "x_fechapago", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fcartvaloresadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fcartvaloresadd", "x_fechaingr", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fcartvaloresadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fcartvaloresadd", "x_fechaentrega", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
<input type="<?= $Page->estado->getInputTextType() ?>" name="x_estado" id="x_estado" data-table="cartvalores" data-field="x_estado" value="<?= $Page->estado->EditValue ?>" size="30" maxlength="2" placeholder="<?= HtmlEncode($Page->estado->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->estado->formatPattern()) ?>"<?= $Page->estado->editAttributes() ?> aria-describedby="x_estado_help">
...
loadjs.ready(["fcartvaloresadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fcartvaloresadd", "x_fechahora", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fcartvaloresadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fcartvaloresadd", "x_fecharel", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fcartvaloresadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fcartvaloresadd", "x_fechasal", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fcartvaloresadd"><?= $Language->phrase("AddBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fcartvaloresadd" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
