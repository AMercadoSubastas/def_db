...
//  fclose($f1); 
 ...
 // $chau ="12";
  ...
  $chau = $inf["comiscobr"];
    $secu = $inf["secuencia"];
   echo "formObj11.descripcion10.value = '".$hola."';\n";  
  //  echo "formObj.descripcion.value = '".$inf["descor"]."';\n";    
    echo "formObj11.comision10.value = '".$chau."';\n";   
	    echo "formObj11.secuencia10.value = '".$secu."';\n";    
    } else {
   ...
   echo "formObj11.descripcion10.value = '".$item."';\n";  
   
   
   }      
    
  }else{
    echo "formObj11.descripcion10.value  = '';\n";    
    echo "formObj11.comision10.value = '';\n";  
	   echo "formObj11.secuencia10.value = '';\n";    
