 ...
 * Page class
 */
class ProvinciasView extends Provincias
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProvinciasView";
    ...
    // CSS class/style
    public $CurrentPageName = "ProvinciasView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("codnum") ?? Route("codnum")) !== null) {
            ...
            $returnUrl = "ProvinciasList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ProvinciasList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
