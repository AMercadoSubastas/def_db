...
$nombre_usu = "";
    ...
    $query_cabfac = sprintf("SELECT * FROM cabfac WHERE (tcomp IN (115,116,117,119,120,121,122,123,124,125,126,127,133,134,135,136)) AND codrem = $remate ORDER BY fecreg, nrodoc, tcomp" );
 		...
 		switch ($tcomp) {
            ...
            case 135:
               $tot_comision = 0.00;
                ...
                while ($row_detfac = mysqli_fetch_array($detfac)) {
                    if ($row_detfac["concafac"] == 20 || $row_detfac["concafac"] == 28 || $row_detfac["concafac"] == 33)
                        $tot_public   += $row_detfac["neto"];
                    ...
                    if ($row_detfac["concafac"] == 13 || $row_detfac["concafac"] == 16)
				        $lotes105     += $row_detfac["neto"];
                    if ($row_detfac["concafac"] == 19 || $row_detfac["concafac"] == 36  || $row_detfac["concafac"] == 21)
                        $tot_comision += $row_detfac["neto"];
