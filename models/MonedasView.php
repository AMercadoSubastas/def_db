 ...
 * Page class
 */
class MonedasView extends Monedas
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MonedasView";
    ...
    // CSS class/style
    public $CurrentPageName = "MonedasView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("codnum") ?? Route("codnum")) !== null) {
            ...
            $returnUrl = "MonedasList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "MonedasList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
