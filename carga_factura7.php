...
// DESDE ACA
// Primero busco el numero de factura
...
//		$num_comp_fac = ($row_comprobante['nroact'])+1 ; 
		//echo $num_comp_fac;
		// Actualizo la tabla series con el ultimo numero
//		$actualiza = sprintf("UPDATE `series` SET `nroact` = '$num_comp_fac' WHERE `series`.`codnum` =%s",GetSQLValueString($_POST['serie'], "int")) ;				 
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
 ...
 // DESDE ACA
// Leo todos los medios de pago asociados a esta factura
$sql_medpagos = sprintf("SELECT *  FROM cartvalores  WHERE ncomprel IS NULL  AND codrem = %s",
 				GetSQLValueString($_POST['remate_num'], "int"));
$medpagos = mysqli_query($amercado, $sql_medpagos) or die(mysqli_error($amercado));
$totalRows_medpagos = mysqli_num_rows($medpagos);

        
 if ( $totalRows_medpagos > 0) {
 		// Actualizo todos los medios de pago con el numero de factura
  		$updateSQL = sprintf("UPDATE cartvalores SET ncomprel = %s  WHERE codrem = %s AND ncomprel IS NULL",
  				 GetSQLValueString($_POST['num_factura'], "int"),
				GetSQLValueString($_POST['remate_num'], "int"));
  		mysqli_select_db($amercado, $database_amercado);
  		$Result1 = mysqli_query($amercado, $updateSQL) or die(mysqli_error($amercado));
 	...
 	// busco el ultimo numero para efectivo y hago el insert
  		mysqli_select_db($amercado, $database_amercado);
		$query_comprobante = "SELECT * FROM series  WHERE series.codnum =8";
		$comprobante = mysqli_query($amercado, $query_comprobante) or die(mysqli_error($amercado));
		$row_comprobante = mysqli_fetch_assoc($comprobante);
		$totalRows_comprobante = mysqli_num_rows($comprobante);
		$num_comp_ef = ($row_comprobante['nroact'])+1 ; 
	  	$insertSQL = sprintf("INSERT INTO cartvalores (tcomp, serie, ncomp, codpais, importe, fechaingr, tcomprel, serierel, ncomprel, estado, moneda, codrem) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString("12", "int"),
                       GetSQLValueString("8", "int"),
                       GetSQLValueString($_POST['num_comp_ef'], "int"),
					   GetSQLValueString("1", "int"),
					   GetSQLValueString($_POST['tot_general'], "double"),
					   GetSQLValueString($_POST['fecha_factura'], "date"),
					   GetSQLValueString($_POST['tcomp'], "int"),
					   ...
					   GetSQLValueString("1", "int"),
                       GetSQLValueString($_POST['remate_num'], "int"));
		// Actualizo el ultimo nro de la serie para efectivo
		$actualiza = "UPDATE `series` SET `nroact` = '$num_comp_ef' WHERE `series`.`codnum` ='8'" ;				 
		$resultado=mysqli_query($amercado,	$actualiza);		
...
mysqli_select_db($amercado, $database_amercado);
$query_cliente = "SELECT * FROM entidades WHERE tipoent='2'";
...
//  var factura.pago_contado2 // Factura
 // var formulario.factura3.value = fac_numero ; 
 // alert(fac_numero) ;
//var factura.pago_contado2 = factura.pago_contado2.value;
...
// alert("Dentro coocke")
   ...
   var ckUtil = new CJL_CookieUtil("factura", 45);
...
function forma_pago(form)
 {
  var total = factura.tot_general.value;
  var fac_numero = factura.num_factura.value ; // Nuemro de la Factura 
  var tipo_comprobante = factura.tcomp.value ;  // Tipo de comprobante 
  var serie_num     = factura.serie.value ;  // Numero de Serie 
  var fecha_factura = factura.fecha_factura.value ; //  Fecha de Factura
...
?>
        ...
        <tr>
          ...
          <td><input name="num_factura" type="num_factura" class="phpmakerlist" id="ncomp" value="<?php echo $num_comp_fac ?>"/></td>
          <td>&nbsp;</td>
...
?>
    ...
    <tr>
      <td colspan="3"  background="images/separador3.gif"><table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#003366">
        <tr>
          <td width="39" rowspan="2" class="ewTableHeader"><div align="center">Lote</div></td>
          <td width="369" rowspan="2" class="ewTableHeader"><div align="center">Descripci&oacute;n</div></td>
          <td width="44" rowspan="2" class="ewTableHeader"><div align="center">Com</div></td>
          <td width="60" rowspan="2" class="ewTableHeader"><div align="center">Importe</div></td>
          <td height="24" colspan="3" class="ewTableHeader"><div align="center">Impuestos</div></td>
        </tr>
        <tr>
          <td height="15" class="ewTableHeader"><div align="center">
            <?php echo $iva_15_porcen     ?>
          </div></td>
          <td class="ewTableHeader"><div align="center">
            <?php echo $iva_21_porcen     ?>
          </div></td>
        </tr>
        <tr>
          ...
          <?php if($nivel=='9') { ?>
          <td bgcolor="#0094FF"><input name="comision" type="text" id="comision" size="3" /></td>
          <?php } else { ?>
          <td bgcolor="#0094FF"><input name="comision" type="text" id="comision" size="3"  readonly="" /></td>
          <?php } ?>
        ...
        <tr>
          ...
          <?php if($nivel=='9') { ?>
          <td bgcolor="#0094FF"><input name="comision1" type="text" id="comision1" size="3" /></td>
          <?php } else { ?>
          <td bgcolor="#0094FF"><input name="comision1" type="text" id="comision1" size="3" readonly="" /></td>
          <?php } ?>
        ...
        <tr>
          ...
          <?php if($nivel=='9') { ?>
          <td bgcolor="#0094FF"><input name="comision2" type="text" id="comision2" size="3" /></td>
          <?php } else { ?>
          <td bgcolor="#0094FF"><input name="comision2" type="text" id="comision2" size="3" readonly="" /></td>
          <?php } ?>
        ...
        <tr>
          ...
          <?php if($nivel=='9') { ?>
          <td bgcolor="#0094FF"><input name="comision3" type="text" id="comision3" size="3" /></td>
          <?php } else { ?>
          <td bgcolor="#0094FF"><input name="comision3" type="text" id="comision3" size="3"  readonly=""/></td>
          <?php } ?>
        ...
        <tr>
          ...
          <?php if($nivel=='9') { ?>
          <td bgcolor="#0094FF"><input name="comision4" type="text" id="comision4" size="3" /></td>
          <?php } else { ?>
          <td bgcolor="#0094FF"><input name="comision4" type="text" id="comision4" size="3" /></td>
          <?php } ?>
        ...
        <tr>
          ...
          <?php if($nivel=='9') { ?>
          <td bgcolor="#0094FF"><input name="comision5" type="text" id="comision5" size="3" /></td>
          <?php } else { ?>
          <td bgcolor="#0094FF"><input name="comision5" type="text" id="comision5" size="3" /></td>
          <?php } ?>
        ...
        <tr>
          ...
          <?php } else { ?>
          <td bgcolor="#0094FF"><input name="comision6" type="text" id="importe62" size="3" /></td>
          <?php } ?>
        ...
        <tr>
          ...
          <?php if($nivel=='9') { ?>
          <td bgcolor="#0094FF"><input name="comision7" type="text" id="comision7" size="3" /></td>
          <?php } else { ?>
          <td bgcolor="#0094FF"><input name="comision7" type="text" id="comision7" size="3" /></td>
          <?php } ?>
        ...
        <tr>
          ...
          <?php if($nivel=='9') { ?>
          <td bgcolor="#0094FF"><input name="comision8" type="text" id="comision8" size="3" /></td>
          <?php } else { ?>
          <td bgcolor="#0094FF"><input name="comision8" type="text" id="comision8" size="3" /></td>
          <?php } ?>
        ...
        <tr>
          ...
          <?php if($nivel=='9') { ?>
          <td bgcolor="#0094FF"><input name="comision9" type="text" id="comision9" size="3" /></td>
          <?php } else { ?>
          <td bgcolor="#0094FF"><input name="comision9" type="text" id="comision9" size="3" /></td>
          <?php } ?>
        ...
        <tr>
          ...
          <?php if($nivel=='9') { ?>
          <td bgcolor="#0094FF"><input name="comision10" type="text" id="comision10" size="3" /></td>
          <?php } else { ?>
          <td bgcolor="#0094FF"><input name="comision10" type="text" id="comision10" size="3" /></td>
          <?php } ?>
        ...
        <tr>
          ...
          <?php if($nivel=='9') { ?>
          <td bgcolor="#0094FF"><input name="comision11" type="text" id="comision11" size="3" /></td>
          <?php } else { ?>
          <td bgcolor="#0094FF"><input name="comision11" type="text" id="comision11" size="3" /></td>
          <?php } ?>
        ...
        <tr>
          ...
          <?php } else { ?>
          <td bgcolor="#0094FF"><input name="comision11" type="text" id="comision12" size="3" /></td>
          <?php } ?>
        ...
        <tr>
          ...
          <?php } else { ?>
          <td bgcolor="#0094FF"><input name="comision11" type="text" id="comision13" size="3" /></td>
          <?php } ?>
        ...
        <tr>
          ...
          <?php if($nivel=='9') { ?>
          <td bgcolor="#0094FF"><input name="comision14" type="text" id="comision13" size="3" /></td>
          <?php } else { ?>
          <td bgcolor="#0094FF"><input name="comision11" type="text" id="comision14" size="3" /></td>
          <?php } ?>
    ...
    <tr bgcolor="#0094FF">
      <td width="260"  valign="top"><table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#0094FF">
   <tr >
     <td width="50%">&nbsp;<span class="ewTableHeader">Resolucion</span></td>
     <td width="50%"><input name="tieneresol" type="checkbox" id="tieneresol" value="si" onclick="resol(this.form)"   /></td>
   </tr>
    <tr>
     <td width="50%">&nbsp;<span class="ewTableHeader">Resolucion</span></td>
     <td width="50%"><input name="imprimir" type="checkbox" id="imprimir" value="si" onclick="resol(this.form)"   /></td>
   </tr>
      </table> </td><td width="373"  align="right">
        <table width="320" border="0" cellpadding="1" cellspacing="1" bgcolor="#0094FF">
          <tr>
            <td colspan="2"><div align="center"><img src="images/con_pago.gif" width="140" height="28" /></div></td>
          </tr>
          <tr>
            <td width="48%">&nbsp;<span class="ewTableHeader">Efectivo</span></td>
            <td width="52%"><input name="pago_contado2" type="checkbox" onclick="forma_pago(this.form)" value="si" checked="checked"/></td>
          </tr>
        </table>
      </td>
      </tr>
    ...
    <tr>
      <td colspan="3" bgcolor="#003366"><table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#0094FF">
        ...
        <tr>
          ...
          <td><input name="totcomis" id="totcomis" type="text" size="12" /></td>
