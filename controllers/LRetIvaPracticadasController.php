...
/**
 * l_ret_iva_practicadas controller
 */
class LRetIvaPracticadasController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/LRetIvaPracticadas[/{params:.*}]", [PermissionMiddleware::class], "custom.l_ret_iva_practicadas")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "LRetIvaPracticadas");
    }
}
