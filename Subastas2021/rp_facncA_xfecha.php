...
while ($row_cabeceraf = mysqli_fetch_array($cabeceraf)) {
	...
	if ($ptcomp !=  51 && $ptcomp !=  52  && $ptcomp != 55 &&  $ptcomp != 57  && $ptcomp != 59 && 
		$ptcomp != 61 && $ptcomp != 63 && $ptcomp != 89 && $ptcomp != 92 && $ptcomp != 93 && $ptcomp != 94)
		continue;
	$totalFilas = 0;
	...
	$pdf->SetY(-58); // $pdf->SetY(-25);
   	...
   	if ($pserie==29 || $pserie == 31) {	
    	...
    	if ($ptcomp == 59 || ($ptcomp == 57 && $tot_iva21 == 0.00 && $tot_iva105 == 0.00))
   		$pdf->Cell(0,8,'  Neto 0 %                  Neto 10,5 %              Comisi�n 10 %                    IVA 21 %                        IVA 10,5 %                  Tasa Adm.            Importe Total',0,0,'L');
		else if ($ptcomp == 52 && $tot_neto0 != 0)
			$pdf->Cell(0,8,'  Neto 21 %                  Neto 0 %              Comisi�n 10 %                    IVA 21 %                        IVA 10,5 %               Tasa Adm.            Importe Total',0,0,'L');
		else
