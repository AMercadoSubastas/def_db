...
/**
 * l_compras_xls controller
 */
class LComprasXlsController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/LComprasXls[/{params:.*}]", [PermissionMiddleware::class], "custom.l_compras_xls")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "LComprasXls");
    }
}
