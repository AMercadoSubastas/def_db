...
/**
 * l_ret_iva_sufridas controller
 */
class LRetIvaSufridasController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/LRetIvaSufridas[/{params:.*}]", [PermissionMiddleware::class], "custom.l_ret_iva_sufridas")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "LRetIvaSufridas");
    }
}
