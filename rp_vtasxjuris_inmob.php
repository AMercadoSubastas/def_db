...
$query_cabfac = sprintf("SELECT * FROM cabfac WHERE (tcomp BETWEEN 51 AND 64 OR tcomp IN (89,92,93,94,103,104,105,111,112)) AND fecreg BETWEEN %s AND %s AND usuario in (25,26) ORDER BY fecreg, nrodoc, tcomp", $fecha_desde, $fecha_hasta);
