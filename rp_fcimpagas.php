...
// Inicio el pdf con los datos de cabecera
  ...
  $pdf->SetY(15);
  $pdf->Cell(130);
  $pdf->Cell(20,10,' Facturas de Ventas Impagas ',0,0,'L');
...
{	
	...
	if ($tcomp !=  51 && $tcomp !=  52 && $tcomp !=  53 && $tcomp !=  54 && $tcomp != 55 && 
		...
		$tcomp != 61 && $tcomp != 62 &&	$tcomp != 63 && $tcomp != 64  && $tcomp != 86 && $tcomp != 89 && $tcomp != 92 && $tcomp != 93 && $tcomp != 94
         && $tcomp != 102 && $tcomp != 103 && $tcomp != 104 && $tcomp != 105)
		continue;
