 ...
 * Page class
 */
class LocalidadesDelete extends Localidades
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LocalidadesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "LocalidadesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("LocalidadesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("LocalidadesList"); // Return to list
                return;
            }
        }
