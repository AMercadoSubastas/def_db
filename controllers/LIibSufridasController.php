...
/**
 * l_iib_sufridas controller
 */
class LIibSufridasController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/LIibSufridas[/{params:.*}]", [PermissionMiddleware::class], "custom.l_iib_sufridas")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "LIibSufridas");
    }
}
