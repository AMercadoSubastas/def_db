 ...
 * Page class
 */
class DetfacView extends Detfac
{
    use MessagesTrait;
    ...
    // CSS class/style
    public $CurrentPageName = "DetfacView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("codnum") ?? Route("codnum")) !== null) {
            ...
            $returnUrl = "DetfacList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "DetfacList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
