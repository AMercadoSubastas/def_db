...
$query_cabfac = sprintf("SELECT * FROM cabfac WHERE fecreg BETWEEN %s AND %s  AND usuario not in (25,26) ORDER BY fecreg, nrodoc", $fecha_desde, $fecha_hasta);
...
// Inicio el pdf con los datos de cabecera
  ...
  $pdf->SetY(15);
  $pdf->Cell(130);
  $pdf->Cell(20,10,' Libro IVA Ventas Subastas',0,0,'L');
