...
/**
 * Table class for impfac
 */
class Impfac extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->nreng->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        ...
        $this->codimp->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "impfac";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ImpfacList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ImpfacView" => $Language->phrase("View"),
            "ImpfacEdit" => $Language->phrase("Edit"),
            "ImpfacAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ImpfacView",
            Config("API_ADD_ACTION") => "ImpfacAdd",
            Config("API_EDIT_ACTION") => "ImpfacEdit",
            Config("API_DELETE_ACTION") => "ImpfacDelete",
            Config("API_LIST_ACTION") => "ImpfacList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ImpfacView", $parm);
        } else {
            $url = $this->keyUrl("ImpfacView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ImpfacEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ImpfacList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ImpfacAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ImpfacList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ImpfacDelete", $parm);
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->codimp->EditValue = $this->codimp->CurrentValue;
        $this->codimp->PlaceHolder = RemoveHtml($this->codimp->caption());
        if (strval($this->codimp->EditValue) != "" && is_numeric($this->codimp->EditValue)) {
            $this->codimp->EditValue = FormatNumber($this->codimp->EditValue, null);
        }
