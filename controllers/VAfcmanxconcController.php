...
/**
 * v_afcmanxconc controller
 */
class VAfcmanxconcController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/VAfcmanxconc[/{params:.*}]", [PermissionMiddleware::class], "custom.v_afcmanxconc")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "VAfcmanxconc");
    }
}
