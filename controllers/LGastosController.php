 ...
 * l_gastos controller
 */
class LGastosController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/LGastos[/{params:.*}]", [PermissionMiddleware::class], "custom.l_gastos")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "LGastos");
    }
}
