...
<body>
<form  name="libros" class="container-specific-1" method="post" action="rp_ctacte_cli_tot.php">
  <table width="392" height="179" border="0" align="left" cellpadding="1" cellspacing="1">
    ...
    <tr>
      ...
      <tr>
      <td width="181">cliente desde</td>
      <td width="132"><input name="cli_desde" type="text" size="11" /></td>
      
    </tr>
      <tr>
      <td width="181">cliente Hasta</td>
      <td width="132"><input name="cli_hasta" type="text" size="11" /></td>
