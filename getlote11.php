...
//  fclose($f1); 
 ...
 // $chau ="12";
  ...
  $chau = $inf["comiscobr"];
  $secu = $inf["secuencia"];
      echo "formObj12.descripcion11.value = '".$hola."';\n";  
  //  echo "formObj.descripcion.value = '".$inf["descor"]."';\n";    
      echo "formObj12.comision11.value = '".$chau."';\n";    
	  echo "formObj12.secuencia11.value = '".$secu."';\n";    
   } else {
   //  $fact = mysqli_query("SELECT * FROM detfac WHERE ( codrem='".$remate."' AND codintlote='".$lote."')")  or die(mysqli_error($amercado));
    ...
    echo "formObj12.descripcion11.value = '".$item."';\n";  
   
   
   }      
    
  }else{
    echo "formObj12.descripcion11.value  = '';\n";    
    echo "formObj12.comision11.value = '';\n";   
	echo "formObj12.secuencia11.value = '';\n";    
