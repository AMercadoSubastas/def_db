 ...
 * Page class
 */
class DirRematesDelete extends DirRemates
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DirRematesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "DirRematesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("DirRematesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("DirRematesList"); // Return to list
                return;
            }
        }
