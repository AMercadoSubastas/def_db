...
<body>
<form  name="libros"  class="container-specific-1" method="post" action="rp_retenciones_div.php">
  <table width="369" height="182" border="0" align="left" cellpadding="1" cellspacing="1">
    ...
    <tr>
      <td width="150">&nbsp;</td>
      <td width="50"><input type="submit" class="btn" name="Submit" value="Enviar" /></td>
      <td width="50">&nbsp;</td>
    </tr>
  </table>
</form>
