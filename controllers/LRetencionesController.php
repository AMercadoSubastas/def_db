...
/**
 * l_retenciones controller
 */
class LRetencionesController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/LRetenciones[/{params:.*}]", [PermissionMiddleware::class], "custom.l_retenciones")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "LRetenciones");
    }
}
