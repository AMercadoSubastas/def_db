...
/**
 * l_comisxremjurist controller
 */
class LComisxremjuristController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/LComisxremjurist[/{params:.*}]", [PermissionMiddleware::class], "custom.l_comisxremjurist")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "LComisxremjurist");
    }
}
