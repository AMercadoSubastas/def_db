...
if (GetSQLValueString($_POST['importe_ing_brutos'], "double")!="NULL") {
	...
	//echo "Adentro de Ingresos Brutos";
	} elseif   (GetSQLValueString($_POST['importe_ganancias'], "double")!="NULL") {    //  Importe del comprobanta 
		// Datos para ING BRUTOS         // 
		...
		//echo "Adentro de Ganancias";
		} elseif   (GetSQLValueString($_POST['importe_iva'], "double")!="NULL") {      //  Importe del comprobanta 
			// Datos para ING BRUTOS         // 
			...
			//echo "Adentro de IVA";
			} elseif   (GetSQLValueString($_POST['importe_sus'], "double")!="NULL") { 
				// Datos para ING BRUTOS         // 
