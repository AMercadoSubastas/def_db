...
//  $tcompsal = 2 ;
//  $seriesal =3 ;
//  $ncomsal = GetSQLValueString($_POST['liquidacion'], "int");
//  $codrem =  GetSQLValueString($_POST['remate'], "int");
//  $fechareamte = 
//$insertSQL = sprintf("INSERT INTO cartvalores (tcomprel , serierel , ncomprel , estado , tcompsal , seriesal , ncompsal, codrem , fechaentrega ) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
 ...
 //                      GetSQLValueString($_POST['fecest'], "date"),
 //                      GetSQLValueString($_POST['fecreal'], "date"),
 //                      GetSQLValueString($_POST['imptot'], "double"),
 //                      GetSQLValueString($_POST['cantlotes'], "int"),
 //                      GetSQLValueString($_POST['horaest'], "date"),
 //                      GetSQLValueString($_POST['horareal'], "date"),
 //                      GetSQLValueString($_POST['observacion'], "text"),
//                       GetSQLValueString($_POST['tipoind'], "int"));  
  
  
echo "<form name='cheque_tercero' action='aliquidacion.php'>";
echo "<input name='remate' type='text' value='$remate' />";
//echo "<input name='cliente' type='text' value='$numero_cliente'>";
...
<?php $tipo = $_GET['tcomp_b'];
$serie = $_GET['serie_b'];
$liquidacion = $_GET['liquidacion_b'];
$remate = $_GET['remate_num_b'];

//echo "Remate num".$remate."<br>";
//echo "Tipo de Comprobante".$tipo."<br>";
//echo "Serie de Liquidacion".$serie."<br>";
//echo "Liquidacion".$liquidacion."<br>";
...
mysqli_select_db($amercado, $database_amercado);
$query_gastos_autorizados = "SELECT cabfac.codnum, cabfac.ncomp, cabfac.fecreg, cabfac.totbruto, cabfac.tcomp FROM cabfac WHERE cabfac.tcomp=18  AND cabfac.codrem='$remate' AND cabfac.estado='P'";
...
//echo "CAntidad Gastos".$cant_gastos."<br>";
if ($cant_gastos == 0){ 
...
<?php }
//echo "Total Gastos autorizados ".$cant_gastos;
?>
...
<table width="640" border="0" cellspacing="1" cellpadding="1">
  <tr>
    <td colspan="2" background="images/fondo_titulos.jpg"><img src="images/ing_facturas_a_liq.gif" width="315" height="30" /></td>
  </tr>
  <tr>
    <td width="320">&nbsp;</td>
    <td width="379">&nbsp;</td>
     ...
     <tr>
      ...
      <tr>
        ...
        <td colspan="2"><table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#FFFFCC">
          <tr>
            <td colspan="6" bgcolor="#993333" ><div align="center"><img src="images/ing_facturas_a_liq.gif" width="367" height="24" /></div></td>
          </tr>
          <tr>
