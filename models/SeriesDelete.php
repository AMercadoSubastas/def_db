 ...
 * Page class
 */
class SeriesDelete extends Series
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SeriesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "SeriesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("SeriesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("SeriesList"); // Return to list
                return;
            }
        }
