 ...
 * a_liquid controller
 */
class ALiquidController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/ALiquid[/{params:.*}]", [PermissionMiddleware::class], "custom.a_liquid")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "ALiquid");
    }
}
