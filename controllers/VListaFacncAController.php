...
/**
 * v_lista_facncA controller
 */
class VListaFacncAController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/VListaFacncA[/{params:.*}]", [PermissionMiddleware::class], "custom.v_lista_facncA")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "VListaFacncA");
    }
}
