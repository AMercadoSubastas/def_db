...
$pdf->SetY(15);
$pdf->Cell(70);
$pdf->Cell(20,10,' Ranking de Ventas por Cliente (Lotes)',0,0,'L');
$pdf->SetFont('Arial','B',9);
$pdf->SetY(25);
$pdf->Cell(10);
$pdf->Cell(60,8,'     Raz�n Social  ',1,0,'L');
$pdf->Cell(25,8,'       CUIT  ',1,0,'L');
$pdf->Cell(45,8,'     Total Facturado      ',1,0,'L');
...
{	
	...
	if ($row_Recordset3["esfactura"] != 1)
		continue;
	if ($tcomp != 51 && $tcomp != 53 && $tcomp != 57 && $tcomp != 58 && $tcomp != 59 && $tcomp != 60)
		continue;
	...
	$cliente = $row_cabecerafac["cliente"];
	$total   = ($row_cabecerafac["totneto105"] + $row_cabecerafac["totneto21"]) * $signo;
...
for ($j=0;$j < $i;$j++) {
	if ($linea < 48) {
		...
		$pdf->SetY(15);
		$pdf->Cell(70);
		$pdf->Cell(20,10,' Ranking de Ventas por Cliente',0,0,'L');
		$pdf->SetFont('Arial','B',9);
		$pdf->SetY(25);
		$pdf->Cell(10);
		$pdf->Cell(60,8,'     Raz�n Social  ',1,0,'L');
