	...
	if ($i <= 22) {
		...
		switch ($tcomp) {
            ...
            case 113:
                ...
                while ($row_detfac = mysqli_fetch_array($detfac, MYSQLI_BOTH)) {
                    if ($row_detfac["concafac"] == 20 || $row_detfac["concafac"] == 28 || $row_detfac["concafac"] == 33 || $row_detfac["concafac"] == 41 || $row_detfac["concafac"] == 43 || $row_detfac["concafac"] == 71)
                        $tot_public   += $row_detfac["neto"];
                    if ($row_detfac["concafac"] == 14)
				        $lotes21      += $row_detfac["neto"];
		...
		$fecha        = substr($row_cabecerafac["fecdoc"],8,2)."-".substr($row_cabecerafac["fecdoc"],5,2)."-".substr($row_cabecerafac["fecdoc"],0,4);
  		switch ($tcomp) {
            ...
            case 112:
				...
				$tot_servicios= 0.00;
                while ($row_detfac = mysqli_fetch_array($detfac, MYSQLI_BOTH)) {
                    if ($row_detfac["concafac"] == 2 || $row_detfac["concafac"] == 4 || $row_detfac["concafac"] == 3 || $row_detfac["concafac"] == 28)
                        $tot_public   += $row_detfac["neto"];
                    if ($row_detfac["concafac"] == 14)
				        $lotes21      += $row_detfac["neto"];
                    if ($row_detfac["concafac"] == 13)
