...
/**
 * lista_ivacompras controller
 */
class ListaIvacomprasController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/ListaIvacompras[/{params:.*}]", [PermissionMiddleware::class], "custom.lista_ivacompras")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "ListaIvacompras");
    }
}
