...
//$remate = 1302;
	...
	$sql_deposito = sprintf("SELECT   bancos.nombre ,codchq , importe , fechapago , codrem, cartvalores.codnum FROM cartvalores , bancos WHERE tcomp = 9  AND serie = 7  AND tcomprel = %s AND serierel = %s AND ncomprel = %s AND bancos.codnum = cartvalores.codban", $tip_comp,$serierel,$num_fact);
		// $registro1
		$sql = sprintf("SELECT bancos.nombre , codchq , importe , fechapago , codrem , cartvalores.codnum FROM cartvalores , bancos WHERE tcomp =8 AND serie =6 AND tcomprel = %s AND serierel = %s AND ncomprel = %s  AND bancos.codnum = cartvalores.codban",$tip_comp,$serierel,$num_fact);
		//echo "TIPCOMP =".$tip_comp."  - SERIE = ".$serierel."  - NUM_FACT = ".$num_fact."  -  REMATE = ".$num_remate."  -  ";
		// $registro2
		$sql_dolares = sprintf("SELECT importe FROM cartvalores WHERE tcomp =13 AND serie =9 AND tcomprel = %s AND serierel = %s AND ncomprel = %s",$tip_comp,$serierel,$num_fact);
		// $registro3
		$sql_pesos = sprintf("SELECT importe  FROM cartvalores  WHERE tcomp =12 AND serie =8 AND tcomprel = %s AND serierel = %s AND ncomprel = %s",$tip_comp,$serierel,$num_fact);
		// $registro4
		$sql_iva = sprintf("SELECT * FROM cartvalores WHERE tcomp =40 AND serie =22 AND tcomprel = %s AND serierel = %s AND ncomprel = %s",$tip_comp,$serierel,$num_fact);
		// $registro5
		$sql_ing_brutos = sprintf("SELECT * FROM cartvalores WHERE tcomp =41 AND serie =23 AND tcomprel = %s AND serierel = %s AND ncomprel = %s",$tip_comp,$serierel,$num_fact);
		// $registro6
		$sql_ganancias = sprintf("SELECT * FROM cartvalores WHERE tcomp =42 AND serie =24 AND tcomprel = %s AND serierel = %s AND ncomprel = %s",$tip_comp,$serierel,$num_fact);
		// $registro7
		$sql_suss = sprintf("SELECT * FROM cartvalores WHERE tcomp =43 AND serie =25 AND tcomprel = %s AND serierel = %s AND ncomprel = %s",$tip_comp,$serierel,$num_fact); 
		$precio2 =0 ;
...
<table width="90%" border="0" cellspacing="1" cellpadding="1">
  ...
  <tr>
     ...
     <form name="valor_contado" > <tr>
      ...
      <tr>
        ...
        <td colspan="2"><table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#003366">
          ...
          <form id="cheques" name="cheque_form" method="post" action="carga_cheque_con.php">
            <tr>
      ...
      <tr>
        ...
        <td colspan="2"><table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#003366">
          ...
          <form id="cheques" name="deposito_form" method="post" action="carga_deposito_con.php">
            <tr>
      ...
      <tr>
        ...
        <td colspan="2"><table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#003366">
          ...
          <form id="form1" name="moneda" method="post" action="carga_moneda_con.php">
            <tr>
      ...
      <tr>
        ...
        <td colspan="2"><table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#003366">
          ...
          <form id="ing_pesos" name="ing_pesos" method="post" action="carga_pesos_con.php">
            <tr>
       ...
       <tr>
        ...
        <td colspan="2"><table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#003366">
          ...
          <tr>
		   ...
		   ?>
          <form id="ing_brutos" name="ing_brutos" method="post" action="carga_retencion_con.php">
			...
			<form id="ing_ganancias" name="ing_ganancias" method="post" action="carga_retencion_con.php"> 
			<tr>
			  ...
			  <form  name="ing_iva" method="post" action="carga_retencion_con.php"> 
			<tr>
			  ...
			  <form  name="ing_suss" method="post" action="carga_retencion_con.php"> 
            <tr>
   ...
   $reg_ley = $reg_ley." - ".$registro[0].", Nro ".$registro[1].", $ ".$registro[2]."/"; 
           ?>
            ...
            <tr>
              ...
              <td bgcolor="#993333" ><input name="list_importe_cheque" type="text" class="seleccion" id="importe2" size="15" value="<?php echo $registro[2] ?>"/>              </td><td bgcolor="#993333"><a href="medio_borrar_con.php?codnum=<?php echo $registro[5] ?>" ><img src="images/b_drop.png" width="16" height="16" border="0" /></a></td>
              <td bgcolor="#993333"><a href="medio_editar_con.php?codnum=<?php echo $registro[5] ?>" ><img src="images/b_edit.png" width="16" height="16" border="0" /></a></td>
            </tr>
			<?php } ?>
            <tr>
   ...
   $reg_leyenda = $reg_leyenda."-".$registro1[0].",Nro ".$registro1[1]." $ ".$registro1[2]."/"; 
?>
<tr>
...
<td bgcolor="#993333"><input name="textfield422" type="text" class="seleccion" size="13" value="<?php echo $registro1[2] ?>" />              </td>      
        <td bgcolor="#FFFF00"><a href="medio_borrar_con.php?codnum=<?php echo $registro1[5] ?>"><img src="images/b_drop.png" width="16" height="16" border="0" /></a></td>
        <td bgcolor="#993333"><a href="medio_editar_con.php?codnum=<?php echo $registro1[5] ?>"><img src="images/b_edit.png" width="16" height="16" border="0" /></a></td>
</tr>
		<?php } ?>
            <tr>
              <td bgcolor="#993333">&nbsp;</td>
...
?>  <?php if ($totalRows_total_ing_brutos!=0) {  
  ...
  echo "Registro ING BRUTOS".$record_ing_brutos ?><br/>
          ...
          <tr>
            ...
            <td width="34"   bgcolor="#993333"  align="right"><a href="medio_borrar_con.php?codnum=<?php echo $record_ing_brutos ?>" ><img src="images/b_drop.png" width="16" height="16" border="0" /></a></td>
            <td width="34"   bgcolor="#993333"  align="right"><a href="medio_editar_reten_con.php?codnum=<?php echo $record_ing_brutos ?>&retencion= <?php echo $retencion ?>"><img src="images/b_edit.png" width="16" height="16" border="0" /></a></td>
            </tr> <?php } 
          ...
          <tr>
            ...
            <td width="34"  bgcolor="#993333"  align="right"><a href="medio_borrar_con.php?codnum=<?php echo $record_ganacias ?>"><img src="images/b_drop.png" width="16" height="16" border="0" /></a></td>
            <td width="34"  bgcolor="#993333"  align="right"><a href="medio_editar_reten_con.php?codnum=<?php echo $record_ganacias ?>&retencion= <?php echo $retencion ?>"><img src="images/b_edit.png" width="16" height="16" border="0" /></a></td>
            </tr> <?php } 
          ...
          <tr>
            ...
            <td  bgcolor="#993333"  align="right"><a href="medio_borrar_con.php?codnum=<?php echo $record_iva ?>"><img src="images/b_drop.png" width="16" height="16" border="0" /></a></td>
            <td  bgcolor="#993333"  align="right"><a href="medio_editar_reten_con.php?codnum=<?php echo $record_iva ?>&retencion= <?php echo $retencion ?>"><img src="images/b_edit.png" width="16" height="16" border="0" /></a></td>
          ...
          <tr>
            ...
            <td  bgcolor="#993333"  align="right"><a href="medio_borrar_con.php?codnum=<?php echo $record_sus ?>"><img src="images/b_drop.png" width="16" height="16" border="0" /></a></td>
            <td  bgcolor="#993333"  align="right"><a href="medio_editar_reten_con.php?codnum=<?php echo $record_sus ?>&retencion= <?php echo $retencion ?>"><img src="images/b_edit.png" width="16" height="16" border="0" /></a></td>
            </tr><?php } ?>
          <tr>
      ...
      <tr>
        <td><?php 
			 ...
			 if ($monto_total_cheques!=0) { //  $precio1 = 0 ;
			   	$leyenda = $leyenda." Deposito : ".$reg_ley." -";
			  	$leyenda = $leyenda." Total de depositos $".$monto_total_cheques."-";
			 }
			 //  $monto_total_cheques = 0 ;
			 if ($precio1!=0) {
