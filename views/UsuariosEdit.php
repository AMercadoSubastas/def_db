...
<div class="input-group">
    <input type="password" name="x_clave" id="x_clave" autocomplete="new-password" data-field="x_clave" value="<?= $Page->clave->EditValue ?>" size="40" maxlength="255" placeholder="<?= HtmlEncode($Page->clave->getPlaceHolder()) ?>"<?= $Page->clave->editAttributes() ?> aria-describedby="x_clave_help">
