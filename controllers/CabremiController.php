...
class CabremiController extends ControllerBase
{
    // list
    #[Map(["GET","POST","OPTIONS"], "/CabremiList[/{codnum}]", [PermissionMiddleware::class], "list.cabremi")]
    public function list(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "CabremiList");
    }
}
