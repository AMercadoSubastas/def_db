...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
	...
	if (isset($cuit_enti)) {
		$cuit_enti2 =substr($cuit_enti, 3, 8); 
	}
...
<form id="factura" name="factura" method="POST" action="<?php echo $editFormAction; ?>">
  <table width="900" border="1" align="left" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
    <tr>
        <td width="900" colspan="3" ><div align="center"><img src="images/not_cred_B4.png" width="330" height="30" /></div></td>
    </tr>
    <tr>
        <td colspan="2" valign="top" bgcolor="#FFFFFF"><table width="100%" border="1" cellspacing="1" cellpadding="1">
        <tr>
            <td width="13%" height="20" bgcolor="#FFFFFF">&nbsp;<span class="ewTableHeader">Tipo de Cbte </span></td>
        ...
        <tr>
            ...
            <td width="34%"><input name="fecha_factura1" type="text" id="fecha_factura1" size="25"  value= <?php echo $fecha_hoy; ?> />
        ...
        <td colspan="3" valign="top" bgcolor="#FFFFFF"><table width="100%" border="1" cellspacing="1" cellpadding="1">
          ...
          <td width="20%"><select name="tcbterel2" onChange="agregarOpciones2(this.form)">
                              ...
                              <option value="7">N DEB B0002</option>
        ...
        <tr>
            ...
            <tr>
			    ...
			    <td width="87" background="images/fonod_lote.jpg" class="ewTableHeader">
