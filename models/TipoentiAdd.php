 ...
 * Page class
 */
class TipoentiAdd extends Tipoenti
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TipoentiAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "TipoentiAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("TipoentiList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "TipoentiList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "TipoentiView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "TipoentiList") {
                            ...
                            $returnUrl = "TipoentiList"; // Return list page content
                        }
                    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("TipoentiList"), "", $this->TableVar, true);
