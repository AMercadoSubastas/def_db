...
?>
    ...
    <tr>
	  ...
	  <table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#003366">
		...
		<tr>
          ...
          <td bgcolor="#0094FF"><input name="descripcion" type="text" class="phpmaker" id="descripcion" size="65" />
	...
	<td bgcolor="#0094FF" width="29" align="center"><input type="radio" name="impuesto1" value="<?php echo $iva_21_porcen     ?>" onclick="validarFormulario(this.form)" /></td>
      ...
      <input name="secuencia1" type="hidden" class="phpmaker" id="secuencia1" size="65" />
         ...
         <?php if($nivel=='9') { ?> <td bgcolor="#0094FF"><input name="comision12" type="text" id="comision12" size="3" /></td>
		 <?php } else { ?>
     ...
     <?php if($nivel=='9') { ?>  <td bgcolor="#0094FF"><input name="comision13" type="text" id="comision13" size="3" /></td>
	 <?php } else { ?>
    ...
    <?php if($nivel=='9') { ?>      <td bgcolor="#0094FF"><input name="comision14" type="text" id="comision14" size="3" /></td>
	<?php } else { ?>
