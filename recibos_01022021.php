...
if (isset($_POST['renglon1']) && GetSQLValueString($_POST['renglon1'], "int")!="NULL") {
	...
	if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "recibo")) {
		// INSERTO LOS DETALELS DE LA FACTURA EN EL RECIBO DE LA PRIMER FACTURA
...
if (isset($_POST['renglon2']) && GetSQLValueString($_POST['renglon2'], "int")!="NULL") {
	if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "recibo")) {
		// INSERTO LOS DETALELS DE LA FACTURA EN EL RECIBO DE LA SEGUNDA FACTURA
		$doc2 = $_POST['doc2'];
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "recibo"))  {
	...
	$insertGoTo = "medios_pago_recibos.php?ftcomp='2'&&fserie='3'&&fncomp=$recibo";
  	...
  	header(sprintf("Location: %s", "medios_pago_recibos.php?ftcomp=2&&fserie=3&&fncomp=$recibo&&total_general=$tot_general&&remate=$remate"));
}
?>
