 ...
 * Page class
 */
class RubrosDelete extends Rubros
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RubrosDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "RubrosDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("RubrosList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("RubrosList"); // Return to list
                return;
            }
        }
