...
<form id="form1" name="form1" method="post" action="rp_comisvend.php">
  <table width="707" height="264" border="0" align="left" cellpadding="1" cellspacing="1">
    ...
    <tr>
      ...
      <td width="69"><a href="javascript:showCal('Calendar18')"><img src="calendar/img.gif" width="32" height="23"  border="0"/></a></td>
    </tr>
    <tr>
      <td width="181" height="44">Hasta</td>
      <td width="132"><input name="fecha_hasta" type="text" size="11" /></td>
      <td width="69"><a href="javascript:showCal('Calendar19')"><img src="calendar/img.gif" width="32" height="23"  border="0"/></a></td>
    </tr>
    <tr>
      <td width="126">&nbsp;</td>
      <td width="365">&nbsp;</td>
