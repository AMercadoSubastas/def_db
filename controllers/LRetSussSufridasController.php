...
/**
 * l_ret_suss_sufridas controller
 */
class LRetSussSufridasController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/LRetSussSufridas[/{params:.*}]", [PermissionMiddleware::class], "custom.l_ret_suss_sufridas")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "LRetSussSufridas");
    }
}
