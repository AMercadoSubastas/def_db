...
$query_Recordset1 = "SELECT cabfac.nrodoc , cabfac.fecval, cabfac.totbruto , cabfac.tcomp , cabfac.codnum FROM cabfac WHERE cabfac.cliente='$cliente'  AND cabfac.estado='P' AND cabfac.tcomp NOT IN (98,99) ORDER BY cabfac.tcomp , cabfac.fecreg ,  cabfac.ncomp";
  ...
  <form name="deposito_list" method='post' action='recibos.php'>
   <tr bgcolor="#003366">
    <td class="ewTableHeader" >Cliente&nbsp;&nbsp;&nbsp;</td>
     <td colspan="3"><input type="text"  value="<?php echo utf8_encode($row_cliente['razsoc']) ?>" /></td>
	</tr><input type="hidden" name="cli" value="<?php echo $cliente ?>" />
   
	<tr bgcolor="#003366">
    <td class="ewTableHeader" >Direccion&nbsp;&nbsp;&nbsp;</td>
     <td colspan="3"><input type="text"  value="<?php echo utf8_encode($row_cliente['calle'])."  ".$row_cliente['numero'] ?>" size="35" /></td>
