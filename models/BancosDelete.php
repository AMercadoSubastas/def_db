 ...
 * Page class
 */
class BancosDelete extends Bancos
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BancosDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "BancosDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("BancosList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("BancosList"); // Return to list
                return;
            }
        }
