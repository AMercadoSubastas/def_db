 ...
 * Page class
 */
class TipoivaEdit extends Tipoiva
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TipoivaEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "TipoivaEdit";
    ...
    protected function getEditRow($rsold)
    {
        ...
        // discrimina
        $this->discrimina->setDbValueDef($rsnew, strval($this->discrimina->CurrentValue) == "1" ? "1" : "0", $this->discrimina->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['discrimina'])) { // discrimina
            $this->discrimina->CurrentValue = $row['discrimina'];
        }
