...
<body>
<form  name="libros" method="post" action="rp_ret_iva_sufridas.php">
  <table width="427" height="265" border="0" align="left" cellpadding="1" cellspacing="1">
    <tr>
      <td colspan="3" background="images/nada.gif" align="center">&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="3">Lista las retenciones de IVA</td>
    </tr>
    <tr>
