 ...
 * Page class
 */
class CabreciboAdd extends Cabrecibo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CabreciboAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "CabreciboAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "CabreciboView") {
    ...
    {
        $this->emitido->DefaultValue = $this->emitido->getDefault(); // PHP
        $this->emitido->OldValue = $this->emitido->DefaultValue;
    }
    ...
    protected function validateForm()
    {
        ...
        if (in_array("detrecibo", $detailTblVar) && $detailPage->DetailAdd) {
            $detailPage->run();
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($addRow) {
            $detailTblVar = explode(",", $this->getCurrentDetailTable());
            $detailPage = Container("DetreciboGrid");
            if (in_array("detrecibo", $detailTblVar) && $detailPage->DetailAdd && $addRow) {
    ...
    protected function getAddRow()
    {
        ...
        // cantcbtes
        $this->cantcbtes->setDbValueDef($rsnew, $this->cantcbtes->CurrentValue, false);
        ...
        // imptot
        $this->imptot->setDbValueDef($rsnew, $this->imptot->CurrentValue, false);
        ...
        $this->emitido->setDbValueDef($rsnew, $tmpBool, strval($this->emitido->CurrentValue) == "");
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['cantcbtes'])) { // cantcbtes
            $this->cantcbtes->setFormValue($row['cantcbtes']);
        }
        ...
        if (isset($row['imptot'])) { // imptot
            $this->imptot->setFormValue($row['imptot']);
        }
