...
/**
 * v_afcxloteA10 controller
 */
class VAfcxloteA10Controller extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/VAfcxloteA10[/{params:.*}]", [PermissionMiddleware::class], "custom.v_afcxloteA10")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "VAfcxloteA10");
    }
}
