    ...
    <tr>
      <td colspan="2">
              ...
              <table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#003366">
                <tr>
                  <td colspan="6" bgcolor="#0094FF">
                    <div align="center"><img src="images/ingres_cheques_propios.gif" width="500" height="24" /></div>
                  </td>
                </tr>
                <tr>
                  <td width="221" bgcolor="#00CCFF">
          ...
          <tr>
            ...
            <td colspan="2">
              <table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#003366">
                <tr>
                  <td colspan="6" bgcolor="#0094FF">
                    <div align="center"><img src="images/ingreso_depositos_propios.gif" width="402" height="24" /></div>
                  </td>
                </tr>
                <tr>
        ...
        <td colspan="2"><table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#003366">
          ...
          <form id="ing_pesos" name="ing_pesos" method="post" action="">
            <tr>
            ...
            <tr>
              ...
              <td width="150">&nbsp;</td>
              <td width="150">&nbsp;</td>
			  <input name="numfac4"    type="hidden"  value=""/>
			   <input name="codrem4"   type="hidden"   value=""/>
              <input name="fechaing4"  type="hidden"  value=""/>
              <input name="serie4"     type="hidden"  value="14"/>
              <input name="ncomp4"     type="hidden"   value=""/>
              <input name="serierel4"  type="hidden"   value="" />
              <input name="tcomprel4"  type="hidden"  value="" />
              <input name="estado3"    type="hidden"  value="S"/>
              <input name="tcomp4"     type="hidden"   value="38"/>
			  <input name="tot_general" type="hidden"  value="" />
              ...
              <table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#FFFFCC">
                <tr>
                  <td colspan="5" bgcolor="#993333">
                    <div align="center"><img src="images/cheques_propios_marron.gif" width="367" height="24" /></div>
                  </td>
                </tr>
                <tr>
          ...
          <tr>
            ...
            <td colspan="2">
              <table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#FFFFCC">
                <tr>
                  <td colspan="4" bgcolor="#993333">
                    <div align="center"><img src="images/depositos_bancarios_porpios.gif" width="367" height="24" /></div>
                  </td>
                </tr>
                <tr>
                  <td width="150" bgcolor="#999966">
            ...
            <td colspan="2">
              <table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#FFFFCC">
                ...
                <tr>
                  ...
                  <td width="101" colspan="2" bgcolor="#993333" align="right"><input name="importe_pesos" type="text" class="seleccion" size="13" value="<?php echo $tot_efectivo ?>" /> </td>
                </tr>
                <tr>
                  <td bgcolor="#993333">
          ...
          <tr>
            ...
            <td colspan="2" rowspan="2" bgcolor="#ECE9D8">
              <div align="center"><img src="images/leyenda.gif" width="230" height="26" /> </div>
              <form id="leyenda" name="leyenda" method="POST" action="<?php echo $editFormAction; ?>">
                <div align="center">
