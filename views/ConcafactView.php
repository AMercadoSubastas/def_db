...
?>
<main class="view">
<form name="fconcafactview" id="fconcafactview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" autocomplete="off">
<?php if (!$Page->isExport()) { ?>
<script>
...
<?php if ($Page->codnum->Visible) { // codnum ?>
    <tr id="r_codnum"<?= $Page->codnum->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_concafact_codnum"><?= $Page->codnum->caption() ?></span></td>
...
<?php if ($Page->nroconc->Visible) { // nroconc ?>
    <tr id="r_nroconc"<?= $Page->nroconc->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_concafact_nroconc"><?= $Page->nroconc->caption() ?></span></td>
...
<?php if ($Page->descrip->Visible) { // descrip ?>
    <tr id="r_descrip"<?= $Page->descrip->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_concafact_descrip"><?= $Page->descrip->caption() ?></span></td>
...
<?php if ($Page->porcentaje->Visible) { // porcentaje ?>
    <tr id="r_porcentaje"<?= $Page->porcentaje->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_concafact_porcentaje"><?= $Page->porcentaje->caption() ?></span></td>
...
<?php if ($Page->importe->Visible) { // importe ?>
    <tr id="r_importe"<?= $Page->importe->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_concafact_importe"><?= $Page->importe->caption() ?></span></td>
...
<?php if ($Page->usuario->Visible) { // usuario ?>
    <tr id="r_usuario"<?= $Page->usuario->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_concafact_usuario"><?= $Page->usuario->caption() ?></span></td>
        <td data-name="usuario"<?= $Page->usuario->cellAttributes() ?>>
<span id="el_concafact_usuario">
...
<?php if ($Page->fechahora->Visible) { // fechahora ?>
    <tr id="r_fechahora"<?= $Page->fechahora->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_concafact_fechahora"><?= $Page->fechahora->caption() ?></span></td>
...
<?php if ($Page->activo->Visible) { // activo ?>
    <tr id="r_activo"<?= $Page->activo->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_concafact_activo"><?= $Page->activo->caption() ?></span></td>
...
<?php if ($Page->tipoiva->Visible) { // tipoiva ?>
    <tr id="r_tipoiva"<?= $Page->tipoiva->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_concafact_tipoiva"><?= $Page->tipoiva->caption() ?></span></td>
...
<?php if ($Page->impuesto->Visible) { // impuesto ?>
    <tr id="r_impuesto"<?= $Page->impuesto->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_concafact_impuesto"><?= $Page->impuesto->caption() ?></span></td>
...
<?php if ($Page->tieneresol->Visible) { // tieneresol ?>
    <tr id="r_tieneresol"<?= $Page->tieneresol->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_concafact_tieneresol"><?= $Page->tieneresol->caption() ?></span></td>
...
<?php if ($Page->ctacbleBAS->Visible) { // ctacbleBAS ?>
    <tr id="r_ctacbleBAS"<?= $Page->ctacbleBAS->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_concafact_ctacbleBAS"><?= $Page->ctacbleBAS->caption() ?></span></td>
