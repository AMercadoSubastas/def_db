  ...
  if($inf = mysqli_fetch_array($res)){
   $estado = $inf["estado"];
     if ($estado==0) {  
       ...
       $chau = $inf["comiscobr"];
       $secu = $inf["secuencia"];
       echo "formObj3.descripcion2.value = '".$hola."';\n";  
  //  echo "formObj.descripcion.value = '".$inf["descor"]."';\n";    
       echo "formObj3.comision2.value = '".$chau."';\n";    
	   echo "formObj3.secuencia2.value = '".$secu."';\n";    
    } else {
   ...
   echo "formObj3.descripcion2.value = '".$item."';\n";  
   
   
   }    
    
  }else{
    echo "formObj3.descripcion2.value  = '';\n";    
    echo "formObj3.comision2.value = '';\n";  
	    echo "formObj3.secuencia2.value = '';\n";    
