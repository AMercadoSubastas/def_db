 ...
 * Page class
 */
class CalificacionDelete extends Calificacion
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CalificacionDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "CalificacionDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("CalificacionList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("CalificacionList"); // Return to list
                return;
            }
        }
