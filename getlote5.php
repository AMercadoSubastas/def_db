...
//  fclose($f1); 
 ...
 // $chau ="12";
  ...
  $chau = $inf["comiscobr"];
   $secu = $inf["secuencia"];
   echo "formObj6.descripcion5.value = '".$hola."';\n";  
  //  echo "formObj.descripcion.value = '".$inf["descor"]."';\n";    
    echo "formObj6.comision5.value = '".$chau."';\n";    
	 echo "formObj6.secuencia5.value = '".$secu."';\n";    
     } else {
   ...
   echo "formObj6.descripcion5.value = '".$item."';\n";  
   
   
   }      
    
  }else{
    echo "formObj6.descripcion5.value  = '';\n";    
    echo "formObj6.comision5.value = '';\n";    
	echo "formObj6.secuencia5.value = '';\n";    
