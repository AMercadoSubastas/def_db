...
//  fclose($f1); 
 if($inf = mysqli_fetch_array($res)){
  ...
  $chau = $inf["comiscobr"];
   $secu = $inf["secuencia"];
   echo "formObj9.descripcion8.value = '".$hola."';\n";  
  //  echo "formObj.descripcion.value = '".$inf["descor"]."';\n";    
    echo "formObj9.comision8.value = '".$chau."';\n";    
	 echo "formObj9.secuencia8.value = '".$secu."';\n";    
     } else {
   ...
   echo "formObj9.descripcion8.value = '".$item."';\n";  
   
   
   }      
    
  }else{
    echo "formObj9.descripcion8.value  = '';\n";    
    echo "formObj9.comision8.value = '';\n";  
	   echo "formObj9.secuencia8.value = '';\n";    
