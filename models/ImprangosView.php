 ...
 * Page class
 */
class ImprangosView extends Imprangos
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ImprangosView";
    ...
    // CSS class/style
    public $CurrentPageName = "ImprangosView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("codimp") ?? Route("codimp")) !== null) {
            $this->RecKey["codimp"] = $keyValue;
        }
        if (($keyValue = Get("secuencia") ?? Route("secuencia")) !== null) {
            $this->RecKey["secuencia"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("codimp") ?? Route("codimp")) !== null) {
            ...
            $this->RecKey["codimp"] = $this->codimp->QueryStringValue;
        } elseif (Post("codimp") !== null) {
            $this->codimp->setFormValue(Post("codimp"));
            $this->RecKey["codimp"] = $this->codimp->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->codimp->setQueryStringValue($keyValue);
            $this->RecKey["codimp"] = $this->codimp->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "ImprangosList"; // Return to list
        }
        if (($keyValue = Get("secuencia") ?? Route("secuencia")) !== null) {
            $this->secuencia->setQueryStringValue($keyValue);
            $this->RecKey["secuencia"] = $this->secuencia->QueryStringValue;
        } elseif (Post("secuencia") !== null) {
            $this->secuencia->setFormValue(Post("secuencia"));
            $this->RecKey["secuencia"] = $this->secuencia->FormValue;
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ImprangosList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
