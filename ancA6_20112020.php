...
function validarFormulario(form)
{
	...
	var imp0  = (factura.impuesto[2].value); // impuesto 0 %
	...
	var tot_general  =  0;
	// PRIMER LOTE
	if (factura.impuesto[2].checked==true) {
		if (monto.length!=0) {
	    	var tot_mon = eval(monto);              // Monto de Primer Lote
      		var imp_tot_21 = eval(monto*imp0);        // Impuesto Monto 1 al 21 %
...
function agregarOpciones(form)
{
	var selec = form.tipos.options;
		...
		factura.serie_texto.value = "SERIE DE N CRED A0006";
		factura.tcomp.value = 61;
...
<form id="factura" name="factura" method="POST" action="<?php echo $editFormAction; ?>">
  <table width="741" height="890" border="0" align="left" cellpadding="1" cellspacing="1" bgcolor="#82BADD">
    <tr>
      <td colspan="3" background="images/fondo_titulos.jpg"><div align="center"><img src="images/not_cred_auto.gif" width="450" height="30" /></div></td>
    </tr>
    <tr>
        ...
        <tr>
         ...
         <td colspan="2" bgcolor="#82BADD" align="center"></td>
            ...
            <tr>
             ...
             <tr>
              <td width="56%" height="39" bgcolor="#82BADD">&nbsp;<span class="ewTableHeader"></span></td>
              <td width="44%" bgcolor="#82BADD"></td>
          </tr>
            <tr>
              <td width="56%" height="44" bgcolor="#82BADD">&nbsp;<span class="ewTableHeader"></span></td>
              <td width="44%" bgcolor="#82BADD"></td>
              </tr>
          </table></td>
          </tr>
...
?>
    ...
    <tr>
      <td colspan="3" >
	  <table width="100%" border="1" cellpadding="1" cellspacing="1" bgcolor="#082BADD">
        <tr>
          <td width="39" rowspan="2" background="images/fonod_lote.jpg" class="ewTableHeader">
              <div  align="center">CONCEPTO</div></td>
          <td width="390" rowspan="2" background="images/fonod_lote.jpg" class="ewTableHeader">
              <div align="center">DESCRIPCION</div></td>
          
          <td width="70" rowspan="2" background="images/fonod_lote.jpg" class="ewTableHeader">
       ...
       <tr>
          ...
          <td class="ewTableHeader"><div align="center"><?php echo $iva_21_porcen     ?></div></td>
			<td class="ewTableHeader"><div align="center"><?php echo $iva_0_porcen     ?></div></td>
        </tr>
		...
		<tr>
		 ...
		 <td bgcolor="#82BADD" width="26" align="center"><input type="radio" name="impuesto" value="<?php  echo $iva_0_porcen     ?>" onClick="validarFormulario(this.form)"/></td>
          </tr>
		 <tr>
    ...
    <tr>
      <td width="461" rowspan="3" valign="top"><table width="94%" border="0" cellpadding="1" cellspacing="1" bgcolor="#82BADD"><tr>
	...
	<tr><td height="25" bgcolor="#82BADD" border="1" class="ewTableHeader">&nbsp;Imprimir   </td><td bgcolor="#82BADD" ><input type="checkbox" name="imprime" value="1" />
      ...
      <td width="254" rowspan="3" valign="top"><table width="95%" height="115" border="1" cellpadding="1" cellspacing="1" bgcolor="#82BADD">
