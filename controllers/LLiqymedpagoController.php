...
/**
 * l_liqymedpago controller
 */
class LLiqymedpagoController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/LLiqymedpago[/{params:.*}]", [PermissionMiddleware::class], "custom.l_liqymedpago")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "LLiqymedpago");
    }
}
