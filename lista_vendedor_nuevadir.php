...
<body>
<form id="form1" class="container" name="form1" method="post" action="rp_vendedor_nuevadir.php">
  <table width="300" border="0" align="left" cellpadding="1" cellspacing="1">
    <tr>
      <td colspan="2" background="images/fondo_titulos.jpg" align="center"><img src="images/catalogo_vendedor.gif" width="222" height="30" /></td>
    </tr>
    <tr>
      <td width="150">&nbsp;</td>
      <td>&nbsp;</td>
