...
/**
 * lista_facncB_consultar controller
 */
class ListaFacncBConsultarController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/ListaFacncBConsultar[/{params:.*}]", [PermissionMiddleware::class], "custom.lista_facncB_consultar")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "ListaFacncBConsultar");
    }
}
