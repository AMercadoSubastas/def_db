...
/**
 * l_vtasxjuris controller
 */
class LVtasxjurisController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/LVtasxjuris[/{params:.*}]", [PermissionMiddleware::class], "custom.l_vtasxjuris")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "LVtasxjuris");
    }
}
