	...
	if ($sigo_y_grabo == 1 && $todo_ok == 1) {
		...
		if (isset($_POST['lote']) && GetSQLValueString($_POST['lote'], "int") != "NULL") {
			...
			if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
				//mysqli_select_db($amercado, $database_amercado);
				$leolote = sprintf(
					"SELECT * FROM lotes WHERE codrem = %s AND codintlote = %s",
				...
				//============================================================================
				$insertSQL = sprintf(
					"INSERT INTO detfac (tcomp, serie, ncomp, nreng, codrem, codlote, descrip, neto, porciva, comcob, usuario) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
				...
				$updateSQL = sprintf(
					"UPDATE lotes SET estado = %s, preciofinal =  %s WHERE codrem = %s AND secuencia = %s",
		...
		if (isset($_POST['lote']) && GetSQLValueString($_POST['lote'], "int") != "NULL") {
			...
			if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
				...
				if ($hay_lotes_pendientes == 1) {
					$updateSQL = sprintf(
						"UPDATE remates SET estado = %s , imptot = %s WHERE ncomp = %s",
						GetSQLValueString("1", "int"),
						GetSQLValueString($_POST['tot_general'], "double"),
						GetSQLValueString($_POST['remate_num'], "int")
					);
...
<body>
	<form id="factura" class="container" name="factura" method="POST" action="<?php echo $editFormAction; ?>">
		<table width="640" border="1" align="left" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
			<tr>
				<td colspan="3">
					<div align="center"><img src="images/carga_aut_lotes.gif" width="358" height="30" /></div>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="3">
					...
					<table width="100%" border="1" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
						<tr>
							<td width="73" rowspan="2" class="ewTableHeader" background="images/fonod_lote.jpg">
								<div align="center">LOTE</div>
							</td>
							<td width="308" rowspan="2" class="ewTableHeader" background="images/fonod_lote.jpg">
								<div align="center">DESCRIPCION</div>
							</td>
							<td width="86" rowspan="2" class="ewTableHeader" background="images/fonod_lote.jpg">
								<div align="center">COM</div>
							</td>
							<td width="58" rowspan="2" class="ewTableHeader" background="images/fonod_lote.jpg">
								<div align="center">% TASA</div>
							</td>
							<td width="68" rowspan="2" class="ewTableHeader" background="images/fonod_lote.jpg">
								<div align="center">IMPORTE</div>
							</td>
							<td height="24" colspan="3" class="ewTableHeader" background="images/fonod_lote.jpg">
								<div align="center">IMPUESTOS</div>
							</td>
						</tr>
						<tr>
							<td width="59" height="15" class="ewTableHeader" background="images/fonod_lote.jpg">
								<div align="center"><?php echo $iva_15_porcen     ?></div>
							</td>
							<td class="ewTableHeader" background="images/fonod_lote.jpg">
								<div align="center"><?php echo $iva_21_porcen     ?></div>
							</td>
						</tr>
			...
			<tr bgcolor="#FFFFFF">
				...
				<td width="426" hidden rowspan="3" valign="top">
					<table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
