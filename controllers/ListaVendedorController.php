...
/**
 * lista_vendedor controller
 */
class ListaVendedorController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/ListaVendedor[/{params:.*}]", [PermissionMiddleware::class], "custom.lista_vendedor")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "ListaVendedor");
    }
}
