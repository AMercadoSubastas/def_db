 ...
 * Page class
 */
class TipoindustriaView extends Tipoindustria
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TipoindustriaView";
    ...
    // CSS class/style
    public $CurrentPageName = "TipoindustriaView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("codnum") ?? Route("codnum")) !== null) {
            ...
            $returnUrl = "TipoindustriaList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "TipoindustriaList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
