 ...
 * Page class
 */
class FormapagoAdd extends Formapago
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FormapagoAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "FormapagoAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("FormapagoList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "FormapagoList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "FormapagoView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "FormapagoList") {
                            ...
                            $returnUrl = "FormapagoList"; // Return list page content
                        }
                    }
    ...
    {
        $this->porcrecargo->DefaultValue = $this->porcrecargo->getDefault(); // PHP
        $this->porcrecargo->OldValue = $this->porcrecargo->DefaultValue;
    ...
    protected function loadFormValues()
    {
        ...
        // Check field name 'porcrecargo' first before field var 'x_porcrecargo'
        $val = $CurrentForm->hasValue("porcrecargo") ? $CurrentForm->getValue("porcrecargo") : $CurrentForm->getValue("x_porcrecargo");
        if (!$this->porcrecargo->IsDetailKey) {
            if (IsApi() && $val === null) {
                $this->porcrecargo->Visible = false; // Disable update for API request
            } else {
                $this->porcrecargo->setFormValue($val, true, $validate);
            }
        }
    ...
    public function restoreFormValues()
    {
        ...
        $this->porcrecargo->CurrentValue = $this->porcrecargo->FormValue;
    ...
    public function renderRow()
    {
        ...
        // porcrecargo
        $this->porcrecargo->RowCssClass = "row";
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            // porcrecargo
            $this->porcrecargo->setupEditAttributes();
            $this->porcrecargo->EditValue = $this->porcrecargo->CurrentValue;
            $this->porcrecargo->PlaceHolder = RemoveHtml($this->porcrecargo->caption());
            if (strval($this->porcrecargo->EditValue) != "" && is_numeric($this->porcrecargo->EditValue)) {
                $this->porcrecargo->EditValue = FormatNumber($this->porcrecargo->EditValue, null);
            }
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            ...
            if ($this->porcrecargo->Visible && $this->porcrecargo->Required) {
                if (!$this->porcrecargo->IsDetailKey && EmptyValue($this->porcrecargo->FormValue)) {
                    $this->porcrecargo->addErrorMessage(str_replace("%s", $this->porcrecargo->caption(), $this->porcrecargo->RequiredErrorMessage));
                }
            }
            if (!CheckNumber($this->porcrecargo->FormValue)) {
                $this->porcrecargo->addErrorMessage($this->porcrecargo->getErrorMessage(false));
            }
    ...
    protected function getAddRow()
    {
        ...
        // porcrecargo
        $this->porcrecargo->setDbValueDef($rsnew, $this->porcrecargo->CurrentValue, strval($this->porcrecargo->CurrentValue) == "");
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['porcrecargo'])) { // porcrecargo
            $this->porcrecargo->setFormValue($row['porcrecargo']);
        }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("FormapagoList"), "", $this->TableVar, true);
