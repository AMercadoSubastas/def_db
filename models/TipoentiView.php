 ...
 * Page class
 */
class TipoentiView extends Tipoenti
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TipoentiView";
    ...
    // CSS class/style
    public $CurrentPageName = "TipoentiView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("codnum") ?? Route("codnum")) !== null) {
            ...
            $returnUrl = "TipoentiList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "TipoentiList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
