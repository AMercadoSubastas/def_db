...
if ($salida == 1) {
	...
	$pdf->Cell(24,16,'Rec. Gs. Pub.',1,0,'L');
    ...
    {	
        ...
        if ($i <= 22) {
            ...
            if (( $tcomp == 119 || $tcomp == 120 || $tcomp == 121 || $tcomp == 122 || $tcomp == 123 || $tcomp == 124 || $tcomp == 137 || $tcomp == 138) && ($row_cabecerafac["totiva21"] == 0.00 &&  $row_cabecerafac["totiva105"] == 0.00)) {
                $tot_neto21   = 0.00;
                $tot_neto105  = 0.00;
                $tot_exento   = 0.00; //$row_cabecerafac["totneto21"] + $row_cabecerafac["totneto"];
                $tot_comision   = 0.00;
				$tot_servicios   = 0.00;
            ...
            else if ($tcomp == 143 || $tcomp == 125 || $tcomp == 126 || $tcomp == 127 || $tcomp == 133 || $tcomp == 134 || $tcomp == 136) {
            ...
            } else if ($tcomp == 119 || $tcomp == 120 || $tcomp == 121  || $tcomp == 135 || $tcomp == 137) {
				//Aca leo detfac para ver el concepto facturado
				$query_detfac = "SELECT * FROM detfac WHERE tcomp = $tcomp AND ncomp = $ncomp";
				$detfac = mysqli_query($amercado, $query_detfac) or die("ERROR LEYENDO DETFAC ".$query_detfac);
                //$row_detfac = mysqli_fetch_assoc($detfac);
                ...
                while ($row_detfac = mysqli_fetch_array($detfac, MYSQLI_BOTH)) {
                    ...
                    if ($row_detfac["concafac"] == 44 )
				        $tot_comision += $row_detfac["neto"];
					if ($row_detfac["concafac"] == 14 )
				        $tot_neto21 += $row_detfac["neto"];
					if ($row_detfac["concafac"] == 27 )
				        $tot_comision += $row_detfac["neto"];
