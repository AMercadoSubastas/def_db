...
//  fclose($f1); 
 ...
 // $chau ="12";
  ...
  $chau = $inf["comiscobr"];
   $secu = $inf["secuencia"];
   echo "formObj15.descripcion14.value = '".$hola."';\n";  
  //  echo "formObj.descripcion.value = '".$inf["descor"]."';\n";    
    echo "formObj15.comision14.value = '".$chau."';\n";   
	 echo "formObj15.secuencia14.value = '".$secu."';\n";    
    } else {
   //  $fact = mysqli_query("SELECT * FROM detfac WHERE ( codrem='".$remate."' AND codintlote='".$lote."')")  or die(mysqli_error($amercado));
    ...
    echo "formObj15.descripcion14.value = '".$item."';\n";  
   
   
   }      
    
  }else{
    echo "formObj15.descripcion14.value  = '';\n";    
    echo "formObj15.comision14.value = '';\n";   
	 echo "formObj15.secuencia14.value = '';\n";    
