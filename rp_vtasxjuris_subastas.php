...
$query_cabfac = sprintf("SELECT * FROM cabfac WHERE (tcomp BETWEEN 51 AND 64 OR tcomp IN (89,92,93,94,103,104,105,111,112)) AND fecreg BETWEEN %s AND %s AND usuario not in (25,26) ORDER BY fecreg, nrodoc, tcomp", $fecha_desde, $fecha_hasta);
...
{	
	...
	//if ($tcomp !=  51 && $tcomp !=  52 && $tcomp !=  53 && $tcomp !=  54 && $tcomp !=  55 && $tcomp !=  56  &&  $tcomp != 57 && $tcomp != 58 && $tcomp != 59 && $tcomp != 60 && $tcomp !=  61 && $tcomp !=  62 && $tcomp !=  63 && $tcomp !=  64 && $tcomp !=  89 && $tcomp !=  92  && $tcomp !=  93 && $tcomp !=  94 && $tcomp !=  102 && $tcomp !=  103 && $tcomp !=  104 && $tcomp !=  105 && $tcomp !=  86)
	//	continue;
