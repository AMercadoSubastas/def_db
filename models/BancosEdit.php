 ...
 * Page class
 */
class BancosEdit extends Bancos
{
    use MessagesTrait;
    ...
    // CSS class/style
    public $CurrentPageName = "BancosEdit";
    ...
    protected function getEditRow($rsold)
    {
        ...
        // codbanco
        $this->codbanco->setDbValueDef($rsnew, $this->codbanco->CurrentValue, $this->codbanco->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        if (isset($row['codbanco'])) { // codbanco
            $this->codbanco->CurrentValue = $row['codbanco'];
        }
