...
/**
 * ncndxconc controller
 */
class NcndxconcController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/Ncndxconc[/{params:.*}]", [PermissionMiddleware::class], "custom.ncndxconc")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "Ncndxconc");
    }
}
