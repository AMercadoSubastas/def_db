 ...
 * Page class
 */
class PaisesView extends Paises
{
    use MessagesTrait;
    ...
    // CSS class/style
    public $CurrentPageName = "PaisesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("codnum") ?? Route("codnum")) !== null) {
            ...
            $returnUrl = "PaisesList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PaisesList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
