...
/**
 * l_citiventas controller
 */
class LCitiventasController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/LCitiventas[/{params:.*}]", [PermissionMiddleware::class], "custom.l_citiventas")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "LCitiventas");
    }
}
