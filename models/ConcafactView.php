 ...
 * Page class
 */
class ConcafactView extends Concafact
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ConcafactView";
    ...
    // CSS class/style
    public $CurrentPageName = "ConcafactView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("codnum") ?? Route("codnum")) !== null) {
            ...
            $returnUrl = "ConcafactList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ConcafactList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
