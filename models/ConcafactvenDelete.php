 ...
 * Page class
 */
class ConcafactvenDelete extends Concafactven
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ConcafactvenDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ConcafactvenDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ConcafactvenList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ConcafactvenList"); // Return to list
                return;
            }
        }
