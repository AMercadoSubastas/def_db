...
/**
 * l_ranking_cli_cant controller
 */
class LRankingCliCantController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/LRankingCliCant[/{params:.*}]", [PermissionMiddleware::class], "custom.l_ranking_cli_cant")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "LRankingCliCant");
    }
}
