...
/**
 * v_afacutxconc_i controller
 */
class VAfacutxconcIController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/VAfacutxconcI[/{params:.*}]", [PermissionMiddleware::class], "custom.v_afacutxconc_i")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "VAfacutxconcI");
    }
}
