 ...
 * emicbtes controller
 */
class EmicbtesController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/Emicbtes[/{params:.*}]", [PermissionMiddleware::class], "custom.emicbtes")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "Emicbtes");
    }
}
