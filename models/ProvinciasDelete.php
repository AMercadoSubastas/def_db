 ...
 * Page class
 */
class ProvinciasDelete extends Provincias
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProvinciasDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ProvinciasDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ProvinciasList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ProvinciasList"); // Return to list
                return;
            }
        }
