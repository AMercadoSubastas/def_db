...
<body>
<form id="form1" name="form1" method="post" action="rp_martillero_nuevadir.php">
  <table width="300" border="0" align="left" cellpadding="1" cellspacing="1">
    <tr>
      <td colspan="2" background="images/fondo_titulos.jpg" align="center"><img src="images/catalogo_martillero.gif" width="225" height="30" /></td>
    </tr>
    <tr>
      <td width="150">&nbsp;</td>
      <td>&nbsp;</td>
