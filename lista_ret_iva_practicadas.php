...
<body>
<form  name="libros" method="post" action="rp_ret_iva_practicadas.php">
  <table width="300" border="0" align="left" cellpadding="1" cellspacing="1">
    <tr>
      <td colspan="3" background="images/fondo_titulos.jpg" align="center"><img src="images/list_percepciones.gif" width="235" height="30" /></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="3">Lista las percepciones  desde </td>
    </tr>
    <tr>
