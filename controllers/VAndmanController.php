 ...
 * v_andman controller
 */
class VAndmanController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/VAndman[/{params:.*}]", [PermissionMiddleware::class], "custom.v_andman")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "VAndman");
    }
}
