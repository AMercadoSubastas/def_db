 ...
 * ncndxlot controller
 */
class NcndxlotController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/Ncndxlot[/{params:.*}]", [PermissionMiddleware::class], "custom.ncndxlot")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "Ncndxlot");
    }
}
