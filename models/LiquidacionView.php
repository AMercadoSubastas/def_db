 ...
 * Page class
 */
class LiquidacionView extends Liquidacion
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LiquidacionView";
    ...
    // CSS class/style
    public $CurrentPageName = "LiquidacionView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("codnum") ?? Route("codnum")) !== null) {
            ...
            $returnUrl = "LiquidacionList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "LiquidacionList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
