 ...
 * Page class
 */
class SeriesEdit extends Series
{
    use MessagesTrait;
    ...
    // CSS class/style
    public $CurrentPageName = "SeriesEdit";
    ...
    protected function getEditRow($rsold)
    {
        ...
        // tipcomp
        $this->tipcomp->setDbValueDef($rsnew, $this->tipcomp->CurrentValue, $this->tipcomp->ReadOnly);

        // descripcion
        $this->descripcion->setDbValueDef($rsnew, $this->descripcion->CurrentValue, $this->descripcion->ReadOnly);

        // nrodesde
        $this->nrodesde->setDbValueDef($rsnew, $this->nrodesde->CurrentValue, $this->nrodesde->ReadOnly);

        // nrohasta
        $this->nrohasta->setDbValueDef($rsnew, $this->nrohasta->CurrentValue, $this->nrohasta->ReadOnly);

        // nroact
        $this->nroact->setDbValueDef($rsnew, $this->nroact->CurrentValue, $this->nroact->ReadOnly);

        // mascara
        $this->mascara->setDbValueDef($rsnew, $this->mascara->CurrentValue, $this->mascara->ReadOnly);

        // activo
        $this->activo->setDbValueDef($rsnew, strval($this->activo->CurrentValue) == "1" ? "1" : "0", $this->activo->ReadOnly);

        // automatica
        $this->automatica->setDbValueDef($rsnew, strval($this->automatica->CurrentValue) == "1" ? "1" : "0", $this->automatica->ReadOnly);

        // fechatope
        $this->fechatope->setDbValueDef($rsnew, UnFormatDateTime($this->fechatope->CurrentValue, $this->fechatope->formatPattern()), $this->fechatope->ReadOnly);
        return $rsnew;
    }
