...
?>
          ...
          <td bgcolor="#FFFFFF"><input name="descripcion" type="text" class="phpmaker" id="descripcion" size="80" /></td><input name="secuencia" type="hidden" class="phpmaker"  size="5"  value="1"/>
