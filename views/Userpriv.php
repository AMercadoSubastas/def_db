...
window.Tabulator || loadjs([
    ew.PATH_BASE + "css/<?= CssFile("tabulator_bootstrap5.css", false) ?>?v=24.4.1",
    ew.PATH_BASE + "js/tabulator.js?v=24.4.1"
], "tabulator");
</script>
<style>
main .tooltip {
...
<script>
ew.ready(["load", "tabulator"], ew.PATH_BASE + "js/userpriv.js?v=24.4.1");
</script>
