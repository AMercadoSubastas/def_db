...
/**
 * a_fcxconciB controller
 */
class AFcxconciBController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/AFcxconciB[/{params:.*}]", [PermissionMiddleware::class], "custom.a_fcxconciB")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "AFcxconciB");
    }
}
