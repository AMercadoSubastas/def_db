 ...
 * v_andB4 controller
 */
class VAndB4Controller extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/VAndB4[/{params:.*}]", [PermissionMiddleware::class], "custom.v_andB4")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "VAndB4");
    }
}
