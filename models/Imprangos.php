...
/**
 * Table class for imprangos
 */
class Imprangos extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // codimp
        $this->codimp = new DbField(
            $this, // Table
            'x_codimp', // Variable name
            'codimp', // Name
            '`codimp`', // Expression
            '`codimp`', // Basic search expression
            19, // Type
            3, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`codimp`', // Virtual expression
            false, // Is virtual
        ...
        $this->codimp->InputTextType = "text";
        $this->codimp->Raw = true;
        $this->codimp->IsPrimaryKey = true; // Primary key field
        $this->codimp->Nullable = false; // NOT NULL field
        $this->codimp->Required = true; // Required field
        $this->codimp->setSelectMultiple(false); // Select one
        $this->codimp->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->codimp->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        global $CurrentLanguage;
        switch ($CurrentLanguage) {
            case "en-US":
                $this->codimp->Lookup = new Lookup($this->codimp, 'impuestos', false, 'codnum', ["descripcion","","",""], '', '', [], [], [], [], [], [], false, '`descripcion` ASC', '', "`descripcion`");
                break;
            default:
                $this->codimp->Lookup = new Lookup($this->codimp, 'impuestos', false, 'codnum', ["descripcion","","",""], '', '', [], [], [], [], [], [], false, '`descripcion` ASC', '', "`descripcion`");
                break;
        }
        $this->codimp->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->codimp->SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['codimp'] = &$this->codimp;
        ...
        $this->secuencia->IsPrimaryKey = true; // Primary key field
        ...
        // monto_min
        $this->monto_min = new DbField(
            $this, // Table
            'x_monto_min', // Variable name
            'monto_min', // Name
            '`monto_min`', // Expression
            '`monto_min`', // Basic search expression
            4, // Type
            12, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`monto_min`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->monto_min->addMethod("getDefault", fn() => 0);
        $this->monto_min->InputTextType = "text";
        $this->monto_min->Raw = true;
        $this->monto_min->Nullable = false; // NOT NULL field
        $this->monto_min->Required = true; // Required field
        $this->monto_min->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->monto_min->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['monto_min'] = &$this->monto_min;

        // monto_max
        $this->monto_max = new DbField(
            $this, // Table
            'x_monto_max', // Variable name
            'monto_max', // Name
            '`monto_max`', // Expression
            '`monto_max`', // Basic search expression
            4, // Type
            12, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`monto_max`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->monto_max->addMethod("getDefault", fn() => 0);
        $this->monto_max->InputTextType = "text";
        $this->monto_max->Raw = true;
        $this->monto_max->Nullable = false; // NOT NULL field
        $this->monto_max->Required = true; // Required field
        $this->monto_max->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->monto_max->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['monto_max'] = &$this->monto_max;
        ...
        // monto_fijo
        $this->monto_fijo = new DbField(
            $this, // Table
            'x_monto_fijo', // Variable name
            'monto_fijo', // Name
            '`monto_fijo`', // Expression
            '`monto_fijo`', // Basic search expression
            4, // Type
            12, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`monto_fijo`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->monto_fijo->InputTextType = "text";
        $this->monto_fijo->Raw = true;
        $this->monto_fijo->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->monto_fijo->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['monto_fijo'] = &$this->monto_fijo;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->activo->Lookup = new Lookup($this->activo, 'imprangos', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
                break;
            default:
                $this->activo->Lookup = new Lookup($this->activo, 'imprangos', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
                break;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "imprangos";
    }
    ...
    public function deleteSql(&$rs, $where = "", $curfilter = true)
    {
        ...
        if ($rs) {
            if (array_key_exists('codimp', $rs)) {
                AddFilter($where, QuotedName('codimp', $this->Dbid) . '=' . QuotedValue($rs['codimp'], $this->codimp->DataType, $this->Dbid));
            }
            if (array_key_exists('secuencia', $rs)) {
                AddFilter($where, QuotedName('secuencia', $this->Dbid) . '=' . QuotedValue($rs['secuencia'], $this->secuencia->DataType, $this->Dbid));
            }
        }
        $filter = $curfilter ? $this->CurrentFilter : "";
        AddFilter($filter, $where);
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->codimp->DbValue = $row['codimp'];
        $this->secuencia->DbValue = $row['secuencia'];
        $this->monto_min->DbValue = $row['monto_min'];
        $this->monto_max->DbValue = $row['monto_max'];
        $this->porcentaje->DbValue = $row['porcentaje'];
        $this->monto_fijo->DbValue = $row['monto_fijo'];
    ...
    {
        return "`codimp` = @codimp@ AND `secuencia` = @secuencia@";
    }
    ...
    {
        $keys = [];
        $val = $current ? $this->codimp->CurrentValue : $this->codimp->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
        }
        $val = $current ? $this->secuencia->CurrentValue : $this->secuencia->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false, $keySeparator = null)
    {
        ...
        if (count($keys) == 2) {
            if ($current) {
                $this->codimp->CurrentValue = $keys[0];
            } else {
                $this->codimp->OldValue = $keys[0];
            }
            if ($current) {
                $this->secuencia->CurrentValue = $keys[1];
            } else {
                $this->secuencia->OldValue = $keys[1];
            }
        }
    }
    ...
    public function getRecordFilter($row = null, $current = false)
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('codimp', $row) ? $row['codimp'] : null;
        } else {
            $val = !EmptyValue($this->codimp->OldValue) && !$current ? $this->codimp->OldValue : $this->codimp->CurrentValue;
        }
        if (!is_numeric($val)) {
        ...
        if ($val === null) {
            ...
            $keyFilter = str_replace("@codimp@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
        }
        if (is_array($row)) {
            $val = array_key_exists('secuencia', $row) ? $row['secuencia'] : null;
        } else {
            $val = !EmptyValue($this->secuencia->OldValue) && !$current ? $this->secuencia->OldValue : $this->secuencia->CurrentValue;
        }
        if (!is_numeric($val)) {
            return "0=1"; // Invalid key
        }
        if ($val === null) {
            ...
            $keyFilter = str_replace("@secuencia@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
        }
        return $keyFilter;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ImprangosList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ImprangosView" => $Language->phrase("View"),
            "ImprangosEdit" => $Language->phrase("Edit"),
            "ImprangosAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ImprangosView",
            Config("API_ADD_ACTION") => "ImprangosAdd",
            Config("API_EDIT_ACTION") => "ImprangosEdit",
            Config("API_DELETE_ACTION") => "ImprangosDelete",
            Config("API_LIST_ACTION") => "ImprangosList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ImprangosView", $parm);
        } else {
            $url = $this->keyUrl("ImprangosView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ImprangosEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ImprangosList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ImprangosAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ImprangosList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ImprangosDelete", $parm);
        }
    }
    ...
    {
        $json = "";
        $json .= "\"codimp\":" . VarToJson($this->codimp->CurrentValue, "number");
        $json .= ",\"secuencia\":" . VarToJson($this->secuencia->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    {
        if ($this->codimp->CurrentValue !== null) {
            $url .= "/" . $this->encodeKeyValue($this->codimp->CurrentValue);
        } else {
            return "javascript:ew.alert(ew.language.phrase('InvalidRecord'));";
        }
        if ($this->secuencia->CurrentValue !== null) {
            $url .= $this->RouteCompositeKeySeparator . $this->encodeKeyValue($this->secuencia->CurrentValue);
        } else {
            return "javascript:ew.alert(ew.language.phrase('InvalidRecord'));";
        }
        if ($parm != "") {
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            $keyValues = $isApi
                ...
                : []; // Non-API
            if (($keyValue = Param("codimp") ?? Route("codimp")) !== null) {
                $arKey[] = $keyValue;
            ...
            if (($keyValue = Param("secuencia") ?? Route("secuencia")) !== null) {
                $arKey[] = $keyValue;
        ...
        if (is_array($arKeys)) {
            foreach ($arKeys as $key) {
                ...
                if (!is_numeric($key[0])) { // codimp
                    continue;
                }
                if (!is_numeric($key[1])) { // secuencia
                    continue;
                }
                $ar[] = $key;
            }
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->codimp->CurrentValue = $key[0];
            } else {
                $this->codimp->OldValue = $key[0];
            }
            if ($setCurrent) {
                $this->secuencia->CurrentValue = $key[1];
            } else {
                $this->secuencia->OldValue = $key[1];
            }
    ...
    public function renderListRow()
    {
        ...
        $this->monto_min->TooltipValue = "";

        // monto_max
        $this->monto_max->HrefValue = "";
        $this->monto_max->TooltipValue = "";
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    $doc->exportCaption($this->codimp);
                    $doc->exportCaption($this->secuencia);
                    $doc->exportCaption($this->monto_min);
                    $doc->exportCaption($this->monto_max);
                    $doc->exportCaption($this->porcentaje);
                    $doc->exportCaption($this->monto_fijo);
        ...
        while (($row = $result->fetch()) && $recCnt < $stopRec) {
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        $doc->exportField($this->codimp);
                        $doc->exportField($this->secuencia);
                        $doc->exportField($this->monto_min);
                        $doc->exportField($this->monto_max);
                        $doc->exportField($this->porcentaje);
                        $doc->exportField($this->monto_fijo);
