 ...
 * Page class
 */
class CalificacionView extends Calificacion
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CalificacionView";
    ...
    // CSS class/style
    public $CurrentPageName = "CalificacionView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("codnum") ?? Route("codnum")) !== null) {
            ...
            $returnUrl = "CalificacionList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "CalificacionList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
