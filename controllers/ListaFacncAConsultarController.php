...
/**
 * lista_facncA_consultar controller
 */
class ListaFacncAConsultarController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/ListaFacncAConsultar[/{params:.*}]", [PermissionMiddleware::class], "custom.lista_facncA_consultar")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "ListaFacncAConsultar");
    }
}
