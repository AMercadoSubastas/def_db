...
// Imprimo la cabecera
   // Linea de arriba
	...
	$pdf->SetY(32);
	$pdf->SetX(120);
    $pdf->Cell(150,10,'C.U.I.T : 20-14101985-7');
	$pdf->SetY(37);
	$pdf->SetX(120);
	$pdf->Cell(150,10,'Ing. Brutos N� : reg. simp.');
	$pdf->SetY(42);
	$pdf->SetX(120);
	$pdf->Cell(150,10,'Fecha de Inicio de Actividades : 01/01/2013');
	$pdf->SetY(48);
	$pdf->SetX(10);
	...
	$pdf->Image('images/logo_RCH.jpg',10,8);
...
$pdf->SetX(155);
//$df_importe = number_format($df_importe, 2, ',','.');
