...
function validarFormulario(form)
{
	...
	var tot_general  = 0;
	// PRIMER LOTE
	//strAlerta1 = "ENTRO AL PRIMER LOTE ";
	//alert(strAlerta1);
	if (monto.length!=0) {
		//strAlerta2 = "ENTR� AL PRIMER LOTE ";
		//alert(strAlerta2);
		//porciva = eval(porciva / 100);
		//strAlerta3 = "PORCIVA = " + "\n" + porciva + "\n" ;
		//alert(strAlerta3);
		...
		//strAlerta5 = "imp_tot_21 = " + "\n" + imp_tot_21 + "\n" ;
		//alert(strAlerta5);
	  	var	tot_general = eval(monto+('+')+imp_tot_21);	// Total general
		//strAlerta6 = "tot_general = " + "\n" + tot_general + "\n" ;
		//alert(strAlerta6);
	    
		form.totneto21.value = tot_mon.toFixed(2) ;	
		//strAlerta7 = "form.totneto21.value = " + "\n" + form.totneto21.value + "\n" ;
		//alert(strAlerta7);
		form.totiva21.value = imp_tot_21.toFixed(2) ;
		//strAlerta8 = "form.totiva21.value = " + "\n" + form.totiva21.value + "\n" ;
		//alert(strAlerta8);
		form.tot_general.value = tot_general.toFixed(2) ;
		//strAlerta9 = "form.tot_general.value = " + "\n" + form.tot_general.value + "\n" ;
		//alert(strAlerta9);
		
		//strAlerta = "Total neto = " + form.tot_totneto21.value + "\n"  + "Total IVA = " + form.totiva21.value + "\n" + "Total general = " + form.tot_general.value + "\n" + "porciva =  " + porciva + "\n";
		// lanzamos la acci�n
		//alert(strAlerta);
    ...
    <tr>
      <td colspan="2" valign="top" bgcolor="#82BADD"><table width="900" border="1" cellspacing="1" cellpadding="1">
		 ...
		 <td width="14%" height="20" class="ewTableHeader">&nbsp;Tipo de Cbte </td>
          ...
          <td width="35%"><input name="serie_texto" value="SERIE DE FACT CONCEPTOS A0004" type="text"  size="24" />
        ...
        <tr>
         ...
         <td colspan="2" bgcolor="#82BADD" align="center"><img src="images/cond_pago.gif" width="150" height="30" /></td>
           ...
           <tr>
              <td width="50%" height="39" bgcolor="#82BADD">&nbsp;<span class="ewTableHeader">Afecta Liquidacion</span></td>
              <td width="50%" bgcolor="#82BADD"><input name="GrupoOpciones2" type="radio" value='1' onclick="liquidacion(this.form)"  /></td>
          </tr>
            <tr>
              <td width="50%" height="44" bgcolor="#82BADD">&nbsp;<span class="ewTableHeader">No afecta Liquidacion</span></td>
              <td width="50%" bgcolor="#82BADD"><input type="radio" name="GrupoOpciones2" value='0' checked="checked"onClick="liquidacion(this.form)"/></td>
              </tr>
          </table></td>
          </tr>
        <tr>
