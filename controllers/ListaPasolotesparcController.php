...
/**
 * lista_pasolotesparc controller
 */
class ListaPasolotesparcController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/ListaPasolotesparc[/{params:.*}]", [PermissionMiddleware::class], "custom.lista_pasolotesparc")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "ListaPasolotesparc");
    }
}
