...
/**
 * a_anulliq controller
 */
class AAnulliqController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/AAnulliq[/{params:.*}]", [PermissionMiddleware::class], "custom.a_anulliq")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "AAnulliq");
    }
}
