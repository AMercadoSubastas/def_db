 ...
 * Page class
 */
class TipoindustriaEdit extends Tipoindustria
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TipoindustriaEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "TipoindustriaEdit";
    ...
    protected function getEditRow($rsold)
    {
        ...
        // nomre
        $this->nomre->setDbValueDef($rsnew, $this->nomre->CurrentValue, $this->nomre->ReadOnly);
        return $rsnew;
    }
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['nomre'])) { // nomre
            $this->nomre->CurrentValue = $row['nomre'];
        }
    }
