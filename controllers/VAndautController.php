 ...
 * v_andaut controller
 */
class VAndautController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/VAndaut[/{params:.*}]", [PermissionMiddleware::class], "custom.v_andaut")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "VAndaut");
    }
}
