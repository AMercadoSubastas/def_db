 ...
 * Page class
 */
class LocalidadesAdd extends Localidades
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LocalidadesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "LocalidadesAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("LocalidadesList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "LocalidadesList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "LocalidadesView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "LocalidadesList") {
                            ...
                            $returnUrl = "LocalidadesList"; // Return list page content
                        }
                    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("LocalidadesList"), "", $this->TableVar, true);
