...
/**
 * l_liq_ibb controller
 */
class LLiqIbbController extends ControllerBase
{
    // custom
    #[Map(["GET", "POST", "OPTIONS"], "/LLiqIbb[/{params:.*}]", [PermissionMiddleware::class], "custom.l_liq_ibb")]
    public function custom(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "LLiqIbb");
    }
}
